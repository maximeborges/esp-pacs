...
pub type OUTFIFO_WDATA_CH2_W<'a> = crate::FieldWriter<'a, u32, OUT_PUSH_CH2_SPEC, u16, u16, 9, 0>;
...
pub type OUTFIFO_PUSH_CH2_W<'a> = crate::BitWriter<'a, u32, OUT_PUSH_CH2_SPEC, bool, 9>;
impl R {
