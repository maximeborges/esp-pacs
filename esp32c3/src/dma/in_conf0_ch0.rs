...
pub struct IN_RST_CH0_R(crate::FieldReader<bool>);
impl IN_RST_CH0_R {
    #[inline(always)]
...
pub struct IN_LOOP_TEST_CH0_R(crate::FieldReader<bool>);
...
pub struct INDSCR_BURST_EN_CH0_R(crate::FieldReader<bool>);
...
pub struct IN_DATA_BURST_EN_CH0_R(crate::FieldReader<bool>);
...
pub struct MEM_TRANS_EN_CH0_R(crate::FieldReader<bool>);
