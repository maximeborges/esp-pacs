...
pub struct INLINK_DSCR_ADDR_CH2_R(crate::FieldReader<u32>);
...
pub struct IN_DSCR_STATE_CH2_R(crate::FieldReader<u8>);
...
pub struct IN_STATE_CH2_R(crate::FieldReader<u8>);
impl IN_STATE_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
