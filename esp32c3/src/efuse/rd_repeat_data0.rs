...
pub struct DIS_USB_JTAG_R(crate::FieldReader<bool>);
impl DIS_USB_JTAG_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct DIS_USB_DEVICE_R(crate::FieldReader<bool>);
...
pub struct RPT4_RESERVED6_R(crate::FieldReader<bool>);
...
pub struct JTAG_SEL_ENABLE_R(crate::FieldReader<bool>);
...
pub struct SOFT_DIS_JTAG_R(crate::FieldReader<u8>);
...
pub struct DIS_PAD_JTAG_R(crate::FieldReader<bool>);
impl DIS_PAD_JTAG_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct VDD_SPI_AS_GPIO_R(crate::FieldReader<bool>);
...
pub struct BTLC_GPIO_ENABLE_R(crate::FieldReader<u8>);
...
pub struct POWERGLITCH_EN_R(crate::FieldReader<bool>);
