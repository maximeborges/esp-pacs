...
pub type CARRIER_LOW_THRES_W<'a> =
    crate::FieldWriter<'a, u32, CH2_RX_CARRIER_RM_SPEC, u16, u16, 16, 0>;
...
pub type CARRIER_HIGH_THRES_W<'a> =
    crate::FieldWriter<'a, u32, CH2_RX_CARRIER_RM_SPEC, u16, u16, 16, 16>;
impl R {
