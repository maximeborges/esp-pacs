...
pub type IBUS_PMS_SCT1_ATTR_W<'a> =
    crate::FieldWriter<'a, u32, IBUS_PMS_TBL_ATTR_SPEC, u8, u8, 4, 0>;
...
pub type IBUS_PMS_SCT2_ATTR_W<'a> =
    crate::FieldWriter<'a, u32, IBUS_PMS_TBL_ATTR_SPEC, u8, u8, 4, 4>;
impl R {
