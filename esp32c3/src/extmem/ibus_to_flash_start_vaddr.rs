...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ibus_to_flash_start_vaddr]
(index.html) module"]
pub struct IBUS_TO_FLASH_START_VADDR_SPEC;
impl crate::RegisterSpec for IBUS_TO_FLASH_START_VADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ibus_to_flash_start_vaddr::R]
(R) reader structure"]
impl crate::Readable for IBUS_TO_FLASH_START_VADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ibus_to_flash_start_vaddr::W]
(W) writer structure"]
