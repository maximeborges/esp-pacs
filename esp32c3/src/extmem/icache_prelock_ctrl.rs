...
pub type ICACHE_PRELOCK_SCT0_EN_W<'a> =
    crate::BitWriter<'a, u32, ICACHE_PRELOCK_CTRL_SPEC, bool, 0>;
...
pub type ICACHE_PRELOCK_SCT1_EN_W<'a> =
    crate::BitWriter<'a, u32, ICACHE_PRELOCK_CTRL_SPEC, bool, 1>;
impl R {
