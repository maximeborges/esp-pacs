...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [icache_autoload_sct0_addr]
(index.html) module"]
pub struct ICACHE_AUTOLOAD_SCT0_ADDR_SPEC;
impl crate::RegisterSpec for ICACHE_AUTOLOAD_SCT0_ADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [icache_autoload_sct0_addr::R]
(R) reader structure"]
impl crate::Readable for ICACHE_AUTOLOAD_SCT0_ADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [icache_autoload_sct0_addr::W]
(W) writer structure"]
