...
pub type PERI_BACKUP_DONE_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, PERI_BACKUP_INT_CLR_SPEC, bool, 0>;
#[doc = "Field `PERI_BACKUP_ERR_INT_CLR` writer - reg_peri_backup_err_int_clr"]
pub type PERI_BACKUP_ERR_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, PERI_BACKUP_INT_CLR_SPEC, bool, 1>;
impl W {
