...
pub type PERI_BACKUP_DONE_INT_ENA_W<'a> =
    crate::BitWriter<'a, u32, PERI_BACKUP_INT_ENA_SPEC, bool, 0>;
...
pub type PERI_BACKUP_ERR_INT_ENA_W<'a> =
    crate::BitWriter<'a, u32, PERI_BACKUP_INT_ENA_SPEC, bool, 1>;
impl R {
