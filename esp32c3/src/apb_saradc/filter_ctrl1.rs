...
pub type APB_SARADC_FILTER_FACTOR1_W<'a> =
    crate::FieldWriter<'a, u32, FILTER_CTRL1_SPEC, u8, u8, 3, 26>;
...
pub type APB_SARADC_FILTER_FACTOR0_W<'a> =
    crate::FieldWriter<'a, u32, FILTER_CTRL1_SPEC, u8, u8, 3, 29>;
impl R {
