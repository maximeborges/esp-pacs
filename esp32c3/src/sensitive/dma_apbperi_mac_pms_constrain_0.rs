...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_apbperi_mac_pms_constrain_0]
(index.html) module"]
pub struct DMA_APBPERI_MAC_PMS_CONSTRAIN_0_SPEC;
impl crate::RegisterSpec for DMA_APBPERI_MAC_PMS_CONSTRAIN_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_apbperi_mac_pms_constrain_0::R]
(R) reader structure"]
impl crate::Readable for DMA_APBPERI_MAC_PMS_CONSTRAIN_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_apbperi_mac_pms_constrain_0::W]
(W) writer structure"]
