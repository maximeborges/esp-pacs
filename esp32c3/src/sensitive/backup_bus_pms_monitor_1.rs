...
pub type BACKUP_BUS_PMS_MONITOR_VIOLATE_CLR_W<'a> =
    crate::BitWriter<'a, u32, BACKUP_BUS_PMS_MONITOR_1_SPEC, bool, 0>;
...
pub type BACKUP_BUS_PMS_MONITOR_VIOLATE_EN_W<'a> =
    crate::BitWriter<'a, u32, BACKUP_BUS_PMS_MONITOR_1_SPEC, bool, 1>;
impl R {
