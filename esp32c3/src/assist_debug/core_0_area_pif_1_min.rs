...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_area_pif_1_min]
(index.html) module"]
pub struct CORE_0_AREA_PIF_1_MIN_SPEC;
impl crate::RegisterSpec for CORE_0_AREA_PIF_1_MIN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_area_pif_1_min::R]
(R) reader structure"]
impl crate::Readable for CORE_0_AREA_PIF_1_MIN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_area_pif_1_min::W]
(W) writer structure"]
