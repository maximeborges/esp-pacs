...
pub type COMB_PATH_LEN_NVT_W<'a> =
    crate::FieldWriter<'a, u32, COMB_PVT_NVT_CONF_SPEC, u8, u8, 5, 0>;
#[doc = "Field `COMB_ERR_CNT_CLR_NVT` writer - reg_comb_err_cnt_clr_nvt"]
pub type COMB_ERR_CNT_CLR_NVT_W<'a> = crate::BitWriter<'a, u32, COMB_PVT_NVT_CONF_SPEC, bool, 5>;
...
pub type COMB_PVT_MONITOR_EN_NVT_W<'a> = crate::BitWriter<'a, u32, COMB_PVT_NVT_CONF_SPEC, bool, 6>;
impl R {
