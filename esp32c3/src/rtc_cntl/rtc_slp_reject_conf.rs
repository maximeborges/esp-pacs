...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_slp_reject_conf]
(index.html) module"]
pub struct RTC_SLP_REJECT_CONF_SPEC;
impl crate::RegisterSpec for RTC_SLP_REJECT_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_slp_reject_conf::R]
(R) reader structure"]
impl crate::Readable for RTC_SLP_REJECT_CONF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_slp_reject_conf::W]
(W) writer structure"]
