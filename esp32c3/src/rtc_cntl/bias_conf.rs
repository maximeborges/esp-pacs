...
pub type DG_VDD_DRV_B_SLP_W<'a> = crate::FieldWriter<'a, u32, BIAS_CONF_SPEC, u8, u8, 8, 0>;
...
pub type DG_VDD_DRV_B_SLP_EN_W<'a> = crate::BitWriter<'a, u32, BIAS_CONF_SPEC, bool, 8>;
