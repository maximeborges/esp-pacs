...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_cntl_retention_ctrl]
(index.html) module"]
pub struct RTC_CNTL_RETENTION_CTRL_SPEC;
impl crate::RegisterSpec for RTC_CNTL_RETENTION_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_cntl_retention_ctrl::R]
(R) reader structure"]
impl crate::Readable for RTC_CNTL_RETENTION_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_cntl_retention_ctrl::W]
(W) writer structure"]
