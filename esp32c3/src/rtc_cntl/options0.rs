...
pub type XTL_EN_WAIT_W<'a> = crate::FieldWriter<'a, u32, OPTIONS0_SPEC, u8, u8, 4, 14>;
...
pub type XTL_EXT_CTR_SEL_W<'a> = crate::FieldWriter<'a, u32, OPTIONS0_SPEC, u8, u8, 3, 20>;
