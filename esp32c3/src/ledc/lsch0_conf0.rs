...
pub struct TIMER_SEL_LSCH0_R(crate::FieldReader<u8>);
...
pub struct SIG_OUT_EN_LSCH0_R(crate::FieldReader<bool>);
...
pub struct IDLE_LV_LSCH0_R(crate::FieldReader<bool>);
...
pub struct OVF_NUM_LSCH0_R(crate::FieldReader<u16>);
...
pub struct OVF_CNT_EN_LSCH0_R(crate::FieldReader<bool>);
