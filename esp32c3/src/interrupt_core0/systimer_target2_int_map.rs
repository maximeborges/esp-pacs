...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [systimer_target2_int_map]
(index.html) module"]
pub struct SYSTIMER_TARGET2_INT_MAP_SPEC;
impl crate::RegisterSpec for SYSTIMER_TARGET2_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [systimer_target2_int_map::R]
(R) reader structure"]
impl crate::Readable for SYSTIMER_TARGET2_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [systimer_target2_int_map::W]
(W) writer structure"]
