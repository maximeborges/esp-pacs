...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_pif_pms_monitor_violate_size_intr_map]
(index.html) module"]
...
#[doc = "`read()` method returns [core_0_pif_pms_monitor_violate_size_intr_map::R]
(R) reader structure"]
impl crate::Readable for CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_pif_pms_monitor_violate_size_intr_map::W]
(W) writer structure"]
