...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [interrupt_reg_date]
(index.html) module"]
pub struct INTERRUPT_REG_DATE_SPEC;
impl crate::RegisterSpec for INTERRUPT_REG_DATE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [interrupt_reg_date::R]
(R) reader structure"]
impl crate::Readable for INTERRUPT_REG_DATE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [interrupt_reg_date::W]
(W) writer structure"]
