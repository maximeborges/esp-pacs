...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_interrupt_pro_map]
(index.html) module"]
pub struct GPIO_INTERRUPT_PRO_MAP_SPEC;
impl crate::RegisterSpec for GPIO_INTERRUPT_PRO_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpio_interrupt_pro_map::R]
(R) reader structure"]
impl crate::Readable for GPIO_INTERRUPT_PRO_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpio_interrupt_pro_map::W]
(W) writer structure"]
