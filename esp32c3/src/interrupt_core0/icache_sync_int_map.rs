...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [icache_sync_int_map]
(index.html) module"]
pub struct ICACHE_SYNC_INT_MAP_SPEC;
impl crate::RegisterSpec for ICACHE_SYNC_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [icache_sync_int_map::R]
(R) reader structure"]
impl crate::Readable for ICACHE_SYNC_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [icache_sync_int_map::W]
(W) writer structure"]
