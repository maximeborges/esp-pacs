...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi_mem_reject_intr_map]
(index.html) module"]
pub struct SPI_MEM_REJECT_INTR_MAP_SPEC;
impl crate::RegisterSpec for SPI_MEM_REJECT_INTR_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi_mem_reject_intr_map::R]
(R) reader structure"]
impl crate::Readable for SPI_MEM_REJECT_INTR_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi_mem_reject_intr_map::W]
(W) writer structure"]
