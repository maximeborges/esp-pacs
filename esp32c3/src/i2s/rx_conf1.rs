...
pub struct RX_TDM_WS_WIDTH_R(crate::FieldReader<u8>);
...
pub struct RX_BCK_DIV_NUM_R(crate::FieldReader<u8>);
...
pub struct RX_BITS_MOD_R(crate::FieldReader<u8>);
impl RX_BITS_MOD_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct RX_HALF_SAMPLE_BITS_R(crate::FieldReader<u8>);
...
pub struct RX_TDM_CHAN_BITS_R(crate::FieldReader<u8>);
