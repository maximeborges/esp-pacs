...
pub type TX_RESET_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 0>;
#[doc = "Field `TX_FIFO_RESET` writer - Set this bit to reset Tx AFIFO"]
pub type TX_FIFO_RESET_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 1>;
...
pub type TX_START_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 2>;
...
pub type TX_SLAVE_MOD_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 3>;
...
pub type TX_MONO_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 5>;
...
pub type TX_CHAN_EQUAL_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 6>;
...
pub type TX_BIG_ENDIAN_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 7>;
...
pub type TX_UPDATE_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 8>;
...
pub type TX_MONO_FST_VLD_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 9>;
...
pub type TX_PCM_CONF_W<'a> = crate::FieldWriter<'a, u32, TX_CONF_SPEC, u8, u8, 2, 10>;
...
pub type TX_PCM_BYPASS_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 12>;
...
pub type TX_STOP_EN_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 13>;
...
pub type TX_LEFT_ALIGN_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 15>;
...
pub type TX_24_FILL_EN_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 16>;
...
pub type TX_WS_IDLE_POL_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 17>;
...
pub type TX_BIT_ORDER_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 18>;
...
pub type TX_TDM_EN_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 19>;
...
pub type TX_PDM_EN_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 20>;
...
pub type TX_CHAN_MOD_W<'a> = crate::FieldWriter<'a, u32, TX_CONF_SPEC, u8, u8, 3, 24>;
...
pub type SIG_LOOPBACK_W<'a> = crate::BitWriter<'a, u32, TX_CONF_SPEC, bool, 27>;
impl R {
