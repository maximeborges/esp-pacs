...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wr_message_mem]
(index.html) module"]
pub struct WR_MESSAGE_MEM_SPEC;
impl crate::RegisterSpec for WR_MESSAGE_MEM_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [wr_message_mem::R]
(R) reader structure"]
impl crate::Readable for WR_MESSAGE_MEM_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [wr_message_mem::W]
(W) writer structure"]
