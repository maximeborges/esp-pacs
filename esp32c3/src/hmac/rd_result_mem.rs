...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rd_result_mem]
(index.html) module"]
pub struct RD_RESULT_MEM_SPEC;
impl crate::RegisterSpec for RD_RESULT_MEM_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [rd_result_mem::R]
(R) reader structure"]
impl crate::Readable for RD_RESULT_MEM_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rd_result_mem::W]
(W) writer structure"]
