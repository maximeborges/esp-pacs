...
pub struct CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_R(crate::FieldReader<u8, u8>);
impl CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_R {
...
pub struct CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_W<'a> {
...
pub struct CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_R(crate::FieldReader<u8, u8>);
impl CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_R(crate::FieldReader<u8, u8>);
impl CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_R(crate::FieldReader<u8, u8>);
impl CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl W {
    ...
    pub fn core_1_pif_pms_constrain_rtcslow_1_world_0_l(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_W { w: self }
    }
    #[doc = "Bits 3:5 - RTCSlow_1 memory high region permission in world 0 for core1."]
    #[inline(always)]
    pub fn core_1_pif_pms_constrain_rtcslow_1_world_0_h(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_W { w: self }
    }
    #[doc = "Bits 6:8 - RTCSlow_1 memory low region permission in world 1 for core1."]
    #[inline(always)]
    pub fn core_1_pif_pms_constrain_rtcslow_1_world_1_l(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_W { w: self }
    }
    #[doc = "Bits 9:11 - RTCSlow_1 memory high region permission in world 1 for core1."]
    #[inline(always)]
    pub fn core_1_pif_pms_constrain_rtcslow_1_world_1_h(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_pif_pms_constrain_14]
(index.html) module"]
pub struct CORE_1_PIF_PMS_CONSTRAIN_14_SPEC;
impl crate::RegisterSpec for CORE_1_PIF_PMS_CONSTRAIN_14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_pif_pms_constrain_14::R]
(R) reader structure"]
impl crate::Readable for CORE_1_PIF_PMS_CONSTRAIN_14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_pif_pms_constrain_14::W]
(W) writer structure"]
