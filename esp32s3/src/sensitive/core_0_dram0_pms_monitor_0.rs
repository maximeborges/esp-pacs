...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_dram0_pms_monitor_0]
(index.html) module"]
pub struct CORE_0_DRAM0_PMS_MONITOR_0_SPEC;
impl crate::RegisterSpec for CORE_0_DRAM0_PMS_MONITOR_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_dram0_pms_monitor_0::R]
(R) reader structure"]
impl crate::Readable for CORE_0_DRAM0_PMS_MONITOR_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_dram0_pms_monitor_0::W]
(W) writer structure"]
