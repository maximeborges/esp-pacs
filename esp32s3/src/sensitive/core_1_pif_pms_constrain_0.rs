...
pub struct CORE_1_PIF_PMS_CONSTRAIN_LOCK_R(crate::FieldReader<bool, bool>);
impl CORE_1_PIF_PMS_CONSTRAIN_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_PIF_PMS_CONSTRAIN_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_PIF_PMS_CONSTRAIN_LOCK_R {
...
pub struct CORE_1_PIF_PMS_CONSTRAIN_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_PIF_PMS_CONSTRAIN_LOCK_W<'a> {
...
impl R {
    ...
    pub fn core_1_pif_pms_constrain_lock(&self) -> CORE_1_PIF_PMS_CONSTRAIN_LOCK_R {
        CORE_1_PIF_PMS_CONSTRAIN_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set 1 to lock core1 pif permission configuration register."]
    #[inline(always)]
    pub fn core_1_pif_pms_constrain_lock(&mut self) -> CORE_1_PIF_PMS_CONSTRAIN_LOCK_W {
        CORE_1_PIF_PMS_CONSTRAIN_LOCK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_pif_pms_constrain_0]
(index.html) module"]
pub struct CORE_1_PIF_PMS_CONSTRAIN_0_SPEC;
impl crate::RegisterSpec for CORE_1_PIF_PMS_CONSTRAIN_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_pif_pms_constrain_0::R]
(R) reader structure"]
impl crate::Readable for CORE_1_PIF_PMS_CONSTRAIN_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_pif_pms_constrain_0::W]
(W) writer structure"]
