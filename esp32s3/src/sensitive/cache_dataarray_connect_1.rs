...
pub struct CACHE_DATAARRAY_CONNECT_FLATTEN_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cache_dataarray_connect_1]
(index.html) module"]
pub struct CACHE_DATAARRAY_CONNECT_1_SPEC;
impl crate::RegisterSpec for CACHE_DATAARRAY_CONNECT_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cache_dataarray_connect_1::R]
(R) reader structure"]
impl crate::Readable for CACHE_DATAARRAY_CONNECT_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cache_dataarray_connect_1::W]
(W) writer structure"]
