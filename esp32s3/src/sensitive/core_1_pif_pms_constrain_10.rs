...
impl R {
    ...
    pub fn core_1_pif_pms_constrain_rtcfast_world_0_l(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_WORLD_0_L_R::new((self.bits & 0x07) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_rtcfast_world_0_h(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_WORLD_0_H_R::new(((self.bits >> 3) & 0x07) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_rtcfast_world_1_l(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_WORLD_1_L_R::new(((self.bits >> 6) & 0x07) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_rtcfast_world_1_h(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_WORLD_1_H_R::new(((self.bits >> 9) & 0x07) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - RTCFast memory low region permission in world 0 for core1."]
