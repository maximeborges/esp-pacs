...
pub struct CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_SPLTADDR_WORLD_0_R(crate::FieldReader<u16>);
...
pub struct CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_SPLTADDR_WORLD_1_R(crate::FieldReader<u16>);
