...
pub struct EDMA_PMS_SHA_LOCK_R(crate::FieldReader<bool, bool>);
impl EDMA_PMS_SHA_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        EDMA_PMS_SHA_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EDMA_PMS_SHA_LOCK_R {
...
pub struct EDMA_PMS_SHA_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> EDMA_PMS_SHA_LOCK_W<'a> {
...
impl R {
    ...
    pub fn edma_pms_sha_lock(&self) -> EDMA_PMS_SHA_LOCK_R {
        EDMA_PMS_SHA_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set 1 to lock EDMA-SHA permission control registers."]
    #[inline(always)]
    pub fn edma_pms_sha_lock(&mut self) -> EDMA_PMS_SHA_LOCK_W {
        EDMA_PMS_SHA_LOCK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [edma_pms_sha_lock]
(index.html) module"]
pub struct EDMA_PMS_SHA_LOCK_SPEC;
impl crate::RegisterSpec for EDMA_PMS_SHA_LOCK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [edma_pms_sha_lock::R]
(R) reader structure"]
impl crate::Readable for EDMA_PMS_SHA_LOCK_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [edma_pms_sha_lock::W]
(W) writer structure"]
