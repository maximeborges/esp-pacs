...
pub struct CORE_0_VECBASE_WORLD_MASK_R(crate::FieldReader<bool, bool>);
impl CORE_0_VECBASE_WORLD_MASK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_VECBASE_WORLD_MASK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_VECBASE_WORLD_MASK_R {
...
pub struct CORE_0_VECBASE_WORLD_MASK_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_VECBASE_WORLD_MASK_W<'a> {
...
impl W {
    #[doc = "Bit 0 - Set 1 to mask world, then only world0_value will work."]
    #[inline(always)]
    pub fn core_0_vecbase_world_mask(&mut self) -> CORE_0_VECBASE_WORLD_MASK_W {
        CORE_0_VECBASE_WORLD_MASK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_vecbase_override_0]
(index.html) module"]
pub struct CORE_0_VECBASE_OVERRIDE_0_SPEC;
impl crate::RegisterSpec for CORE_0_VECBASE_OVERRIDE_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_vecbase_override_0::R]
(R) reader structure"]
impl crate::Readable for CORE_0_VECBASE_OVERRIDE_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_vecbase_override_0::W]
(W) writer structure"]
