...
pub struct CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_INTR_R(crate::FieldReader<bool, bool>);
...
pub struct CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HSIZE_R(crate::FieldReader<u8, u8>);
...
pub struct CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HWORLD_R(crate::FieldReader<u8, u8>);
...
impl R {
    ...
    pub fn core_1_pif_pms_monitor_nonword_violate_intr(
        ...
        CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_INTR_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core_1_pif_pms_monitor_nonword_violate_status_hsize(
        ...
        CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HSIZE_R::new(((self.bits >> 1) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_monitor_nonword_violate_status_hworld(
        ...
        CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HWORLD_R::new(((self.bits >> 3) & 0x03) as u8)
    }
}
#[doc = "core1 permission report register 5.\n\nThis register you can [`read`]
(crate::generic::Reg::read). See [API]
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_pif_pms_monitor_5]
(index.html) module"]
pub struct CORE_1_PIF_PMS_MONITOR_5_SPEC;
impl crate::RegisterSpec for CORE_1_PIF_PMS_MONITOR_5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_pif_pms_monitor_5::R]
(R) reader structure"]
