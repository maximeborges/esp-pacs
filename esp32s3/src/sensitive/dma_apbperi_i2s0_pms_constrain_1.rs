...
pub struct DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_0_R(crate::FieldReader<u8>);
...
pub struct DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_1_R(crate::FieldReader<u8>);
...
pub struct DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_2_R(crate::FieldReader<u8>);
...
pub struct DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_3_R(crate::FieldReader<u8>);
...
pub struct DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_R(crate::FieldReader<u8>);
...
pub struct DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_R(crate::FieldReader<u8>);
