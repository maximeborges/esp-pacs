...
impl R {
    ...
    pub fn dma_apbperi_sdio_pms_constrain_sram_pms_0(
        ...
        DMA_APBPERI_SDIO_PMS_CONSTRAIN_SRAM_PMS_0_R::new((self.bits & 0x03) as u8)
    }
    ...
    pub fn dma_apbperi_sdio_pms_constrain_sram_pms_1(
        ...
        DMA_APBPERI_SDIO_PMS_CONSTRAIN_SRAM_PMS_1_R::new(((self.bits >> 2) & 0x03) as u8)
    }
    ...
    pub fn dma_apbperi_sdio_pms_constrain_sram_pms_2(
        ...
        DMA_APBPERI_SDIO_PMS_CONSTRAIN_SRAM_PMS_2_R::new(((self.bits >> 4) & 0x03) as u8)
    }
    ...
    pub fn dma_apbperi_sdio_pms_constrain_sram_pms_3(
        ...
        DMA_APBPERI_SDIO_PMS_CONSTRAIN_SRAM_PMS_3_R::new(((self.bits >> 6) & 0x03) as u8)
    }
