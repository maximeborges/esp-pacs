...
impl R {
    ...
    pub fn core_1_pif_pms_constrain_world_0_usb_device(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_USB_DEVICE_R::new((self.bits & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_usb_wrap(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_USB_WRAP_R::new(((self.bits >> 2) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_crypto_peri(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_CRYPTO_PERI_R::new(((self.bits >> 4) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_crypto_dma(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_CRYPTO_DMA_R::new(((self.bits >> 6) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_apb_adc(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_APB_ADC_R::new(((self.bits >> 8) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_lcd_cam(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_LCD_CAM_R::new(((self.bits >> 10) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_bt_pwr(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_BT_PWR_R::new(((self.bits >> 12) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_usb(&self) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_USB_R {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_USB_R::new(((self.bits >> 14) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_system(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_SYSTEM_R::new(((self.bits >> 16) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_sensitive(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_SENSITIVE_R::new(((self.bits >> 18) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_interrupt(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_INTERRUPT_R::new(((self.bits >> 20) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_dma_copy(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_DMA_COPY_R::new(((self.bits >> 22) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_cache_config(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_CACHE_CONFIG_R::new(((self.bits >> 24) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_ad(&self) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_AD_R {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_AD_R::new(((self.bits >> 26) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_dio(&self) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_DIO_R {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_DIO_R::new(((self.bits >> 28) & 0x03) as u8)
    }
    ...
    pub fn core_1_pif_pms_constrain_world_0_world_controller(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_WORLD_CONTROLLER_R::new(((self.bits >> 30) & 0x03) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - Core1 access usb_device permission in world0."]
