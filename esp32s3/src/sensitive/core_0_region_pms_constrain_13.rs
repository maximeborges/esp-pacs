...
pub struct CORE_0_REGION_PMS_CONSTRAIN_ADDR_10_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_region_pms_constrain_13]
(index.html) module"]
pub struct CORE_0_REGION_PMS_CONSTRAIN_13_SPEC;
impl crate::RegisterSpec for CORE_0_REGION_PMS_CONSTRAIN_13_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_region_pms_constrain_13::R]
(R) reader structure"]
impl crate::Readable for CORE_0_REGION_PMS_CONSTRAIN_13_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_region_pms_constrain_13::W]
(W) writer structure"]
