...
impl CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_6_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_6_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_6_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_6_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    pub fn core_x_iram0_dram0_dma_sram_category_3(
        ...
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3_R::new(((self.bits >> 6) & 0x03) as u8)
    }
    ...
    pub fn core_x_iram0_dram0_dma_sram_category_4(
        ...
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4_R::new(((self.bits >> 8) & 0x03) as u8)
    }
    ...
    pub fn core_x_iram0_dram0_dma_sram_category_5(
        ...
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5_R::new(((self.bits >> 10) & 0x03) as u8)
    }
    ...
    pub fn core_x_iram0_dram0_dma_sram_category_6(
        ...
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_6_R::new(((self.bits >> 12) & 0x03) as u8)
    }
...
impl W {
    ...
    pub fn core_x_iram0_dram0_dma_sram_category_3(
        ...
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3_W { w: self }
    }
    #[doc = "Bits 8:9 - category4 of core_x_iram0_dram_dma_line, if the splitaddress in block4 of SRAM, configured as 0x10, else if the splitaddress below block4 of SRAM, configured as 0x11, else if splitaddress higher than block4 of SRAM, configured as 0x00"]
    #[inline(always)]
    pub fn core_x_iram0_dram0_dma_sram_category_4(
        ...
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4_W { w: self }
    }
    #[doc = "Bits 10:11 - category5 of core_x_iram0_dram_dma_line, if the splitaddress in block5 of SRAM, configured as 0x10, else if the splitaddress below block5 of SRAM, configured as 0x11, else if splitaddress higher than block5 of SRAM, configured as 0x00"]
    #[inline(always)]
    pub fn core_x_iram0_dram0_dma_sram_category_5(
        ...
        CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5_W { w: self }
    }
    #[doc = "Bits 12:13 - category6 of core_x_iram0_dram_dma_line, if the splitaddress in block6 of SRAM, configured as 0x10, else if the splitaddress below block6 of SRAM, configured as 0x11, else if splitaddress higher than block6 of SRAM, configured as 0x00"]
    #[inline(always)]
    pub fn core_x_iram0_dram0_dma_sram_category_6(
