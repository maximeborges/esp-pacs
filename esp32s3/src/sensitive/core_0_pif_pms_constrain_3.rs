...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SPI_2_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SPI_3_R(crate::FieldReader<u8>);
impl CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SPI_3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SPI_3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SPI_3_R {
    type Target = crate::FieldReader<u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SPI_3_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SPI_3_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_APB_CTRL_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_I2C_EXT1_R(crate::FieldReader<u8>);
impl CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_I2C_EXT1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_I2C_EXT1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_I2C_EXT1_R {
    type Target = crate::FieldReader<u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_I2C_EXT1_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_I2C_EXT1_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SDIO_HOST_R(crate::FieldReader<u8>);
impl CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SDIO_HOST_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SDIO_HOST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SDIO_HOST_R {
    type Target = crate::FieldReader<u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SDIO_HOST_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SDIO_HOST_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_CAN_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PWM1_R(crate::FieldReader<u8>);
impl CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PWM1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PWM1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PWM1_R {
    type Target = crate::FieldReader<u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PWM1_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PWM1_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_I2S1_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_UART2_R(crate::FieldReader<u8>);
impl CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_UART2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_UART2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_UART2_R {
    type Target = crate::FieldReader<u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_UART2_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_UART2_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_RWBT_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_WIFIMAC_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PWR_R(crate::FieldReader<u8>);
...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_world_0_spi_3(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SPI_3_W {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SPI_3_W { w: self }
    }
    #[doc = "Bits 4:5 - Core0 access apb_ctrl permission in world0."]
    #[inline(always)]
    pub fn core_0_pif_pms_constrain_world_0_apb_ctrl(
    ...
    pub fn core_0_pif_pms_constrain_world_0_i2c_ext1(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_I2C_EXT1_W {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_I2C_EXT1_W { w: self }
    }
    #[doc = "Bits 8:9 - Core0 access sdio_host permission in world0."]
    #[inline(always)]
    pub fn core_0_pif_pms_constrain_world_0_sdio_host(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SDIO_HOST_W {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SDIO_HOST_W { w: self }
    }
    #[doc = "Bits 10:11 - Core0 access can permission in world0."]
    #[inline(always)]
    ...
    pub fn core_0_pif_pms_constrain_world_0_pwm1(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PWM1_W {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PWM1_W { w: self }
    }
    #[doc = "Bits 14:15 - Core0 access i2s1 permission in world0."]
    #[inline(always)]
    ...
    pub fn core_0_pif_pms_constrain_world_0_uart2(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_UART2_W {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_UART2_W { w: self }
    }
    #[doc = "Bits 22:23 - Core0 access rwbt permission in world0."]
    #[inline(always)]
