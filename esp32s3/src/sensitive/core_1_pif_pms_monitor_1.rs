...
pub struct CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_R(crate::FieldReader<bool, bool>);
impl CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_R {
...
pub struct CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_W<'a> {
...
pub struct CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_R(crate::FieldReader<bool, bool>);
impl CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn core_1_pif_pms_monitor_violate_clr(&self) -> CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_R {
        CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core_1_pif_pms_monitor_violate_en(&self) -> CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_R {
        CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_R::new(((self.bits >> 1) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set 1 to clear interrupt that core1 initiate illegal PIF bus access."]
    #[inline(always)]
    pub fn core_1_pif_pms_monitor_violate_clr(&mut self) -> CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_W {
        CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_W { w: self }
    }
    #[doc = "Bit 1 - Set 1 to enable interrupt that core1 initiate illegal PIF bus access."]
    #[inline(always)]
    pub fn core_1_pif_pms_monitor_violate_en(&mut self) -> CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_W {
        CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_pif_pms_monitor_1]
(index.html) module"]
pub struct CORE_1_PIF_PMS_MONITOR_1_SPEC;
impl crate::RegisterSpec for CORE_1_PIF_PMS_MONITOR_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_pif_pms_monitor_1::R]
(R) reader structure"]
impl crate::Readable for CORE_1_PIF_PMS_MONITOR_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_pif_pms_monitor_1::W]
(W) writer structure"]
