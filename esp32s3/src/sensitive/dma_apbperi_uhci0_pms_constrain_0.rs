...
pub struct DMA_APBPERI_UHCI0_PMS_CONSTRAIN_LOCK_R(crate::FieldReader<bool, bool>);
impl DMA_APBPERI_UHCI0_PMS_CONSTRAIN_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        DMA_APBPERI_UHCI0_PMS_CONSTRAIN_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMA_APBPERI_UHCI0_PMS_CONSTRAIN_LOCK_R {
...
pub struct DMA_APBPERI_UHCI0_PMS_CONSTRAIN_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> DMA_APBPERI_UHCI0_PMS_CONSTRAIN_LOCK_W<'a> {
...
impl R {
    ...
    pub fn dma_apbperi_uhci0_pms_constrain_lock(&self) -> DMA_APBPERI_UHCI0_PMS_CONSTRAIN_LOCK_R {
        DMA_APBPERI_UHCI0_PMS_CONSTRAIN_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set 1 to lock uhci0 dma permission Configuration Register."]
    ...
    pub fn dma_apbperi_uhci0_pms_constrain_lock(
        &mut self,
    ) -> DMA_APBPERI_UHCI0_PMS_CONSTRAIN_LOCK_W {
        DMA_APBPERI_UHCI0_PMS_CONSTRAIN_LOCK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_apbperi_uhci0_pms_constrain_0]
(index.html) module"]
pub struct DMA_APBPERI_UHCI0_PMS_CONSTRAIN_0_SPEC;
impl crate::RegisterSpec for DMA_APBPERI_UHCI0_PMS_CONSTRAIN_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_apbperi_uhci0_pms_constrain_0::R]
(R) reader structure"]
impl crate::Readable for DMA_APBPERI_UHCI0_PMS_CONSTRAIN_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_apbperi_uhci0_pms_constrain_0::W]
(W) writer structure"]
