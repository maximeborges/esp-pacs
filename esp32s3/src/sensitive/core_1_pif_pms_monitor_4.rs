...
pub struct CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_CLR_R(crate::FieldReader<bool, bool>);
...
pub struct CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_EN_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn core_1_pif_pms_monitor_nonword_violate_clr(
        ...
        CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_CLR_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core_1_pif_pms_monitor_nonword_violate_en(
        ...
        CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_EN_R::new(((self.bits >> 1) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set 1 to clear interrupt that core1 initiate unsupported access type."]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_pif_pms_monitor_4]
(index.html) module"]
pub struct CORE_1_PIF_PMS_MONITOR_4_SPEC;
impl crate::RegisterSpec for CORE_1_PIF_PMS_MONITOR_4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_pif_pms_monitor_4::R]
(R) reader structure"]
impl crate::Readable for CORE_1_PIF_PMS_MONITOR_4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_pif_pms_monitor_4::W]
(W) writer structure"]
