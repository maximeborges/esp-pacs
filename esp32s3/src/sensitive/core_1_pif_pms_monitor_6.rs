...
pub struct CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HADDR_R(crate::FieldReader<u32, u32>);
impl CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HADDR_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_pif_pms_monitor_6]
(index.html) module"]
pub struct CORE_1_PIF_PMS_MONITOR_6_SPEC;
impl crate::RegisterSpec for CORE_1_PIF_PMS_MONITOR_6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_pif_pms_monitor_6::R]
(R) reader structure"]
