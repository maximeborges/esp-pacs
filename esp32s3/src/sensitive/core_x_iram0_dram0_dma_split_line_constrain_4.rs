...
impl R {
    ...
    pub fn core_x_dram0_dma_sram_line_0_category_3(
        ...
        CORE_X_DRAM0_DMA_SRAM_LINE_0_CATEGORY_3_R::new(((self.bits >> 6) & 0x03) as u8)
    }
    ...
    pub fn core_x_dram0_dma_sram_line_0_category_4(
        ...
        CORE_X_DRAM0_DMA_SRAM_LINE_0_CATEGORY_4_R::new(((self.bits >> 8) & 0x03) as u8)
    }
    ...
    pub fn core_x_dram0_dma_sram_line_0_category_5(
        ...
        CORE_X_DRAM0_DMA_SRAM_LINE_0_CATEGORY_5_R::new(((self.bits >> 10) & 0x03) as u8)
    }
    ...
    pub fn core_x_dram0_dma_sram_line_0_category_6(
        ...
        CORE_X_DRAM0_DMA_SRAM_LINE_0_CATEGORY_6_R::new(((self.bits >> 12) & 0x03) as u8)
    }
