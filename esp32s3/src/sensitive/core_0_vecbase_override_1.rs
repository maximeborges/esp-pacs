...
pub struct CORE_0_VECBASE_OVERRIDE_WORLD0_VALUE_R(crate::FieldReader<u32, u32>);
impl CORE_0_VECBASE_OVERRIDE_WORLD0_VALUE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_0_VECBASE_OVERRIDE_WORLD0_VALUE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_VECBASE_OVERRIDE_WORLD0_VALUE_R {
...
pub struct CORE_0_VECBASE_OVERRIDE_WORLD0_VALUE_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_VECBASE_OVERRIDE_WORLD0_VALUE_W<'a> {
...
pub struct CORE_0_VECBASE_OVERRIDE_SEL_R(crate::FieldReader<u8, u8>);
impl CORE_0_VECBASE_OVERRIDE_SEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_VECBASE_OVERRIDE_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_VECBASE_OVERRIDE_SEL_R {
...
pub struct CORE_0_VECBASE_OVERRIDE_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_VECBASE_OVERRIDE_SEL_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl W {
    ...
    pub fn core_0_vecbase_override_world0_value(
        &mut self,
    ) -> CORE_0_VECBASE_OVERRIDE_WORLD0_VALUE_W {
        CORE_0_VECBASE_OVERRIDE_WORLD0_VALUE_W { w: self }
    }
    #[doc = "Bits 22:23 - Set 0x3 to sel vecbase_override to override vecbase register."]
    #[inline(always)]
    pub fn core_0_vecbase_override_sel(&mut self) -> CORE_0_VECBASE_OVERRIDE_SEL_W {
        CORE_0_VECBASE_OVERRIDE_SEL_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_vecbase_override_1]
(index.html) module"]
pub struct CORE_0_VECBASE_OVERRIDE_1_SPEC;
impl crate::RegisterSpec for CORE_0_VECBASE_OVERRIDE_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_vecbase_override_1::R]
(R) reader structure"]
impl crate::Readable for CORE_0_VECBASE_OVERRIDE_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_vecbase_override_1::W]
(W) writer structure"]
