...
impl R {
    ...
    pub fn core_0_pif_pms_constrain_world_1_spi_3(
        ...
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_SPI_3_R::new(((self.bits >> 2) & 0x03) as u8)
    }
    ...
    pub fn core_0_pif_pms_constrain_world_1_i2c_ext1(
        ...
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2C_EXT1_R::new(((self.bits >> 6) & 0x03) as u8)
    }
    ...
    pub fn core_0_pif_pms_constrain_world_1_sdio_host(
        ...
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_SDIO_HOST_R::new(((self.bits >> 8) & 0x03) as u8)
    }
    ...
    pub fn core_0_pif_pms_constrain_world_1_pwm1(&self) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_PWM1_R {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_PWM1_R::new(((self.bits >> 12) & 0x03) as u8)
    }
    ...
    pub fn core_0_pif_pms_constrain_world_1_uart2(
        ...
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_UART2_R::new(((self.bits >> 16) & 0x03) as u8)
    }
