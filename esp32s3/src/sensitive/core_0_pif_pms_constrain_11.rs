...
pub struct CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0_R(crate::FieldReader<u16>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1_R(crate::FieldReader<u16>);
