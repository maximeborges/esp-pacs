...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_R(crate::FieldReader<u8, u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_R(crate::FieldReader<u8, u8>);
...
impl R {
    ...
    pub fn core_0_pif_pms_constrain_world_1_hinf(&self) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_R {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_R::new(((self.bits >> 20) & 0x03) as u8)
    }
    ...
    pub fn core_0_pif_pms_constrain_world_1_i2s0(&self) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_R {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_R::new(((self.bits >> 28) & 0x03) as u8)
    }
