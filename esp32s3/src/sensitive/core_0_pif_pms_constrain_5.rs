...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_UART_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_G0SPI_1_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_G0SPI_0_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_GPIO_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_FE2_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_FE_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_RTC_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_IO_MUX_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_R(crate::FieldReader<u8>);
impl CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_R {
    type Target = crate::FieldReader<u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_MISC_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2C_R(crate::FieldReader<u8>);
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_R(crate::FieldReader<u8>);
impl CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_R {
    type Target = crate::FieldReader<u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_UART1_R(crate::FieldReader<u8>);
...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_world_1_hinf(
        ...
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_W { w: self }
    }
    #[doc = "Bits 24:25 - Core0 access misc permission in world1."]
    #[inline(always)]
    ...
    pub fn core_0_pif_pms_constrain_world_1_i2s0(
        ...
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_W { w: self }
    }
    #[doc = "Bits 30:31 - Core0 access uart1 permission in world1."]
    #[inline(always)]
    pub fn core_0_pif_pms_constrain_world_1_uart1(
