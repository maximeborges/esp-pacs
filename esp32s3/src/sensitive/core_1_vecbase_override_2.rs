...
pub struct CORE_1_VECBASE_OVERRIDE_WORLD1_VALUE_R(crate::FieldReader<u32, u32>);
impl CORE_1_VECBASE_OVERRIDE_WORLD1_VALUE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_1_VECBASE_OVERRIDE_WORLD1_VALUE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_VECBASE_OVERRIDE_WORLD1_VALUE_R {
...
pub struct CORE_1_VECBASE_OVERRIDE_WORLD1_VALUE_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_VECBASE_OVERRIDE_WORLD1_VALUE_W<'a> {
...
impl W {
    ...
    pub fn core_1_vecbase_override_world1_value(
        &mut self,
    ) -> CORE_1_VECBASE_OVERRIDE_WORLD1_VALUE_W {
        CORE_1_VECBASE_OVERRIDE_WORLD1_VALUE_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_vecbase_override_2]
(index.html) module"]
pub struct CORE_1_VECBASE_OVERRIDE_2_SPEC;
impl crate::RegisterSpec for CORE_1_VECBASE_OVERRIDE_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_vecbase_override_2::R]
(R) reader structure"]
impl crate::Readable for CORE_1_VECBASE_OVERRIDE_2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_vecbase_override_2::W]
(W) writer structure"]
