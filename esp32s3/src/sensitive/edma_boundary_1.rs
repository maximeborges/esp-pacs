...
pub struct EDMA_BOUNDARY_1_R(crate::FieldReader<u16, u16>);
impl EDMA_BOUNDARY_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        EDMA_BOUNDARY_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EDMA_BOUNDARY_1_R {
...
pub struct EDMA_BOUNDARY_1_W<'a> {
    w: &'a mut W,
}
impl<'a> EDMA_BOUNDARY_1_W<'a> {
...
impl W {
    #[doc = "Bits 0:13 - This field is used to configure the boundary 1 of external RAM. The unit is 4K. For example, set this field to 0x80, then the address boundary 0 would be 0x3C080000 (0x3C000000 + 0x80 * 4K)."]
    #[inline(always)]
    pub fn edma_boundary_1(&mut self) -> EDMA_BOUNDARY_1_W {
        EDMA_BOUNDARY_1_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [edma_boundary_1]
(index.html) module"]
pub struct EDMA_BOUNDARY_1_SPEC;
impl crate::RegisterSpec for EDMA_BOUNDARY_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [edma_boundary_1::R]
(R) reader structure"]
impl crate::Readable for EDMA_BOUNDARY_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [edma_boundary_1::W]
(W) writer structure"]
