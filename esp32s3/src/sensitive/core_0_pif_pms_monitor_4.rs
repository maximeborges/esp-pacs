...
pub struct CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_CLR_R(crate::FieldReader<bool>);
...
pub struct CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_EN_R(crate::FieldReader<bool>);
