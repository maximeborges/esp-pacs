...
pub struct CORE_0_REGION_PMS_CONSTRAIN_ADDR_9_R(crate::FieldReader<u32, u32>);
impl CORE_0_REGION_PMS_CONSTRAIN_ADDR_9_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_9_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_REGION_PMS_CONSTRAIN_ADDR_9_R {
...
pub struct CORE_0_REGION_PMS_CONSTRAIN_ADDR_9_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_REGION_PMS_CONSTRAIN_ADDR_9_W<'a> {
...
impl W {
    #[doc = "Bits 0:29 - Region 8 end address and Region 9 start address for core0."]
    #[inline(always)]
    pub fn core_0_region_pms_constrain_addr_9(&mut self) -> CORE_0_REGION_PMS_CONSTRAIN_ADDR_9_W {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_9_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_region_pms_constrain_12]
(index.html) module"]
pub struct CORE_0_REGION_PMS_CONSTRAIN_12_SPEC;
impl crate::RegisterSpec for CORE_0_REGION_PMS_CONSTRAIN_12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_region_pms_constrain_12::R]
(R) reader structure"]
impl crate::Readable for CORE_0_REGION_PMS_CONSTRAIN_12_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_region_pms_constrain_12::W]
(W) writer structure"]
