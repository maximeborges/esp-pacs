...
pub struct EDMA_BOUNDARY_LOCK_R(crate::FieldReader<bool, bool>);
impl EDMA_BOUNDARY_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        EDMA_BOUNDARY_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EDMA_BOUNDARY_LOCK_R {
...
pub struct EDMA_BOUNDARY_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> EDMA_BOUNDARY_LOCK_W<'a> {
...
impl R {
    ...
    pub fn edma_boundary_lock(&self) -> EDMA_BOUNDARY_LOCK_R {
        EDMA_BOUNDARY_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set 1 to lock EDMA boundary registers."]
    #[inline(always)]
    pub fn edma_boundary_lock(&mut self) -> EDMA_BOUNDARY_LOCK_W {
        EDMA_BOUNDARY_LOCK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [edma_boundary_lock]
(index.html) module"]
pub struct EDMA_BOUNDARY_LOCK_SPEC;
impl crate::RegisterSpec for EDMA_BOUNDARY_LOCK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [edma_boundary_lock::R]
(R) reader structure"]
impl crate::Readable for EDMA_BOUNDARY_LOCK_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [edma_boundary_lock::W]
(W) writer structure"]
