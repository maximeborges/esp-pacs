...
pub struct CORE_0_REGION_PMS_CONSTRAIN_ADDR_8_R(crate::FieldReader<u32, u32>);
impl CORE_0_REGION_PMS_CONSTRAIN_ADDR_8_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_8_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_REGION_PMS_CONSTRAIN_ADDR_8_R {
...
pub struct CORE_0_REGION_PMS_CONSTRAIN_ADDR_8_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_REGION_PMS_CONSTRAIN_ADDR_8_W<'a> {
...
impl W {
    #[doc = "Bits 0:29 - Region 7 end address and Region 8 start address for core0."]
    #[inline(always)]
    pub fn core_0_region_pms_constrain_addr_8(&mut self) -> CORE_0_REGION_PMS_CONSTRAIN_ADDR_8_W {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_8_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_region_pms_constrain_11]
(index.html) module"]
pub struct CORE_0_REGION_PMS_CONSTRAIN_11_SPEC;
impl crate::RegisterSpec for CORE_0_REGION_PMS_CONSTRAIN_11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_region_pms_constrain_11::R]
(R) reader structure"]
impl crate::Readable for CORE_0_REGION_PMS_CONSTRAIN_11_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_region_pms_constrain_11::W]
(W) writer structure"]
