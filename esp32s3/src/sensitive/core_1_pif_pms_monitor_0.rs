...
pub struct CORE_1_PIF_PMS_MONITOR_LOCK_R(crate::FieldReader<bool, bool>);
impl CORE_1_PIF_PMS_MONITOR_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_PIF_PMS_MONITOR_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_PIF_PMS_MONITOR_LOCK_R {
...
pub struct CORE_1_PIF_PMS_MONITOR_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_PIF_PMS_MONITOR_LOCK_W<'a> {
...
impl R {
    ...
    pub fn core_1_pif_pms_monitor_lock(&self) -> CORE_1_PIF_PMS_MONITOR_LOCK_R {
        CORE_1_PIF_PMS_MONITOR_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set 1 to lock core1 permission report registers."]
    #[inline(always)]
    pub fn core_1_pif_pms_monitor_lock(&mut self) -> CORE_1_PIF_PMS_MONITOR_LOCK_W {
        CORE_1_PIF_PMS_MONITOR_LOCK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_pif_pms_monitor_0]
(index.html) module"]
pub struct CORE_1_PIF_PMS_MONITOR_0_SPEC;
impl crate::RegisterSpec for CORE_1_PIF_PMS_MONITOR_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_pif_pms_monitor_0::R]
(R) reader structure"]
impl crate::Readable for CORE_1_PIF_PMS_MONITOR_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_pif_pms_monitor_0::W]
(W) writer structure"]
