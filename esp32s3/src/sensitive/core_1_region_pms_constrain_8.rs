...
pub struct CORE_1_REGION_PMS_CONSTRAIN_ADDR_5_R(crate::FieldReader<u32, u32>);
impl CORE_1_REGION_PMS_CONSTRAIN_ADDR_5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_1_REGION_PMS_CONSTRAIN_ADDR_5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_REGION_PMS_CONSTRAIN_ADDR_5_R {
...
pub struct CORE_1_REGION_PMS_CONSTRAIN_ADDR_5_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_REGION_PMS_CONSTRAIN_ADDR_5_W<'a> {
...
impl W {
    #[doc = "Bits 0:29 - Region 4 end address and Region 5 start address for core1."]
    #[inline(always)]
    pub fn core_1_region_pms_constrain_addr_5(&mut self) -> CORE_1_REGION_PMS_CONSTRAIN_ADDR_5_W {
        CORE_1_REGION_PMS_CONSTRAIN_ADDR_5_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_region_pms_constrain_8]
(index.html) module"]
pub struct CORE_1_REGION_PMS_CONSTRAIN_8_SPEC;
impl crate::RegisterSpec for CORE_1_REGION_PMS_CONSTRAIN_8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_region_pms_constrain_8::R]
(R) reader structure"]
impl crate::Readable for CORE_1_REGION_PMS_CONSTRAIN_8_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_region_pms_constrain_8::W]
(W) writer structure"]
