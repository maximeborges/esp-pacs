...
pub type RXFIFO_FULL_THRHD_W<'a> = crate::FieldWriter<'a, u32, CONF1_SPEC, u16, u16, 10, 0>;
...
pub type TXFIFO_EMPTY_THRHD_W<'a> = crate::FieldWriter<'a, u32, CONF1_SPEC, u16, u16, 10, 10>;
...
pub type DIS_RX_DAT_OVF_W<'a> = crate::BitWriter<'a, u32, CONF1_SPEC, bool, 20>;
...
pub type RX_TOUT_FLOW_DIS_W<'a> = crate::BitWriter<'a, u32, CONF1_SPEC, bool, 21>;
...
pub type RX_FLOW_EN_W<'a> = crate::BitWriter<'a, u32, CONF1_SPEC, bool, 22>;
...
pub type RX_TOUT_EN_W<'a> = crate::BitWriter<'a, u32, CONF1_SPEC, bool, 23>;
impl R {
