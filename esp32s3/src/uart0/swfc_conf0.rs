...
pub type XOFF_THRESHOLD_W<'a> = crate::FieldWriter<'a, u32, SWFC_CONF0_SPEC, u16, u16, 10, 0>;
...
pub type XOFF_CHAR_W<'a> = crate::FieldWriter<'a, u32, SWFC_CONF0_SPEC, u8, u8, 8, 10>;
impl R {
