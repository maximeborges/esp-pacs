...
pub type RX_FLOW_THRHD_W<'a> = crate::FieldWriter<'a, u32, MEM_CONF_SPEC, u16, u16, 10, 7>;
...
pub type RX_TOUT_THRHD_W<'a> = crate::FieldWriter<'a, u32, MEM_CONF_SPEC, u16, u16, 10, 17>;
...
pub type MEM_FORCE_PD_W<'a> = crate::BitWriter<'a, u32, MEM_CONF_SPEC, bool, 27>;
...
pub type MEM_FORCE_PU_W<'a> = crate::BitWriter<'a, u32, MEM_CONF_SPEC, bool, 28>;
impl R {
