...
pub struct SPI_INTR_3_MAP_R(crate::FieldReader<u8, u8>);
impl SPI_INTR_3_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SPI_INTR_3_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SPI_INTR_3_MAP_R {
...
pub struct SPI_INTR_3_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> SPI_INTR_3_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - this register used to map spi_intr_3 interrupt to one of core0's external interrupt"]
    #[inline(always)]
    pub fn spi_intr_3_map(&mut self) -> SPI_INTR_3_MAP_W {
        SPI_INTR_3_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi_intr_3_map]
(index.html) module"]
pub struct SPI_INTR_3_MAP_SPEC;
impl crate::RegisterSpec for SPI_INTR_3_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi_intr_3_map::R]
(R) reader structure"]
impl crate::Readable for SPI_INTR_3_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi_intr_3_map::W]
(W) writer structure"]
