...
pub struct PWM2_INTR_MAP_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm2_intr_map]
(index.html) module"]
pub struct PWM2_INTR_MAP_SPEC;
impl crate::RegisterSpec for PWM2_INTR_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm2_intr_map::R]
(R) reader structure"]
impl crate::Readable for PWM2_INTR_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwm2_intr_map::W]
(W) writer structure"]
