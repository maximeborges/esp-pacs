...
pub struct TG1_T1_INT_MAP_R(crate::FieldReader<u8, u8>);
impl TG1_T1_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        TG1_T1_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TG1_T1_INT_MAP_R {
...
pub struct TG1_T1_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> TG1_T1_INT_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - this register used to map tg1_t1 interrupt to one of core0's external interrupt"]
    #[inline(always)]
    pub fn tg1_t1_int_map(&mut self) -> TG1_T1_INT_MAP_W {
        TG1_T1_INT_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tg1_t1_int_map]
(index.html) module"]
pub struct TG1_T1_INT_MAP_SPEC;
impl crate::RegisterSpec for TG1_T1_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tg1_t1_int_map::R]
(R) reader structure"]
impl crate::Readable for TG1_T1_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tg1_t1_int_map::W]
(W) writer structure"]
