...
pub struct PWM0_INTR_MAP_R(crate::FieldReader<u8, u8>);
impl PWM0_INTR_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PWM0_INTR_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PWM0_INTR_MAP_R {
...
pub struct PWM0_INTR_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> PWM0_INTR_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - this register used to map pwm0 interrupt to one of core0's external interrupt"]
    #[inline(always)]
    pub fn pwm0_intr_map(&mut self) -> PWM0_INTR_MAP_W {
        PWM0_INTR_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm0_intr_map]
(index.html) module"]
pub struct PWM0_INTR_MAP_SPEC;
impl crate::RegisterSpec for PWM0_INTR_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm0_intr_map::R]
(R) reader structure"]
impl crate::Readable for PWM0_INTR_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwm0_intr_map::W]
(W) writer structure"]
