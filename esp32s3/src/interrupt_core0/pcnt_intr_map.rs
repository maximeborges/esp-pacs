...
pub struct PCNT_INTR_MAP_R(crate::FieldReader<u8, u8>);
impl PCNT_INTR_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PCNT_INTR_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PCNT_INTR_MAP_R {
...
pub struct PCNT_INTR_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> PCNT_INTR_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - this register used to map pcnt interrupt to one of core0's external interrupt"]
    #[inline(always)]
    pub fn pcnt_intr_map(&mut self) -> PCNT_INTR_MAP_W {
        PCNT_INTR_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pcnt_intr_map]
(index.html) module"]
pub struct PCNT_INTR_MAP_SPEC;
impl crate::RegisterSpec for PCNT_INTR_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pcnt_intr_map::R]
(R) reader structure"]
impl crate::Readable for PCNT_INTR_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pcnt_intr_map::W]
(W) writer structure"]
