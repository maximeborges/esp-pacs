...
pub struct PERI_BACKUP_INT_MAP_R(crate::FieldReader<u8, u8>);
impl PERI_BACKUP_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PERI_BACKUP_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PERI_BACKUP_INT_MAP_R {
...
pub struct PERI_BACKUP_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> PERI_BACKUP_INT_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - this register used to map peri_backup interrupt to one of core0's external interrupt"]
    #[inline(always)]
    pub fn peri_backup_int_map(&mut self) -> PERI_BACKUP_INT_MAP_W {
        PERI_BACKUP_INT_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [peri_backup_int_map]
(index.html) module"]
pub struct PERI_BACKUP_INT_MAP_SPEC;
impl crate::RegisterSpec for PERI_BACKUP_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [peri_backup_int_map::R]
(R) reader structure"]
impl crate::Readable for PERI_BACKUP_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [peri_backup_int_map::W]
(W) writer structure"]
