...
pub struct UHCI1_INTR_MAP_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uhci1_intr_map]
(index.html) module"]
pub struct UHCI1_INTR_MAP_SPEC;
impl crate::RegisterSpec for UHCI1_INTR_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uhci1_intr_map::R]
(R) reader structure"]
impl crate::Readable for UHCI1_INTR_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uhci1_intr_map::W]
(W) writer structure"]
