...
pub struct INTR_STATUS_3_R(crate::FieldReader<u32, u32>);
impl INTR_STATUS_3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        INTR_STATUS_3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INTR_STATUS_3_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [intr_status_3]
(index.html) module"]
pub struct INTR_STATUS_3_SPEC;
impl crate::RegisterSpec for INTR_STATUS_3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [intr_status_3::R]
(R) reader structure"]
