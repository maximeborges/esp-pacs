...
pub struct CMPR0_B_R(crate::FieldReader<u16, u16>);
impl CMPR0_B_R {
    #[inline(always)]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cmpr0_value1]
(index.html) module"]
pub struct CMPR0_VALUE1_SPEC;
impl crate::RegisterSpec for CMPR0_VALUE1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cmpr0_value1::R]
(R) reader structure"]
impl crate::Readable for CMPR0_VALUE1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cmpr0_value1::W]
(W) writer structure"]
