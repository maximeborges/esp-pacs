...
pub struct CMPR2_A_R(crate::FieldReader<u16, u16>);
impl CMPR2_A_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CMPR2_A_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CMPR2_A_R {
...
impl W {
    #[doc = "Bits 0:15 - PWM generator 2 time stamp A's shadow register"]
    #[inline(always)]
    pub fn cmpr2_a(&mut self) -> CMPR2_A_W {
        CMPR2_A_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cmpr2_value0]
(index.html) module"]
pub struct CMPR2_VALUE0_SPEC;
impl crate::RegisterSpec for CMPR2_VALUE0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cmpr2_value0::R]
(R) reader structure"]
impl crate::Readable for CMPR2_VALUE0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cmpr2_value0::W]
(W) writer structure"]
