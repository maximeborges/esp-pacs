...
pub struct DB0_FED_UPMETHOD_R(crate::FieldReader<u8>);
...
pub struct DB0_RED_UPMETHOD_R(crate::FieldReader<u8>);
...
pub struct DB0_DEB_MODE_R(crate::FieldReader<bool>);
impl DB0_DEB_MODE_R {
    #[inline(always)]
...
pub struct DB0_A_OUTSWAP_R(crate::FieldReader<bool>);
...
pub struct DB0_B_OUTSWAP_R(crate::FieldReader<bool>);
...
pub struct DB0_RED_INSEL_R(crate::FieldReader<bool>);
...
pub struct DB0_FED_INSEL_R(crate::FieldReader<bool>);
...
pub struct DB0_RED_OUTINVERT_R(crate::FieldReader<bool>);
...
pub struct DB0_FED_OUTINVERT_R(crate::FieldReader<bool>);
...
pub struct DB0_A_OUTBYPASS_R(crate::FieldReader<bool>);
...
pub struct DB0_B_OUTBYPASS_R(crate::FieldReader<bool>);
...
pub struct DB0_CLK_SEL_R(crate::FieldReader<bool>);
impl DB0_CLK_SEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
