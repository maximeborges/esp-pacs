...
pub struct DB0_FED_R(crate::FieldReader<u16, u16>);
impl DB0_FED_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DB0_FED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DB0_FED_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [db0_fed_cfg]
(index.html) module"]
pub struct DB0_FED_CFG_SPEC;
impl crate::RegisterSpec for DB0_FED_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [db0_fed_cfg::R]
(R) reader structure"]
impl crate::Readable for DB0_FED_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [db0_fed_cfg::W]
(W) writer structure"]
