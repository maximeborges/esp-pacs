...
pub struct CMPR0_A_UPMETHOD_R(crate::FieldReader<u8>);
...
pub struct CMPR0_B_UPMETHOD_R(crate::FieldReader<u8>);
...
pub struct CMPR0_A_SHDW_FULL_R(crate::FieldReader<bool>);
...
pub struct CMPR0_B_SHDW_FULL_R(crate::FieldReader<bool>);
