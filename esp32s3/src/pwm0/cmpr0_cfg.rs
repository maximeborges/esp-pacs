...
pub type CMPR0_A_UPMETHOD_W<'a> = crate::FieldWriter<'a, u32, CMPR0_CFG_SPEC, u8, u8, 4, 0>;
...
pub type CMPR0_B_UPMETHOD_W<'a> = crate::FieldWriter<'a, u32, CMPR0_CFG_SPEC, u8, u8, 4, 4>;
