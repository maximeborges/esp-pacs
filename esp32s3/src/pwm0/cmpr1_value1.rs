...
pub struct CMPR1_B_R(crate::FieldReader<u16, u16>);
impl CMPR1_B_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CMPR1_B_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CMPR1_B_R {
...
impl W {
    #[doc = "Bits 0:15 - PWM generator 1 time stamp B's shadow register"]
    #[inline(always)]
    pub fn cmpr1_b(&mut self) -> CMPR1_B_W {
        CMPR1_B_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cmpr1_value1]
(index.html) module"]
pub struct CMPR1_VALUE1_SPEC;
impl crate::RegisterSpec for CMPR1_VALUE1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cmpr1_value1::R]
(R) reader structure"]
impl crate::Readable for CMPR1_VALUE1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cmpr1_value1::W]
(W) writer structure"]
