...
pub type UTEZ_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 0>;
...
pub type UTEP_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 2>;
...
pub type UTEA_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 4>;
...
pub type UTEB_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 6>;
...
pub type UT0_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 8>;
...
pub type UT1_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 10>;
...
pub type DTEZ_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 12>;
...
pub type DTEP_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 14>;
...
pub type DTEA_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 16>;
...
pub type DTEB_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 18>;
...
pub type DT0_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 20>;
...
pub type DT1_W<'a> = crate::FieldWriter<'a, u32, GEN0_A_SPEC, u8, u8, 2, 22>;
impl R {
