...
pub struct DB2_RED_R(crate::FieldReader<u16, u16>);
impl DB2_RED_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DB2_RED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DB2_RED_R {
...
impl W {
    #[doc = "Bits 0:15 - Shadow register for RED"]
    #[inline(always)]
    pub fn db2_red(&mut self) -> DB2_RED_W {
        DB2_RED_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [db2_red_cfg]
(index.html) module"]
pub struct DB2_RED_CFG_SPEC;
impl crate::RegisterSpec for DB2_RED_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [db2_red_cfg::R]
(R) reader structure"]
impl crate::Readable for DB2_RED_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [db2_red_cfg::W]
(W) writer structure"]
