...
pub struct CMPR1_A_UPMETHOD_R(crate::FieldReader<u8>);
...
pub struct CMPR1_B_UPMETHOD_R(crate::FieldReader<u8>);
...
pub struct CMPR1_A_SHDW_FULL_R(crate::FieldReader<bool>);
...
pub struct CMPR1_B_SHDW_FULL_R(crate::FieldReader<bool>);
