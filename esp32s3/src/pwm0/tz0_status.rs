...
pub struct TZ0_CBC_ON_R(crate::FieldReader<bool, bool>);
impl TZ0_CBC_ON_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        TZ0_CBC_ON_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TZ0_CBC_ON_R {
...
pub struct TZ0_OST_ON_R(crate::FieldReader<bool, bool>);
impl TZ0_OST_ON_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        TZ0_OST_ON_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TZ0_OST_ON_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
