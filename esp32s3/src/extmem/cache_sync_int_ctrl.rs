...
pub struct ICACHE_SYNC_INT_ST_R(crate::FieldReader<bool>);
...
pub struct ICACHE_SYNC_INT_ENA_R(crate::FieldReader<bool>);
...
pub struct DCACHE_SYNC_INT_ST_R(crate::FieldReader<bool>);
impl DCACHE_SYNC_INT_ST_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        DCACHE_SYNC_INT_ST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DCACHE_SYNC_INT_ST_R {
    type Target = crate::FieldReader<bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DCACHE_SYNC_INT_ENA_R(crate::FieldReader<bool>);
impl DCACHE_SYNC_INT_ENA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        DCACHE_SYNC_INT_ENA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DCACHE_SYNC_INT_ENA_R {
    type Target = crate::FieldReader<bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DCACHE_SYNC_INT_ENA_W<'a> {
    w: &'a mut W,
}
impl<'a> DCACHE_SYNC_INT_ENA_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct DCACHE_SYNC_INT_CLR_W<'a> {
    w: &'a mut W,
}
impl<'a> DCACHE_SYNC_INT_CLR_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 4 - The bit is used to enable the interrupt by dcache sync done."]
    #[inline(always)]
    pub fn dcache_sync_int_ena(&mut self) -> DCACHE_SYNC_INT_ENA_W {
        DCACHE_SYNC_INT_ENA_W { w: self }
    }
    #[doc = "Bit 5 - The bit is used to clear the interrupt by dcache sync done."]
    #[inline(always)]
    pub fn dcache_sync_int_clr(&mut self) -> DCACHE_SYNC_INT_CLR_W {
        DCACHE_SYNC_INT_CLR_W { w: self }
    }
