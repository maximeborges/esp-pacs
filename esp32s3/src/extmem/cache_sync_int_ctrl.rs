...
pub type DCACHE_SYNC_INT_ENA_W<'a> = crate::BitWriter<'a, u32, CACHE_SYNC_INT_CTRL_SPEC, bool, 4>;
#[doc = "Field `DCACHE_SYNC_INT_CLR` writer - The bit is used to clear the interrupt by dcache sync done."]
pub type DCACHE_SYNC_INT_CLR_W<'a> = crate::BitWriter<'a, u32, CACHE_SYNC_INT_CTRL_SPEC, bool, 5>;
impl R {
