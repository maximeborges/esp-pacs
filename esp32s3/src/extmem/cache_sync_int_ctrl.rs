...
pub struct DCACHE_SYNC_INT_ST_R(crate::FieldReader<bool, bool>);
...
pub struct DCACHE_SYNC_INT_ENA_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn dcache_sync_int_st(&self) -> DCACHE_SYNC_INT_ST_R {
        DCACHE_SYNC_INT_ST_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    ...
    pub fn dcache_sync_int_ena(&self) -> DCACHE_SYNC_INT_ENA_R {
        DCACHE_SYNC_INT_ENA_R::new(((self.bits >> 4) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - The bit is used to enable the interrupt by icache sync done."]
