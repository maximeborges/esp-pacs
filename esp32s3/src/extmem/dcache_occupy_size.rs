...
pub struct DCACHE_OCCUPY_SIZE_R(crate::FieldReader<u16, u16>);
impl DCACHE_OCCUPY_SIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DCACHE_OCCUPY_SIZE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DCACHE_OCCUPY_SIZE_R {
...
pub struct DCACHE_OCCUPY_SIZE_W<'a> {
    w: &'a mut W,
}
impl<'a> DCACHE_OCCUPY_SIZE_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - The bits are used to configure the length for occupy operation. The bits are the counts of cache block. It should be combined with DCACHE_OCCUPY_ADDR_REG."]
    #[inline(always)]
    pub fn dcache_occupy_size(&mut self) -> DCACHE_OCCUPY_SIZE_W {
        DCACHE_OCCUPY_SIZE_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcache_occupy_size]
(index.html) module"]
pub struct DCACHE_OCCUPY_SIZE_SPEC;
impl crate::RegisterSpec for DCACHE_OCCUPY_SIZE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dcache_occupy_size::R]
(R) reader structure"]
impl crate::Readable for DCACHE_OCCUPY_SIZE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dcache_occupy_size::W]
(W) writer structure"]
