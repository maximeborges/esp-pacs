...
pub struct DCACHE_AUTOLOAD_SCT1_ADDR_R(crate::FieldReader<u32, u32>);
impl DCACHE_AUTOLOAD_SCT1_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        DCACHE_AUTOLOAD_SCT1_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DCACHE_AUTOLOAD_SCT1_ADDR_R {
...
pub struct DCACHE_AUTOLOAD_SCT1_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> DCACHE_AUTOLOAD_SCT1_ADDR_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the start virtual address of the second section for autoload operation. It should be combined with dcache_autoload_sct1_ena."]
    #[inline(always)]
    pub fn dcache_autoload_sct1_addr(&mut self) -> DCACHE_AUTOLOAD_SCT1_ADDR_W {
        DCACHE_AUTOLOAD_SCT1_ADDR_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcache_autoload_sct1_addr]
(index.html) module"]
pub struct DCACHE_AUTOLOAD_SCT1_ADDR_SPEC;
impl crate::RegisterSpec for DCACHE_AUTOLOAD_SCT1_ADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dcache_autoload_sct1_addr::R]
(R) reader structure"]
impl crate::Readable for DCACHE_AUTOLOAD_SCT1_ADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dcache_autoload_sct1_addr::W]
(W) writer structure"]
