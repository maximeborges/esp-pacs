...
pub struct CORE1_IBUS_VADDR_R(crate::FieldReader<u32, u32>);
impl CORE1_IBUS_VADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE1_IBUS_VADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE1_IBUS_VADDR_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core1_ibus_reject_vaddr]
(index.html) module"]
pub struct CORE1_IBUS_REJECT_VADDR_SPEC;
impl crate::RegisterSpec for CORE1_IBUS_REJECT_VADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core1_ibus_reject_vaddr::R]
(R) reader structure"]
