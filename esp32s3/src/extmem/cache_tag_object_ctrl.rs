...
pub type ICACHE_TAG_OBJECT_W<'a> = crate::BitWriter<'a, u32, CACHE_TAG_OBJECT_CTRL_SPEC, bool, 0>;
...
pub type DCACHE_TAG_OBJECT_W<'a> = crate::BitWriter<'a, u32, CACHE_TAG_OBJECT_CTRL_SPEC, bool, 1>;
impl R {
