...
pub struct DCACHE_PRELOCK_SCT1_ADDR_R(crate::FieldReader<u32, u32>);
impl DCACHE_PRELOCK_SCT1_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        DCACHE_PRELOCK_SCT1_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DCACHE_PRELOCK_SCT1_ADDR_R {
...
pub struct DCACHE_PRELOCK_SCT1_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> DCACHE_PRELOCK_SCT1_ADDR_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the second start virtual address of data prelock, which is combined with DCACHE_PRELOCK_SCT1_SIZE_REG"]
    #[inline(always)]
    pub fn dcache_prelock_sct1_addr(&mut self) -> DCACHE_PRELOCK_SCT1_ADDR_W {
        DCACHE_PRELOCK_SCT1_ADDR_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcache_prelock_sct1_addr]
(index.html) module"]
pub struct DCACHE_PRELOCK_SCT1_ADDR_SPEC;
impl crate::RegisterSpec for DCACHE_PRELOCK_SCT1_ADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dcache_prelock_sct1_addr::R]
(R) reader structure"]
impl crate::Readable for DCACHE_PRELOCK_SCT1_ADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dcache_prelock_sct1_addr::W]
(W) writer structure"]
