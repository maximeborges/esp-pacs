...
pub struct DCACHE_TAG_MEM_FORCE_ON_R(crate::FieldReader<bool, bool>);
...
pub struct DCACHE_TAG_MEM_FORCE_PD_R(crate::FieldReader<bool, bool>);
...
pub struct DCACHE_TAG_MEM_FORCE_PU_R(crate::FieldReader<bool, bool>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcache_tag_power_ctrl]
(index.html) module"]
pub struct DCACHE_TAG_POWER_CTRL_SPEC;
impl crate::RegisterSpec for DCACHE_TAG_POWER_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dcache_tag_power_ctrl::R]
(R) reader structure"]
impl crate::Readable for DCACHE_TAG_POWER_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dcache_tag_power_ctrl::W]
(W) writer structure"]
