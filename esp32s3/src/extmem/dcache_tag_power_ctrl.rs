...
pub type DCACHE_TAG_MEM_FORCE_ON_W<'a> =
    crate::BitWriter<'a, u32, DCACHE_TAG_POWER_CTRL_SPEC, bool, 0>;
...
pub type DCACHE_TAG_MEM_FORCE_PD_W<'a> =
    crate::BitWriter<'a, u32, DCACHE_TAG_POWER_CTRL_SPEC, bool, 1>;
...
pub type DCACHE_TAG_MEM_FORCE_PU_W<'a> =
    crate::BitWriter<'a, u32, DCACHE_TAG_POWER_CTRL_SPEC, bool, 2>;
impl R {
