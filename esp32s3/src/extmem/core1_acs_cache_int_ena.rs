...
pub struct CORE1_IBUS_ACS_MSK_IC_INT_ENA_R(crate::FieldReader<bool, bool>);
impl CORE1_IBUS_ACS_MSK_IC_INT_ENA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE1_IBUS_ACS_MSK_IC_INT_ENA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE1_IBUS_ACS_MSK_IC_INT_ENA_R {
...
pub struct CORE1_IBUS_ACS_MSK_IC_INT_ENA_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE1_IBUS_ACS_MSK_IC_INT_ENA_W<'a> {
...
pub struct CORE1_IBUS_WR_IC_INT_ENA_R(crate::FieldReader<bool, bool>);
impl CORE1_IBUS_WR_IC_INT_ENA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE1_IBUS_WR_IC_INT_ENA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE1_IBUS_WR_IC_INT_ENA_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE1_IBUS_WR_IC_INT_ENA_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE1_IBUS_WR_IC_INT_ENA_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct CORE1_IBUS_REJECT_INT_ENA_R(crate::FieldReader<bool, bool>);
impl CORE1_IBUS_REJECT_INT_ENA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE1_IBUS_REJECT_INT_ENA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE1_IBUS_REJECT_INT_ENA_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE1_IBUS_REJECT_INT_ENA_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE1_IBUS_REJECT_INT_ENA_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct CORE1_DBUS_ACS_MSK_DC_INT_ENA_R(crate::FieldReader<bool, bool>);
impl CORE1_DBUS_ACS_MSK_DC_INT_ENA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE1_DBUS_ACS_MSK_DC_INT_ENA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE1_DBUS_ACS_MSK_DC_INT_ENA_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE1_DBUS_ACS_MSK_DC_INT_ENA_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE1_DBUS_ACS_MSK_DC_INT_ENA_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct CORE1_DBUS_REJECT_INT_ENA_R(crate::FieldReader<bool, bool>);
impl CORE1_DBUS_REJECT_INT_ENA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE1_DBUS_REJECT_INT_ENA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE1_DBUS_REJECT_INT_ENA_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE1_DBUS_REJECT_INT_ENA_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE1_DBUS_REJECT_INT_ENA_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn core1_ibus_acs_msk_ic_int_ena(&self) -> CORE1_IBUS_ACS_MSK_IC_INT_ENA_R {
        CORE1_IBUS_ACS_MSK_IC_INT_ENA_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core1_ibus_wr_ic_int_ena(&self) -> CORE1_IBUS_WR_IC_INT_ENA_R {
        CORE1_IBUS_WR_IC_INT_ENA_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    ...
    pub fn core1_ibus_reject_int_ena(&self) -> CORE1_IBUS_REJECT_INT_ENA_R {
        CORE1_IBUS_REJECT_INT_ENA_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    ...
    pub fn core1_dbus_acs_msk_dc_int_ena(&self) -> CORE1_DBUS_ACS_MSK_DC_INT_ENA_R {
        CORE1_DBUS_ACS_MSK_DC_INT_ENA_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    ...
    pub fn core1_dbus_reject_int_ena(&self) -> CORE1_DBUS_REJECT_INT_ENA_R {
        CORE1_DBUS_REJECT_INT_ENA_R::new(((self.bits >> 4) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - The bit is used to enable interrupt by cpu access icache while the corresponding ibus is disabled which include speculative access."]
    #[inline(always)]
    pub fn core1_ibus_acs_msk_ic_int_ena(&mut self) -> CORE1_IBUS_ACS_MSK_IC_INT_ENA_W {
        CORE1_IBUS_ACS_MSK_IC_INT_ENA_W { w: self }
    }
    #[doc = "Bit 1 - The bit is used to enable interrupt by ibus trying to write icache"]
    #[inline(always)]
    pub fn core1_ibus_wr_ic_int_ena(&mut self) -> CORE1_IBUS_WR_IC_INT_ENA_W {
        CORE1_IBUS_WR_IC_INT_ENA_W { w: self }
    }
    #[doc = "Bit 2 - The bit is used to enable interrupt by authentication fail."]
    #[inline(always)]
    pub fn core1_ibus_reject_int_ena(&mut self) -> CORE1_IBUS_REJECT_INT_ENA_W {
        CORE1_IBUS_REJECT_INT_ENA_W { w: self }
    }
    #[doc = "Bit 3 - The bit is used to enable interrupt by cpu access dcache while the corresponding dbus is disabled which include speculative access."]
    #[inline(always)]
    pub fn core1_dbus_acs_msk_dc_int_ena(&mut self) -> CORE1_DBUS_ACS_MSK_DC_INT_ENA_W {
        CORE1_DBUS_ACS_MSK_DC_INT_ENA_W { w: self }
    }
    #[doc = "Bit 4 - The bit is used to enable interrupt by authentication fail."]
    #[inline(always)]
    pub fn core1_dbus_reject_int_ena(&mut self) -> CORE1_DBUS_REJECT_INT_ENA_W {
        CORE1_DBUS_REJECT_INT_ENA_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core1_acs_cache_int_ena]
(index.html) module"]
pub struct CORE1_ACS_CACHE_INT_ENA_SPEC;
impl crate::RegisterSpec for CORE1_ACS_CACHE_INT_ENA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core1_acs_cache_int_ena::R]
(R) reader structure"]
impl crate::Readable for CORE1_ACS_CACHE_INT_ENA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core1_acs_cache_int_ena::W]
(W) writer structure"]
