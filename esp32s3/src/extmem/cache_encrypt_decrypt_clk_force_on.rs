...
pub struct CLK_FORCE_ON_MANUAL_CRYPT_R(crate::FieldReader<bool>);
...
pub struct CLK_FORCE_ON_AUTO_CRYPT_R(crate::FieldReader<bool>);
...
pub struct CLK_FORCE_ON_CRYPT_R(crate::FieldReader<bool>);
