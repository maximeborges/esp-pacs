...
pub struct ICACHE_SHUT_CORE0_BUS_R(crate::FieldReader<bool, bool>);
impl ICACHE_SHUT_CORE0_BUS_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        ICACHE_SHUT_CORE0_BUS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ICACHE_SHUT_CORE0_BUS_R {
...
pub struct ICACHE_SHUT_CORE0_BUS_W<'a> {
    w: &'a mut W,
}
impl<'a> ICACHE_SHUT_CORE0_BUS_W<'a> {
...
pub struct ICACHE_SHUT_CORE1_BUS_R(crate::FieldReader<bool, bool>);
impl ICACHE_SHUT_CORE1_BUS_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        ICACHE_SHUT_CORE1_BUS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ICACHE_SHUT_CORE1_BUS_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct ICACHE_SHUT_CORE1_BUS_W<'a> {
    w: &'a mut W,
}
impl<'a> ICACHE_SHUT_CORE1_BUS_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    #[doc = "Bit 0 - The bit is used to disable core0 ibus, 0: enable, 1: disable"]
    #[inline(always)]
    pub fn icache_shut_core0_bus(&mut self) -> ICACHE_SHUT_CORE0_BUS_W {
        ICACHE_SHUT_CORE0_BUS_W { w: self }
    }
    #[doc = "Bit 1 - The bit is used to disable core1 ibus, 0: enable, 1: disable"]
    #[inline(always)]
    pub fn icache_shut_core1_bus(&mut self) -> ICACHE_SHUT_CORE1_BUS_W {
        ICACHE_SHUT_CORE1_BUS_W { w: self }
    }
