...
pub struct CORE1_DBUS_VADDR_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core1_dbus_reject_vaddr]
(index.html) module"]
pub struct CORE1_DBUS_REJECT_VADDR_SPEC;
impl crate::RegisterSpec for CORE1_DBUS_REJECT_VADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core1_dbus_reject_vaddr::R]
(R) reader structure"]
