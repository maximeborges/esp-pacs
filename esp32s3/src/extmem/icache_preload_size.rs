...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [icache_preload_size]
(index.html) module"]
pub struct ICACHE_PRELOAD_SIZE_SPEC;
impl crate::RegisterSpec for ICACHE_PRELOAD_SIZE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [icache_preload_size::R]
(R) reader structure"]
impl crate::Readable for ICACHE_PRELOAD_SIZE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [icache_preload_size::W]
(W) writer structure"]
