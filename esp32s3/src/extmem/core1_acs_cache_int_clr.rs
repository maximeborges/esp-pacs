...
pub type CORE1_IBUS_ACS_MSK_IC_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CORE1_ACS_CACHE_INT_CLR_SPEC, bool, 0>;
#[doc = "Field `CORE1_IBUS_WR_IC_INT_CLR` writer - The bit is used to clear interrupt by ibus trying to write icache"]
pub type CORE1_IBUS_WR_IC_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CORE1_ACS_CACHE_INT_CLR_SPEC, bool, 1>;
#[doc = "Field `CORE1_IBUS_REJECT_INT_CLR` writer - The bit is used to clear interrupt by authentication fail."]
pub type CORE1_IBUS_REJECT_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CORE1_ACS_CACHE_INT_CLR_SPEC, bool, 2>;
...
pub type CORE1_DBUS_ACS_MSK_DC_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CORE1_ACS_CACHE_INT_CLR_SPEC, bool, 3>;
#[doc = "Field `CORE1_DBUS_REJECT_INT_CLR` writer - The bit is used to clear interrupt by authentication fail."]
pub type CORE1_DBUS_REJECT_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CORE1_ACS_CACHE_INT_CLR_SPEC, bool, 4>;
impl W {
