...
pub struct DCACHE_LOCK_SIZE_R(crate::FieldReader<u16, u16>);
impl DCACHE_LOCK_SIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DCACHE_LOCK_SIZE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DCACHE_LOCK_SIZE_R {
...
pub struct DCACHE_LOCK_SIZE_W<'a> {
    w: &'a mut W,
}
impl<'a> DCACHE_LOCK_SIZE_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - The bits are used to configure the length for lock operations. The bits are the counts of cache block. It should be combined with DCACHE_LOCK_ADDR_REG."]
    #[inline(always)]
    pub fn dcache_lock_size(&mut self) -> DCACHE_LOCK_SIZE_W {
        DCACHE_LOCK_SIZE_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcache_lock_size]
(index.html) module"]
pub struct DCACHE_LOCK_SIZE_SPEC;
impl crate::RegisterSpec for DCACHE_LOCK_SIZE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dcache_lock_size::R]
(R) reader structure"]
impl crate::Readable for DCACHE_LOCK_SIZE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dcache_lock_size::W]
(W) writer structure"]
