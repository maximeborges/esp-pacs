...
pub struct CORE1_IBUS_TAG_ATTR_R(crate::FieldReader<u8, u8>);
impl CORE1_IBUS_TAG_ATTR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE1_IBUS_TAG_ATTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE1_IBUS_TAG_ATTR_R {
...
pub struct CORE1_IBUS_ATTR_R(crate::FieldReader<u8, u8>);
impl CORE1_IBUS_ATTR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE1_IBUS_ATTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE1_IBUS_ATTR_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE1_IBUS_WORLD_R(crate::FieldReader<bool, bool>);
impl CORE1_IBUS_WORLD_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE1_IBUS_WORLD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE1_IBUS_WORLD_R {
...
impl R {
    ...
    pub fn core1_ibus_tag_attr(&self) -> CORE1_IBUS_TAG_ATTR_R {
        CORE1_IBUS_TAG_ATTR_R::new((self.bits & 0x07) as u8)
    }
    ...
    pub fn core1_ibus_attr(&self) -> CORE1_IBUS_ATTR_R {
        CORE1_IBUS_ATTR_R::new(((self.bits >> 3) & 0x07) as u8)
    }
    ...
    pub fn core1_ibus_world(&self) -> CORE1_IBUS_WORLD_R {
        CORE1_IBUS_WORLD_R::new(((self.bits >> 6) & 0x01) != 0)
    }
}
#[doc = "******* Description ***********\n\nThis register you can [`read`]
(crate::generic::Reg::read). See [API]
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core1_ibus_reject_st]
(index.html) module"]
pub struct CORE1_IBUS_REJECT_ST_SPEC;
impl crate::RegisterSpec for CORE1_IBUS_REJECT_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core1_ibus_reject_st::R]
(R) reader structure"]
