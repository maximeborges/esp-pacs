...
pub type DCACHE_SYNC_OP_FAULT_INT_ENA_W<'a> =
    crate::BitWriter<'a, u32, CACHE_ILG_INT_ENA_SPEC, bool, 2>;
...
pub type DCACHE_PRELOAD_OP_FAULT_INT_ENA_W<'a> =
    crate::BitWriter<'a, u32, CACHE_ILG_INT_ENA_SPEC, bool, 3>;
...
pub type DCACHE_WRITE_FLASH_INT_ENA_W<'a> =
    crate::BitWriter<'a, u32, CACHE_ILG_INT_ENA_SPEC, bool, 4>;
...
pub type DCACHE_OCCUPY_EXC_INT_ENA_W<'a> =
    crate::BitWriter<'a, u32, CACHE_ILG_INT_ENA_SPEC, bool, 6>;
