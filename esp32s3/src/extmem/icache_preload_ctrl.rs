...
pub struct ICACHE_PRELOAD_ENA_R(crate::FieldReader<bool>);
...
pub struct ICACHE_PRELOAD_DONE_R(crate::FieldReader<bool>);
...
pub struct ICACHE_PRELOAD_ORDER_R(crate::FieldReader<bool>);
