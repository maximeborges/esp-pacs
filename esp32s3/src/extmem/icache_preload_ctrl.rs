...
pub type ICACHE_PRELOAD_ENA_W<'a> = crate::BitWriter<'a, u32, ICACHE_PRELOAD_CTRL_SPEC, bool, 0>;
...
pub type ICACHE_PRELOAD_ORDER_W<'a> = crate::BitWriter<'a, u32, ICACHE_PRELOAD_CTRL_SPEC, bool, 2>;
impl R {
