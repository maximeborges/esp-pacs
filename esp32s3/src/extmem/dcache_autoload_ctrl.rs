...
pub struct DCACHE_AUTOLOAD_SCT0_ENA_R(crate::FieldReader<bool>);
...
pub struct DCACHE_AUTOLOAD_SCT1_ENA_R(crate::FieldReader<bool>);
...
pub struct DCACHE_AUTOLOAD_ENA_R(crate::FieldReader<bool>);
...
pub struct DCACHE_AUTOLOAD_DONE_R(crate::FieldReader<bool>);
...
pub struct DCACHE_AUTOLOAD_ORDER_R(crate::FieldReader<bool>);
...
pub struct DCACHE_AUTOLOAD_RQST_R(crate::FieldReader<u8>);
...
pub struct DCACHE_AUTOLOAD_SIZE_R(crate::FieldReader<u8>);
...
pub struct DCACHE_AUTOLOAD_BUFFER_CLEAR_R(crate::FieldReader<bool>);
