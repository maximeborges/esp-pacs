...
pub struct ICACHE_AUTOLOAD_SIZE_R(crate::FieldReader<u8, u8>);
impl ICACHE_AUTOLOAD_SIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        ICACHE_AUTOLOAD_SIZE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ICACHE_AUTOLOAD_SIZE_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct ICACHE_AUTOLOAD_SIZE_W<'a> {
    w: &'a mut W,
}
impl<'a> ICACHE_AUTOLOAD_SIZE_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct ICACHE_AUTOLOAD_BUFFER_CLEAR_R(crate::FieldReader<bool, bool>);
impl ICACHE_AUTOLOAD_BUFFER_CLEAR_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        ICACHE_AUTOLOAD_BUFFER_CLEAR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ICACHE_AUTOLOAD_BUFFER_CLEAR_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct ICACHE_AUTOLOAD_BUFFER_CLEAR_W<'a> {
    w: &'a mut W,
}
impl<'a> ICACHE_AUTOLOAD_BUFFER_CLEAR_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn icache_autoload_size(&self) -> ICACHE_AUTOLOAD_SIZE_R {
        ICACHE_AUTOLOAD_SIZE_R::new(((self.bits >> 7) & 0x03) as u8)
    }
    ...
    pub fn icache_autoload_buffer_clear(&self) -> ICACHE_AUTOLOAD_BUFFER_CLEAR_R {
        ICACHE_AUTOLOAD_BUFFER_CLEAR_R::new(((self.bits >> 9) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - The bits are used to enable the first section for autoload operation."]
    ...
    #[doc = "Bits 7:8 - The bits are used to configure the numbers of the cache block for the issuing autoload operation."]
    #[inline(always)]
    pub fn icache_autoload_size(&mut self) -> ICACHE_AUTOLOAD_SIZE_W {
        ICACHE_AUTOLOAD_SIZE_W { w: self }
    }
    #[doc = "Bit 9 - The bit is used to clear autoload buffer in icache."]
    #[inline(always)]
    pub fn icache_autoload_buffer_clear(&mut self) -> ICACHE_AUTOLOAD_BUFFER_CLEAR_W {
        ICACHE_AUTOLOAD_BUFFER_CLEAR_W { w: self }
    }
