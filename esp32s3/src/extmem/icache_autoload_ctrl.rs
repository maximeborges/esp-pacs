...
pub type ICACHE_AUTOLOAD_SIZE_W<'a> =
    crate::FieldWriter<'a, u32, ICACHE_AUTOLOAD_CTRL_SPEC, u8, u8, 2, 7>;
...
pub type ICACHE_AUTOLOAD_BUFFER_CLEAR_W<'a> =
    crate::BitWriter<'a, u32, ICACHE_AUTOLOAD_CTRL_SPEC, bool, 9>;
impl R {
