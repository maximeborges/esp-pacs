...
pub struct CORE0_IBUS_TAG_ATTR_R(crate::FieldReader<u8>);
...
pub struct CORE0_IBUS_ATTR_R(crate::FieldReader<u8>);
...
pub struct CORE0_IBUS_WORLD_R(crate::FieldReader<bool>);
