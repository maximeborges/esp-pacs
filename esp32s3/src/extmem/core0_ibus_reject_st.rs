...
pub struct CORE0_IBUS_TAG_ATTR_R(crate::FieldReader<u8, u8>);
impl CORE0_IBUS_TAG_ATTR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE0_IBUS_TAG_ATTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE0_IBUS_TAG_ATTR_R {
...
impl R {
    ...
    pub fn core0_ibus_tag_attr(&self) -> CORE0_IBUS_TAG_ATTR_R {
        CORE0_IBUS_TAG_ATTR_R::new((self.bits & 0x07) as u8)
    }
    ...
    pub fn core0_ibus_attr(&self) -> CORE0_IBUS_ATTR_R {
        CORE0_IBUS_ATTR_R::new(((self.bits >> 3) & 0x07) as u8)
    }
    ...
    pub fn core0_ibus_world(&self) -> CORE0_IBUS_WORLD_R {
        CORE0_IBUS_WORLD_R::new(((self.bits >> 6) & 0x01) != 0)
    }
}
#[doc = "******* Description ***********\n\nThis register you can [`read`]
(crate::generic::Reg::read). See [API]
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core0_ibus_reject_st]
(index.html) module"]
pub struct CORE0_IBUS_REJECT_ST_SPEC;
impl crate::RegisterSpec for CORE0_IBUS_REJECT_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core0_ibus_reject_st::R]
(R) reader structure"]
