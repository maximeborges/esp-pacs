...
pub struct RX_CLKM_DIV_Z_R(crate::FieldReader<u16>);
...
pub struct RX_CLKM_DIV_Y_R(crate::FieldReader<u16>);
...
pub struct RX_CLKM_DIV_X_R(crate::FieldReader<u16>);
...
pub struct RX_CLKM_DIV_YN1_R(crate::FieldReader<bool>);
