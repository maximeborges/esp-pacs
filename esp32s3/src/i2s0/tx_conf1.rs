...
pub type TX_TDM_WS_WIDTH_W<'a> = crate::FieldWriter<'a, u32, TX_CONF1_SPEC, u8, u8, 7, 0>;
...
pub type TX_BCK_DIV_NUM_W<'a> = crate::FieldWriter<'a, u32, TX_CONF1_SPEC, u8, u8, 6, 7>;
...
pub type TX_BITS_MOD_W<'a> = crate::FieldWriter<'a, u32, TX_CONF1_SPEC, u8, u8, 5, 13>;
...
pub type TX_HALF_SAMPLE_BITS_W<'a> = crate::FieldWriter<'a, u32, TX_CONF1_SPEC, u8, u8, 6, 18>;
...
pub type TX_TDM_CHAN_BITS_W<'a> = crate::FieldWriter<'a, u32, TX_CONF1_SPEC, u8, u8, 5, 24>;
...
pub type TX_MSB_SHIFT_W<'a> = crate::BitWriter<'a, u32, TX_CONF1_SPEC, bool, 29>;
...
pub type TX_BCK_NO_DLY_W<'a> = crate::BitWriter<'a, u32, TX_CONF1_SPEC, bool, 30>;
impl R {
