...
pub struct RX_PDM2PCM_EN_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn rx_pdm2pcm_en(&self) -> RX_PDM2PCM_EN_R {
        RX_PDM2PCM_EN_R::new(((self.bits >> 21) & 0x01) != 0)
    }
    ...
    pub fn rx_pdm_sinc_dsr_16_en(&self) -> RX_PDM_SINC_DSR_16_EN_R {
        RX_PDM_SINC_DSR_16_EN_R::new(((self.bits >> 22) & 0x01) != 0)
    }
}
impl W {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rx_conf]
(index.html) module"]
pub struct RX_CONF_SPEC;
impl crate::RegisterSpec for RX_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rx_conf::R]
(R) reader structure"]
impl crate::Readable for RX_CONF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rx_conf::W]
(W) writer structure"]
