...
pub type RX_RESET_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 0>;
#[doc = "Field `RX_FIFO_RESET` writer - Set this bit to reset Rx AFIFO"]
pub type RX_FIFO_RESET_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 1>;
...
pub type RX_START_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 2>;
...
pub type RX_SLAVE_MOD_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 3>;
...
pub type RX_MONO_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 5>;
...
pub type RX_BIG_ENDIAN_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 7>;
...
pub type RX_UPDATE_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 8>;
...
pub type RX_MONO_FST_VLD_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 9>;
...
pub type RX_PCM_CONF_W<'a> = crate::FieldWriter<'a, u32, RX_CONF_SPEC, u8, u8, 2, 10>;
...
pub type RX_PCM_BYPASS_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 12>;
...
pub type RX_STOP_MODE_W<'a> = crate::FieldWriter<'a, u32, RX_CONF_SPEC, u8, u8, 2, 13>;
...
pub type RX_LEFT_ALIGN_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 15>;
...
pub type RX_24_FILL_EN_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 16>;
...
pub type RX_WS_IDLE_POL_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 17>;
...
pub type RX_BIT_ORDER_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 18>;
...
pub type RX_TDM_EN_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 19>;
...
pub type RX_PDM_EN_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 20>;
...
pub type RX_PDM2PCM_EN_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 21>;
...
pub type RX_PDM_SINC_DSR_16_EN_W<'a> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, 22>;
impl R {
