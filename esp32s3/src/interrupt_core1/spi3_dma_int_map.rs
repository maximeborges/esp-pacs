...
pub struct SPI3_DMA_INT_MAP_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi3_dma_int_map]
(index.html) module"]
pub struct SPI3_DMA_INT_MAP_SPEC;
impl crate::RegisterSpec for SPI3_DMA_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi3_dma_int_map::R]
(R) reader structure"]
impl crate::Readable for SPI3_DMA_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi3_dma_int_map::W]
(W) writer structure"]
