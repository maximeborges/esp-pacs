...
pub struct DMA_OUT_CH1_INT_MAP_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_out_ch1_int_map]
(index.html) module"]
pub struct DMA_OUT_CH1_INT_MAP_SPEC;
impl crate::RegisterSpec for DMA_OUT_CH1_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_out_ch1_int_map::R]
(R) reader structure"]
impl crate::Readable for DMA_OUT_CH1_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_out_ch1_int_map::W]
(W) writer structure"]
