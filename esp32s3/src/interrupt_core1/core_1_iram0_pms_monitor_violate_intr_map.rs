...
pub struct CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_R(crate::FieldReader<u8, u8>);
impl CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_R {
...
pub struct CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_W<'a> {
...
impl W {
    ...
    pub fn core_1_iram0_pms_monitor_violate_intr_map(
        ...
        CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_iram0_pms_monitor_violate_intr_map]
(index.html) module"]
...
#[doc = "`read()` method returns [core_1_iram0_pms_monitor_violate_intr_map::R]
(R) reader structure"]
impl crate::Readable for CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_iram0_pms_monitor_violate_intr_map::W]
(W) writer structure"]
