...
pub struct DMA_IN_CH0_INT_MAP_R(crate::FieldReader<u8, u8>);
impl DMA_IN_CH0_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        DMA_IN_CH0_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMA_IN_CH0_INT_MAP_R {
...
pub struct DMA_IN_CH0_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> DMA_IN_CH0_INT_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - this register used to map dma_in_ch0 interrupt to one of core1's external interrupt"]
    #[inline(always)]
    pub fn dma_in_ch0_int_map(&mut self) -> DMA_IN_CH0_INT_MAP_W {
        DMA_IN_CH0_INT_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_in_ch0_int_map]
(index.html) module"]
pub struct DMA_IN_CH0_INT_MAP_SPEC;
impl crate::RegisterSpec for DMA_IN_CH0_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_in_ch0_int_map::R]
(R) reader structure"]
impl crate::Readable for DMA_IN_CH0_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_in_ch0_int_map::W]
(W) writer structure"]
