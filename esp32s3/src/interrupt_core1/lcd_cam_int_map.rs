...
pub struct LCD_CAM_INT_MAP_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lcd_cam_int_map]
(index.html) module"]
pub struct LCD_CAM_INT_MAP_SPEC;
impl crate::RegisterSpec for LCD_CAM_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lcd_cam_int_map::R]
(R) reader structure"]
impl crate::Readable for LCD_CAM_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lcd_cam_int_map::W]
(W) writer structure"]
