...
pub struct I2S0_INT_MAP_R(crate::FieldReader<u8, u8>);
impl I2S0_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        I2S0_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S0_INT_MAP_R {
...
pub struct I2S0_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> I2S0_INT_MAP_W<'a> {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2s0_int_map]
(index.html) module"]
pub struct I2S0_INT_MAP_SPEC;
impl crate::RegisterSpec for I2S0_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2s0_int_map::R]
(R) reader structure"]
impl crate::Readable for I2S0_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2s0_int_map::W]
(W) writer structure"]
