...
impl TG_T1_INT_MAP_R {
    ...
    pub(crate) fn new(bits: u8) -> Self {
        TG_T1_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
...
pub struct TG_T1_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> TG_T1_INT_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - this register used to map tg_t1 interrupt to one of core1's external interrupt"]
    #[inline(always)]
    pub fn tg_t1_int_map(&mut self) -> TG_T1_INT_MAP_W {
        TG_T1_INT_MAP_W { w: self }
    }
