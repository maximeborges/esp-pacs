...
pub struct SPI4_DMA_INT_MAP_R(crate::FieldReader<u8, u8>);
impl SPI4_DMA_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SPI4_DMA_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SPI4_DMA_INT_MAP_R {
...
pub struct SPI4_DMA_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> SPI4_DMA_INT_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - this register used to map spi4_dma interrupt to one of core1's external interrupt"]
    #[inline(always)]
    pub fn spi4_dma_int_map(&mut self) -> SPI4_DMA_INT_MAP_W {
        SPI4_DMA_INT_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi4_dma_int_map]
(index.html) module"]
pub struct SPI4_DMA_INT_MAP_SPEC;
impl crate::RegisterSpec for SPI4_DMA_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi4_dma_int_map::R]
(R) reader structure"]
impl crate::Readable for SPI4_DMA_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi4_dma_int_map::W]
(W) writer structure"]
