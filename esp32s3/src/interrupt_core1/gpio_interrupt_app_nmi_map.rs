...
pub struct GPIO_INTERRUPT_APP_NMI_MAP_R(crate::FieldReader<u8, u8>);
impl GPIO_INTERRUPT_APP_NMI_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        GPIO_INTERRUPT_APP_NMI_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GPIO_INTERRUPT_APP_NMI_MAP_R {
...
pub struct GPIO_INTERRUPT_APP_NMI_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> GPIO_INTERRUPT_APP_NMI_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - this register used to map gpio_interrupt_app_nmi interrupt to one of core1's external interrupt"]
    #[inline(always)]
    pub fn gpio_interrupt_app_nmi_map(&mut self) -> GPIO_INTERRUPT_APP_NMI_MAP_W {
        GPIO_INTERRUPT_APP_NMI_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_interrupt_app_nmi_map]
(index.html) module"]
pub struct GPIO_INTERRUPT_APP_NMI_MAP_SPEC;
impl crate::RegisterSpec for GPIO_INTERRUPT_APP_NMI_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpio_interrupt_app_nmi_map::R]
(R) reader structure"]
impl crate::Readable for GPIO_INTERRUPT_APP_NMI_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpio_interrupt_app_nmi_map::W]
(W) writer structure"]
