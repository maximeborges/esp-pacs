...
pub type CLKM_DIV_NUM_W<'a> = crate::FieldWriter<'a, u32, APB_ADC_CLKM_CONF_SPEC, u8, u8, 8, 0>;
...
pub type CLKM_DIV_B_W<'a> = crate::FieldWriter<'a, u32, APB_ADC_CLKM_CONF_SPEC, u8, u8, 6, 8>;
...
pub type CLKM_DIV_A_W<'a> = crate::FieldWriter<'a, u32, APB_ADC_CLKM_CONF_SPEC, u8, u8, 6, 14>;
...
pub type CLK_SEL_W<'a> = crate::FieldWriter<'a, u32, APB_ADC_CLKM_CONF_SPEC, u8, u8, 2, 21>;
impl R {
