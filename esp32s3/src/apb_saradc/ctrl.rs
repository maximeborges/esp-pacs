...
pub type SARADC_WORK_MODE_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 2, 3>;
...
pub type SARADC_SAR_SEL_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 5>;
...
pub type SARADC_SAR1_PATT_LEN_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 4, 15>;
...
pub type SARADC_SAR2_PATT_LEN_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 4, 19>;
...
pub type SARADC_SAR1_PATT_P_CLEAR_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 23>;
...
pub type SARADC_SAR2_PATT_P_CLEAR_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 24>;
...
pub type SARADC_DATA_SAR_SEL_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 25>;
...
pub type SARADC_DATA_TO_I2S_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 26>;
