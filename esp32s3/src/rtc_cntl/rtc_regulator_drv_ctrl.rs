#[doc = "Register `RTC_REGULATOR_DRV_CTRL` reader"]
pub struct R(crate::R<RTC_REGULATOR_DRV_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_REGULATOR_DRV_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_REGULATOR_DRV_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_REGULATOR_DRV_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_REGULATOR_DRV_CTRL` writer"]
pub struct W(crate::W<RTC_REGULATOR_DRV_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_REGULATOR_DRV_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_REGULATOR_DRV_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_REGULATOR_DRV_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_regulator_drv_ctrl]
(index.html) module"]
pub struct RTC_REGULATOR_DRV_CTRL_SPEC;
impl crate::RegisterSpec for RTC_REGULATOR_DRV_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_regulator_drv_ctrl::R]
(R) reader structure"]
impl crate::Readable for RTC_REGULATOR_DRV_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_regulator_drv_ctrl::W]
(W) writer structure"]
impl crate::Writable for RTC_REGULATOR_DRV_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_REGULATOR_DRV_CTRL to value 0"]
impl crate::Resettable for RTC_REGULATOR_DRV_CTRL_SPEC {
    #[inline(always)]
