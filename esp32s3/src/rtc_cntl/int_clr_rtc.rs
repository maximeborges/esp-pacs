...
pub type RTC_TOUCH_SCAN_DONE_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 4>;
#[doc = "Field `RTC_ULP_CP_INT_CLR` writer - Clear ULP-coprocessor interrupt state"]
pub type RTC_ULP_CP_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 5>;
#[doc = "Field `RTC_TOUCH_DONE_INT_CLR` writer - Clear touch done interrupt state"]
pub type RTC_TOUCH_DONE_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 6>;
#[doc = "Field `RTC_TOUCH_ACTIVE_INT_CLR` writer - Clear touch active interrupt state"]
pub type RTC_TOUCH_ACTIVE_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 7>;
#[doc = "Field `RTC_TOUCH_INACTIVE_INT_CLR` writer - Clear touch inactive interrupt state"]
pub type RTC_TOUCH_INACTIVE_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 8>;
...
pub type RTC_SARADC1_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 11>;
#[doc = "Field `RTC_TSENS_INT_CLR` writer - Clear tsens interrupt state"]
pub type RTC_TSENS_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 12>;
#[doc = "Field `RTC_COCPU_INT_CLR` writer - Clear riscV cocpu interrupt state"]
pub type RTC_COCPU_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 13>;
#[doc = "Field `RTC_SARADC2_INT_CLR` writer - Clear saradc2 interrupt state"]
pub type RTC_SARADC2_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 14>;
...
pub type RTC_COCPU_TRAP_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 17>;
#[doc = "Field `RTC_TOUCH_TIMEOUT_INT_CLR` writer - Clear touch timeout interrupt state"]
pub type RTC_TOUCH_TIMEOUT_INT_CLR_W<'a> = crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 18>;
...
pub type RTC_TOUCH_APPROACH_LOOP_DONE_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, INT_CLR_RTC_SPEC, bool, 20>;
impl W {
