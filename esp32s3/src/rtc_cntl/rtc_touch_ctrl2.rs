#[doc = "Register `RTC_TOUCH_CTRL2` reader"]
pub struct R(crate::R<RTC_TOUCH_CTRL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_TOUCH_CTRL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_TOUCH_CTRL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_TOUCH_CTRL2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_TOUCH_CTRL2` writer"]
pub struct W(crate::W<RTC_TOUCH_CTRL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_TOUCH_CTRL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_TOUCH_CTRL2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_TOUCH_CTRL2_SPEC>) -> Self {
        W(writer)
    }
}
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_touch_ctrl2]
(index.html) module"]
pub struct RTC_TOUCH_CTRL2_SPEC;
impl crate::RegisterSpec for RTC_TOUCH_CTRL2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_touch_ctrl2::R]
(R) reader structure"]
impl crate::Readable for RTC_TOUCH_CTRL2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_touch_ctrl2::W]
(W) writer structure"]
impl crate::Writable for RTC_TOUCH_CTRL2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_TOUCH_CTRL2 to value 0x0008_40cc"]
impl crate::Resettable for RTC_TOUCH_CTRL2_SPEC {
    #[inline(always)]
