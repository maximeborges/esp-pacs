#[doc = "Register `RTC_TOUCH_APPROACH` reader"]
pub struct R(crate::R<RTC_TOUCH_APPROACH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_TOUCH_APPROACH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_TOUCH_APPROACH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_TOUCH_APPROACH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_TOUCH_APPROACH` writer"]
pub struct W(crate::W<RTC_TOUCH_APPROACH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_TOUCH_APPROACH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_TOUCH_APPROACH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_TOUCH_APPROACH_SPEC>) -> Self {
        W(writer)
    }
}
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_touch_approach]
(index.html) module"]
pub struct RTC_TOUCH_APPROACH_SPEC;
impl crate::RegisterSpec for RTC_TOUCH_APPROACH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_touch_approach::R]
(R) reader structure"]
impl crate::Readable for RTC_TOUCH_APPROACH_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_touch_approach::W]
(W) writer structure"]
impl crate::Writable for RTC_TOUCH_APPROACH_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_TOUCH_APPROACH to value 0x5000_0000"]
impl crate::Resettable for RTC_TOUCH_APPROACH_SPEC {
    #[inline(always)]
