#[doc = "Register `RTC_TOUCH_SCAN_CTRL` reader"]
pub struct R(crate::R<RTC_TOUCH_SCAN_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_TOUCH_SCAN_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_TOUCH_SCAN_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_TOUCH_SCAN_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_TOUCH_SCAN_CTRL` writer"]
pub struct W(crate::W<RTC_TOUCH_SCAN_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_TOUCH_SCAN_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_TOUCH_SCAN_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_TOUCH_SCAN_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TOUCH_DENOISE_RES` reader - De-noise resolution: 12/10/8/4 bit"]
pub struct TOUCH_DENOISE_RES_R(crate::FieldReader<u8, u8>);
...
pub struct TOUCH_DENOISE_EN_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_INACTIVE_CONNECTION_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_SHIELD_PAD_EN_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_SCAN_PAD_MAP_R(crate::FieldReader<u16, u16>);
...
pub struct TOUCH_BUFDRV_R(crate::FieldReader<u8, u8>);
impl TOUCH_BUFDRV_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct TOUCH_OUT_RING_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_touch_scan_ctrl]
(index.html) module"]
pub struct RTC_TOUCH_SCAN_CTRL_SPEC;
impl crate::RegisterSpec for RTC_TOUCH_SCAN_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_touch_scan_ctrl::R]
(R) reader structure"]
impl crate::Readable for RTC_TOUCH_SCAN_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_touch_scan_ctrl::W]
(W) writer structure"]
impl crate::Writable for RTC_TOUCH_SCAN_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_TOUCH_SCAN_CTRL to value 0xf000_0102"]
impl crate::Resettable for RTC_TOUCH_SCAN_CTRL_SPEC {
    #[inline(always)]
