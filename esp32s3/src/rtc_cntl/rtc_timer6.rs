...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_timer6]
(index.html) module"]
pub struct RTC_TIMER6_SPEC;
impl crate::RegisterSpec for RTC_TIMER6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_timer6::R]
(R) reader structure"]
impl crate::Readable for RTC_TIMER6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_timer6::W]
(W) writer structure"]
impl crate::Writable for RTC_TIMER6_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_TIMER6 to value 0x1020_0a08"]
