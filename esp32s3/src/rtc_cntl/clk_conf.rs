...
pub type EFUSE_CLK_FORCE_GATING_W<'a> = crate::BitWriter<'a, u32, CLK_CONF_SPEC, bool, 1>;
...
pub type EFUSE_CLK_FORCE_NOGATING_W<'a> = crate::BitWriter<'a, u32, CLK_CONF_SPEC, bool, 2>;
...
pub type CK8M_DIV_SEL_VLD_W<'a> = crate::BitWriter<'a, u32, CLK_CONF_SPEC, bool, 3>;
...
pub type CK8M_DIV_W<'a> = crate::FieldWriter<'a, u32, CLK_CONF_SPEC, u8, u8, 2, 4>;
...
pub type ENB_CK8M_DIV_W<'a> = crate::BitWriter<'a, u32, CLK_CONF_SPEC, bool, 7>;
...
pub type XTAL_GLOBAL_FORCE_GATING_W<'a> = crate::BitWriter<'a, u32, CLK_CONF_SPEC, bool, 27>;
...
pub type XTAL_GLOBAL_FORCE_NOGATING_W<'a> = crate::BitWriter<'a, u32, CLK_CONF_SPEC, bool, 28>;
...
pub type FAST_CLK_RTC_SEL_W<'a> = crate::BitWriter<'a, u32, CLK_CONF_SPEC, bool, 29>;
...
pub type ANA_CLK_RTC_SEL_W<'a> = crate::FieldWriter<'a, u32, CLK_CONF_SPEC, u8, u8, 2, 30>;
impl R {
