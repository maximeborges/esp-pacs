...
pub type TOUCH_SLP_CHANNEL_CLR_W<'a> = crate::BitWriter<'a, u32, TOUCH_APPROACH_SPEC, bool, 23>;
...
pub type MEAS_TIME_W<'a> = crate::FieldWriter<'a, u32, TOUCH_APPROACH_SPEC, u8, u8, 8, 24>;
impl R {
