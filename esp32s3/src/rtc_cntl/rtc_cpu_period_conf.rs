...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_cpu_period_conf]
(index.html) module"]
pub struct RTC_CPU_PERIOD_CONF_SPEC;
impl crate::RegisterSpec for RTC_CPU_PERIOD_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_cpu_period_conf::R]
(R) reader structure"]
impl crate::Readable for RTC_CPU_PERIOD_CONF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_cpu_period_conf::W]
(W) writer structure"]
