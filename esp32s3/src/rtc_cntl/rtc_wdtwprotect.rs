...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_wdtwprotect]
(index.html) module"]
pub struct RTC_WDTWPROTECT_SPEC;
impl crate::RegisterSpec for RTC_WDTWPROTECT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_wdtwprotect::R]
(R) reader structure"]
impl crate::Readable for RTC_WDTWPROTECT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_wdtwprotect::W]
(W) writer structure"]
impl crate::Writable for RTC_WDTWPROTECT_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_WDTWPROTECT to value 0x50d8_3aa1"]
