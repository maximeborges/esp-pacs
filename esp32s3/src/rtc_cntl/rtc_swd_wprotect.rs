...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_swd_wprotect]
(index.html) module"]
pub struct RTC_SWD_WPROTECT_SPEC;
impl crate::RegisterSpec for RTC_SWD_WPROTECT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_swd_wprotect::R]
(R) reader structure"]
impl crate::Readable for RTC_SWD_WPROTECT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_swd_wprotect::W]
(W) writer structure"]
impl crate::Writable for RTC_SWD_WPROTECT_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_SWD_WPROTECT to value 0x8f1d_312a"]
