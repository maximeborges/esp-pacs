...
pub type RTC_CPUSEL_CONF_W<'a> = crate::BitWriter<'a, u32, CPU_PERIOD_CONF_SPEC, bool, 29>;
...
pub type RTC_CPUPERIOD_SEL_W<'a> = crate::FieldWriter<'a, u32, CPU_PERIOD_CONF_SPEC, u8, u8, 2, 30>;
impl R {
