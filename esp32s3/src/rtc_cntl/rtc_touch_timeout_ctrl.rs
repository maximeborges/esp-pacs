#[doc = "Register `RTC_TOUCH_TIMEOUT_CTRL` reader"]
pub struct R(crate::R<RTC_TOUCH_TIMEOUT_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_TOUCH_TIMEOUT_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_TOUCH_TIMEOUT_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_TOUCH_TIMEOUT_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_TOUCH_TIMEOUT_CTRL` writer"]
pub struct W(crate::W<RTC_TOUCH_TIMEOUT_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_TOUCH_TIMEOUT_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_TOUCH_TIMEOUT_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_TOUCH_TIMEOUT_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_touch_timeout_ctrl]
(index.html) module"]
pub struct RTC_TOUCH_TIMEOUT_CTRL_SPEC;
impl crate::RegisterSpec for RTC_TOUCH_TIMEOUT_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_touch_timeout_ctrl::R]
(R) reader structure"]
impl crate::Readable for RTC_TOUCH_TIMEOUT_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_touch_timeout_ctrl::W]
(W) writer structure"]
impl crate::Writable for RTC_TOUCH_TIMEOUT_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_TOUCH_TIMEOUT_CTRL to value 0x007f_ffff"]
impl crate::Resettable for RTC_TOUCH_TIMEOUT_CTRL_SPEC {
    #[inline(always)]
