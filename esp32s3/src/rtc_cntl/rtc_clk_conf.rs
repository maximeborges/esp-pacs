...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_clk_conf]
(index.html) module"]
pub struct RTC_CLK_CONF_SPEC;
impl crate::RegisterSpec for RTC_CLK_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_clk_conf::R]
(R) reader structure"]
impl crate::Readable for RTC_CLK_CONF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_clk_conf::W]
(W) writer structure"]
impl crate::Writable for RTC_CLK_CONF_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_CLK_CONF to value 0x1158_321c"]
