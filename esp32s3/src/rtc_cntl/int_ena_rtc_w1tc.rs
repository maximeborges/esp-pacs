...
pub type SDIO_IDLE_INT_ENA_W1TC_W<'a> = crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 2>;
...
pub type RTC_TOUCH_SCAN_DONE_INT_ENA_W1TC_W<'a> =
    crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 4>;
#[doc = "Field `RTC_ULP_CP_INT_ENA_W1TC` writer - enable ULP-coprocessor interrupt"]
pub type RTC_ULP_CP_INT_ENA_W1TC_W<'a> = crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 5>;
#[doc = "Field `RTC_TOUCH_DONE_INT_ENA_W1TC` writer - enable touch done interrupt"]
pub type RTC_TOUCH_DONE_INT_ENA_W1TC_W<'a> =
    crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 6>;
#[doc = "Field `RTC_TOUCH_ACTIVE_INT_ENA_W1TC` writer - enable touch active interrupt"]
pub type RTC_TOUCH_ACTIVE_INT_ENA_W1TC_W<'a> =
    crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 7>;
#[doc = "Field `RTC_TOUCH_INACTIVE_INT_ENA_W1TC` writer - enable touch inactive interrupt"]
pub type RTC_TOUCH_INACTIVE_INT_ENA_W1TC_W<'a> =
    crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 8>;
...
pub type RTC_SARADC1_INT_ENA_W1TC_W<'a> =
    crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 11>;
#[doc = "Field `RTC_TSENS_INT_ENA_W1TC` writer - enable tsens interrupt"]
pub type RTC_TSENS_INT_ENA_W1TC_W<'a> = crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 12>;
#[doc = "Field `RTC_COCPU_INT_ENA_W1TC` writer - enable riscV cocpu interrupt"]
pub type RTC_COCPU_INT_ENA_W1TC_W<'a> = crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 13>;
#[doc = "Field `RTC_SARADC2_INT_ENA_W1TC` writer - enable saradc2 interrupt"]
pub type RTC_SARADC2_INT_ENA_W1TC_W<'a> =
    crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 14>;
...
pub type RTC_COCPU_TRAP_INT_ENA_W1TC_W<'a> =
    crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 17>;
#[doc = "Field `RTC_TOUCH_TIMEOUT_INT_ENA_W1TC` writer - enable touch timeout interrupt"]
pub type RTC_TOUCH_TIMEOUT_INT_ENA_W1TC_W<'a> =
    crate::BitWriter<'a, u32, INT_ENA_RTC_W1TC_SPEC, bool, 18>;
...
pub type RTC_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TC_W<'a> =
