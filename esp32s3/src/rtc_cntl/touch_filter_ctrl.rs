...
pub type TOUCH_BYPASS_NEG_NOISE_THRES_W<'a> =
    crate::BitWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, bool, 7>;
...
pub type TOUCH_BYPASS_NOISE_THRES_W<'a> =
    crate::BitWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, bool, 8>;
...
pub type TOUCH_SMOOTH_LVL_W<'a> = crate::FieldWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, u8, u8, 2, 9>;
...
pub type TOUCH_JITTER_STEP_W<'a> =
    crate::FieldWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, u8, u8, 4, 11>;
...
pub type TOUCH_NEG_NOISE_LIMIT_W<'a> =
    crate::FieldWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, u8, u8, 4, 15>;
...
pub type TOUCH_NEG_NOISE_THRES_W<'a> =
    crate::FieldWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, u8, u8, 2, 19>;
...
pub type TOUCH_NOISE_THRES_W<'a> =
    crate::FieldWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, u8, u8, 2, 21>;
...
pub type TOUCH_HYSTERESIS_W<'a> =
    crate::FieldWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, u8, u8, 2, 23>;
...
pub type TOUCH_DEBOUNCE_W<'a> = crate::FieldWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, u8, u8, 3, 25>;
...
pub type TOUCH_FILTER_MODE_W<'a> =
    crate::FieldWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, u8, u8, 3, 28>;
...
pub type TOUCH_FILTER_EN_W<'a> = crate::BitWriter<'a, u32, TOUCH_FILTER_CTRL_SPEC, bool, 31>;
impl R {
