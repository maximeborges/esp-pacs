...
pub type PAD_DRIVER_W<'a> = crate::BitWriter<'a, u32, RTC_GPIO_PIN11_SPEC, bool, 2>;
...
pub type INT_TYPE_W<'a> = crate::FieldWriter<'a, u32, RTC_GPIO_PIN11_SPEC, u8, u8, 3, 7>;
...
pub type WAKEUP_ENABLE_W<'a> = crate::BitWriter<'a, u32, RTC_GPIO_PIN11_SPEC, bool, 10>;
impl R {
