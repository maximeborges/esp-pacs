...
pub type CLK_MODE_W<'a> = crate::FieldWriter<'a, u32, SLAVE_SPEC, u8, u8, 2, 0>;
...
pub type CLK_MODE_13_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 2>;
...
pub type RSCK_DATA_OUT_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 3>;
...
pub type SLV_RDDMA_BITLEN_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 8>;
...
pub type SLV_WRDMA_BITLEN_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 9>;
...
pub type SLV_RDBUF_BITLEN_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 10>;
...
pub type SLV_WRBUF_BITLEN_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 11>;
...
pub type DMA_SEG_MAGIC_VALUE_W<'a> = crate::FieldWriter<'a, u32, SLAVE_SPEC, u8, u8, 4, 22>;
...
pub type MODE_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 26>;
...
pub type SOFT_RESET_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 27>;
...
pub type USR_CONF_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 28>;
impl R {
