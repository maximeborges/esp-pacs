...
pub type HOLD_POL_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 20>;
...
pub type WP_POL_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 21>;
...
pub type RD_BIT_ORDER_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 2, 23>;
...
pub type WR_BIT_ORDER_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 2, 25>;
impl R {
