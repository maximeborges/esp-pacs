...
pub type CACHE_USR_SCMD_4BYTE_W<'a> = crate::BitWriter<'a, u32, CACHE_SCTRL_SPEC, bool, 0>;
...
pub type SRAM_RDUMMY_CYCLELEN_W<'a> = crate::FieldWriter<'a, u32, CACHE_SCTRL_SPEC, u8, u8, 6, 6>;
...
pub type SRAM_ADDR_BITLEN_W<'a> = crate::FieldWriter<'a, u32, CACHE_SCTRL_SPEC, u8, u8, 6, 14>;
...
pub type CACHE_SRAM_USR_WCMD_W<'a> = crate::BitWriter<'a, u32, CACHE_SCTRL_SPEC, bool, 20>;
...
pub type SRAM_OCT_W<'a> = crate::BitWriter<'a, u32, CACHE_SCTRL_SPEC, bool, 21>;
...
pub type SRAM_WDUMMY_CYCLELEN_W<'a> = crate::FieldWriter<'a, u32, CACHE_SCTRL_SPEC, u8, u8, 6, 22>;
impl R {
