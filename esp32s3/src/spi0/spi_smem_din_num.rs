...
pub struct SPI_SMEM_DIN0_NUM_R(crate::FieldReader<u8, u8>);
...
pub struct SPI_SMEM_DIN1_NUM_R(crate::FieldReader<u8, u8>);
...
pub struct SPI_SMEM_DIN2_NUM_R(crate::FieldReader<u8, u8>);
...
pub struct SPI_SMEM_DIN3_NUM_R(crate::FieldReader<u8, u8>);
...
pub struct SPI_SMEM_DIN4_NUM_R(crate::FieldReader<u8, u8>);
...
pub struct SPI_SMEM_DIN5_NUM_R(crate::FieldReader<u8, u8>);
...
pub struct SPI_SMEM_DIN6_NUM_R(crate::FieldReader<u8, u8>);
...
pub struct SPI_SMEM_DIN7_NUM_R(crate::FieldReader<u8, u8>);
...
pub struct SPI_SMEM_DINS_NUM_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi_smem_din_num]
(index.html) module"]
pub struct SPI_SMEM_DIN_NUM_SPEC;
impl crate::RegisterSpec for SPI_SMEM_DIN_NUM_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi_smem_din_num::R]
(R) reader structure"]
impl crate::Readable for SPI_SMEM_DIN_NUM_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi_smem_din_num::W]
(W) writer structure"]
