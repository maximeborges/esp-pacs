...
pub type SPI_SMEM_DIN0_MODE_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DIN_MODE_SPEC, u8, u8, 3, 0>;
...
pub type SPI_SMEM_DIN1_MODE_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DIN_MODE_SPEC, u8, u8, 3, 3>;
...
pub type SPI_SMEM_DIN2_MODE_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DIN_MODE_SPEC, u8, u8, 3, 6>;
...
pub type SPI_SMEM_DIN3_MODE_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DIN_MODE_SPEC, u8, u8, 3, 9>;
...
pub type SPI_SMEM_DIN4_MODE_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DIN_MODE_SPEC, u8, u8, 3, 12>;
...
pub type SPI_SMEM_DIN5_MODE_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DIN_MODE_SPEC, u8, u8, 3, 15>;
...
pub type SPI_SMEM_DIN6_MODE_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DIN_MODE_SPEC, u8, u8, 3, 18>;
...
pub type SPI_SMEM_DIN7_MODE_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DIN_MODE_SPEC, u8, u8, 3, 21>;
...
pub type SPI_SMEM_DINS_MODE_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DIN_MODE_SPEC, u8, u8, 3, 24>;
impl R {
