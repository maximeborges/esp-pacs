...
impl ECC_DATA_ERR_BIT_R {
    ...
    pub(crate) fn new(bits: u8) -> Self {
        ECC_DATA_ERR_BIT_R(crate::FieldReader::new(bits))
    }
}
...
impl ECC_CHK_ERR_BIT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        ECC_CHK_ERR_BIT_R(crate::FieldReader::new(bits))
    }
}
...
impl ECC_BYTE_ERR_R {
    ...
    pub(crate) fn new(bits: bool) -> Self {
        ECC_BYTE_ERR_R(crate::FieldReader::new(bits))
    }
}
...
impl ECC_ERR_CNT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        ECC_ERR_CNT_R(crate::FieldReader::new(bits))
    }
}
