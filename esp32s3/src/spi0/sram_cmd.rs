...
pub type SCLK_MODE_W<'a> = crate::FieldWriter<'a, u32, SRAM_CMD_SPEC, u8, u8, 2, 0>;
...
pub type SWB_MODE_W<'a> = crate::FieldWriter<'a, u32, SRAM_CMD_SPEC, u8, u8, 8, 2>;
...
pub type SDIN_DUAL_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 10>;
...
pub type SDOUT_DUAL_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 11>;
...
pub type SADDR_DUAL_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 12>;
...
pub type SCMD_DUAL_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 13>;
...
pub type SDIN_QUAD_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 14>;
...
pub type SDOUT_QUAD_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 15>;
...
pub type SADDR_QUAD_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 16>;
...
pub type SCMD_QUAD_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 17>;
...
pub type SDIN_OCT_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 18>;
...
pub type SDOUT_OCT_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 19>;
...
pub type SADDR_OCT_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 20>;
...
pub type SCMD_OCT_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 21>;
...
pub type SDUMMY_OUT_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 22>;
impl R {
