...
pub struct SPI_SMEM_SPICLK_FUN_DRV_R(crate::FieldReader<u8>);
...
pub struct SPI_FMEM_SPICLK_FUN_DRV_R(crate::FieldReader<u8>);
...
pub struct SPI_SPICLK_PAD_DRV_CTL_EN_R(crate::FieldReader<bool>);
