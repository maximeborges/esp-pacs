...
pub struct SPI_SMEM_VAR_DUMMY_R(crate::FieldReader<bool, bool>);
...
pub struct RDAT_SWP_R(crate::FieldReader<bool, bool>);
impl RDAT_SWP_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct WDAT_SWP_R(crate::FieldReader<bool, bool>);
impl WDAT_SWP_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct CMD_DIS_R(crate::FieldReader<bool, bool>);
impl CMD_DIS_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct SPI_SMEM_OUTMINBYTELEN_R(crate::FieldReader<u8, u8>);
...
pub struct SPI_SMEM_TX_DDR_MSK_EN_R(crate::FieldReader<bool, bool>);
...
pub struct SPI_SMEM_RX_DDR_MSK_EN_R(crate::FieldReader<bool, bool>);
...
pub struct SPI_SMEM_USR_DDR_DQS_THD_R(crate::FieldReader<u8, u8>);
...
pub struct DQS_LOOP_R(crate::FieldReader<bool, bool>);
impl DQS_LOOP_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct DQS_LOOP_MODE_R(crate::FieldReader<bool, bool>);
...
pub struct SPI_SMEM_CLK_DIFF_EN_R(crate::FieldReader<bool, bool>);
...
pub struct SPI_SMEM_HYPERBUS_MODE_R(crate::FieldReader<bool, bool>);
...
pub struct SPI_SMEM_DQS_CA_IN_R(crate::FieldReader<bool, bool>);
...
pub struct SPI_SMEM_HYPERBUS_DUMMY_2X_R(crate::FieldReader<bool, bool>);
...
pub struct SPI_SMEM_CLK_DIFF_INV_R(crate::FieldReader<bool, bool>);
...
#[doc = "Field `SPI_SMEM_OCTA_RAM_ADDR` reader - Set this bit to enable octa_ram address out when accesses to external RAM, which means ADDR_OUT\\[31:0\\]
 = {spi_usr_addr_value\\[25:4\\]
, 6'd0, spi_usr_addr_value\\[3:1\\]
, 1'b0}."]
pub struct SPI_SMEM_OCTA_RAM_ADDR_R(crate::FieldReader<bool, bool>);
...
#[doc = "Field `SPI_SMEM_OCTA_RAM_ADDR` writer - Set this bit to enable octa_ram address out when accesses to external RAM, which means ADDR_OUT\\[31:0\\]
 = {spi_usr_addr_value\\[25:4\\]
, 6'd0, spi_usr_addr_value\\[3:1\\]
, 1'b0}."]
...
#[doc = "Field `SPI_SMEM_HYPERBUS_CA` reader - Set this bit to enable HyperRAM address out when accesses to external RAM, which means ADDR_OUT\\[31:0\\]
 = {spi_usr_addr_value\\[19:4\\]
, 13'd0, spi_usr_addr_value\\[3:1\\]
}."]
pub struct SPI_SMEM_HYPERBUS_CA_R(crate::FieldReader<bool, bool>);
...
#[doc = "Field `SPI_SMEM_HYPERBUS_CA` writer - Set this bit to enable HyperRAM address out when accesses to external RAM, which means ADDR_OUT\\[31:0\\]
 = {spi_usr_addr_value\\[19:4\\]
, 13'd0, spi_usr_addr_value\\[3:1\\]
}."]
...
impl R {
    ...
    pub fn spi_smem_tx_ddr_msk_en(&self) -> SPI_SMEM_TX_DDR_MSK_EN_R {
        SPI_SMEM_TX_DDR_MSK_EN_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    ...
    pub fn spi_smem_rx_ddr_msk_en(&self) -> SPI_SMEM_RX_DDR_MSK_EN_R {
        SPI_SMEM_RX_DDR_MSK_EN_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    ...
    pub fn dqs_loop(&self) -> DQS_LOOP_R {
        DQS_LOOP_R::new(((self.bits >> 21) & 0x01) != 0)
    }
    ...
    pub fn spi_smem_dqs_ca_in(&self) -> SPI_SMEM_DQS_CA_IN_R {
        SPI_SMEM_DQS_CA_IN_R::new(((self.bits >> 26) & 0x01) != 0)
    }
    ...
    pub fn spi_smem_hyperbus_dummy_2x(&self) -> SPI_SMEM_HYPERBUS_DUMMY_2X_R {
        SPI_SMEM_HYPERBUS_DUMMY_2X_R::new(((self.bits >> 27) & 0x01) != 0)
    }
    ...
    pub fn spi_smem_clk_diff_inv(&self) -> SPI_SMEM_CLK_DIFF_INV_R {
        SPI_SMEM_CLK_DIFF_INV_R::new(((self.bits >> 28) & 0x01) != 0)
    }
    #[doc = "Bit 29 - Set this bit to enable octa_ram address out when accesses to external RAM, which means ADDR_OUT\\[31:0\\]
 = {spi_usr_addr_value\\[25:4\\]
, 6'd0, spi_usr_addr_value\\[3:1\\]
, 1'b0}."]
    #[inline(always)]
    pub fn spi_smem_octa_ram_addr(&self) -> SPI_SMEM_OCTA_RAM_ADDR_R {
        SPI_SMEM_OCTA_RAM_ADDR_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    #[doc = "Bit 30 - Set this bit to enable HyperRAM address out when accesses to external RAM, which means ADDR_OUT\\[31:0\\]
 = {spi_usr_addr_value\\[19:4\\]
, 13'd0, spi_usr_addr_value\\[3:1\\]
}."]
    #[inline(always)]
    pub fn spi_smem_hyperbus_ca(&self) -> SPI_SMEM_HYPERBUS_CA_R {
        SPI_SMEM_HYPERBUS_CA_R::new(((self.bits >> 30) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - 1: in ddr mode, 0 in sdr mode"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi_smem_ddr]
(index.html) module"]
pub struct SPI_SMEM_DDR_SPEC;
impl crate::RegisterSpec for SPI_SMEM_DDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi_smem_ddr::R]
(R) reader structure"]
impl crate::Readable for SPI_SMEM_DDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi_smem_ddr::W]
(W) writer structure"]
