...
pub type EN_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 0>;
...
pub type SPI_SMEM_VAR_DUMMY_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 1>;
...
pub type RDAT_SWP_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 2>;
...
pub type WDAT_SWP_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 3>;
...
pub type CMD_DIS_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 4>;
...
pub type SPI_SMEM_OUTMINBYTELEN_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DDR_SPEC, u8, u8, 7, 5>;
...
pub type SPI_SMEM_TX_DDR_MSK_EN_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 12>;
...
pub type SPI_SMEM_RX_DDR_MSK_EN_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 13>;
...
pub type SPI_SMEM_USR_DDR_DQS_THD_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_DDR_SPEC, u8, u8, 7, 14>;
...
pub type DQS_LOOP_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 21>;
...
pub type DQS_LOOP_MODE_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 22>;
...
pub type SPI_SMEM_CLK_DIFF_EN_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 24>;
...
pub type SPI_SMEM_HYPERBUS_MODE_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 25>;
...
pub type SPI_SMEM_DQS_CA_IN_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 26>;
...
pub type SPI_SMEM_HYPERBUS_DUMMY_2X_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 27>;
...
pub type SPI_SMEM_CLK_DIFF_INV_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 28>;
...
pub type SPI_SMEM_OCTA_RAM_ADDR_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 29>;
...
pub type SPI_SMEM_HYPERBUS_CA_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_DDR_SPEC, bool, 30>;
impl R {
