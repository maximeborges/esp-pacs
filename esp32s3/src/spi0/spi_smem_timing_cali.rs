...
pub type SPI_SMEM_TIMING_CLK_ENA_W<'a> =
    crate::BitWriter<'a, u32, SPI_SMEM_TIMING_CALI_SPEC, bool, 0>;
...
pub type SPI_SMEM_TIMING_CALI_W<'a> = crate::BitWriter<'a, u32, SPI_SMEM_TIMING_CALI_SPEC, bool, 1>;
...
pub type SPI_SMEM_EXTRA_DUMMY_CYCLELEN_W<'a> =
    crate::FieldWriter<'a, u32, SPI_SMEM_TIMING_CALI_SPEC, u8, u8, 3, 2>;
impl R {
