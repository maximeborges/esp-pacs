...
pub type CS_SETUP_TIME_W<'a> = crate::FieldWriter<'a, u32, CTRL2_SPEC, u8, u8, 5, 0>;
...
pub type CS_HOLD_TIME_W<'a> = crate::FieldWriter<'a, u32, CTRL2_SPEC, u8, u8, 5, 5>;
...
pub type ECC_CS_HOLD_TIME_W<'a> = crate::FieldWriter<'a, u32, CTRL2_SPEC, u8, u8, 3, 10>;
...
pub type ECC_SKIP_PAGE_CORNER_W<'a> = crate::BitWriter<'a, u32, CTRL2_SPEC, bool, 13>;
...
pub type ECC_16TO18_BYTE_EN_W<'a> = crate::BitWriter<'a, u32, CTRL2_SPEC, bool, 14>;
...
pub type CS_HOLD_DELAY_W<'a> = crate::FieldWriter<'a, u32, CTRL2_SPEC, u8, u8, 6, 25>;
