...
pub type LCD_DOUT_CYCLELEN_W<'a> = crate::FieldWriter<'a, u32, LCD_USER_SPEC, u16, u16, 13, 0>;
...
pub type LCD_ALWAYS_OUT_EN_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 13>;
...
pub type LCD_8BITS_ORDER_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 19>;
...
pub type LCD_UPDATE_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 20>;
...
pub type LCD_BIT_ORDER_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 21>;
...
pub type LCD_BYTE_ORDER_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 22>;
...
pub type LCD_2BYTE_EN_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 23>;
...
pub type LCD_DOUT_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 24>;
...
pub type LCD_DUMMY_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 25>;
...
pub type LCD_CMD_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 26>;
...
pub type LCD_START_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 27>;
#[doc = "Field `LCD_RESET` writer - The value of command."]
pub type LCD_RESET_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 28>;
...
pub type LCD_DUMMY_CYCLELEN_W<'a> = crate::FieldWriter<'a, u32, LCD_USER_SPEC, u8, u8, 2, 29>;
...
pub type LCD_CMD_2_CYCLE_EN_W<'a> = crate::BitWriter<'a, u32, LCD_USER_SPEC, bool, 31>;
impl R {
