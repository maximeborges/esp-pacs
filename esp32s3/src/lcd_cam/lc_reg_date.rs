...
pub struct LC_DATE_R(crate::FieldReader<u32, u32>);
impl LC_DATE_R {
    #[inline(always)]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lc_reg_date]
(index.html) module"]
pub struct LC_REG_DATE_SPEC;
impl crate::RegisterSpec for LC_REG_DATE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lc_reg_date::R]
(R) reader structure"]
impl crate::Readable for LC_REG_DATE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lc_reg_date::W]
(W) writer structure"]
