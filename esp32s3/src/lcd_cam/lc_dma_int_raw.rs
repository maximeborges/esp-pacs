...
pub struct LCD_VSYNC_INT_RAW_R(crate::FieldReader<bool>);
...
pub struct LCD_TRANS_DONE_INT_RAW_R(crate::FieldReader<bool>);
...
pub struct CAM_VSYNC_INT_RAW_R(crate::FieldReader<bool>);
...
pub struct CAM_HS_INT_RAW_R(crate::FieldReader<bool>);
