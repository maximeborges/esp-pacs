...
impl CNT_THR_ZERO_MODE_U_R {
    ...
    pub(crate) fn new(bits: u8) -> Self {
        CNT_THR_ZERO_MODE_U_R(crate::FieldReader::new(bits))
    }
}
...
impl CNT_THR_THRES1_LAT_U_R {
    ...
    pub(crate) fn new(bits: bool) -> Self {
        CNT_THR_THRES1_LAT_U_R(crate::FieldReader::new(bits))
    }
}
...
impl CNT_THR_THRES0_LAT_U_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CNT_THR_THRES0_LAT_U_R(crate::FieldReader::new(bits))
    }
}
...
impl CNT_THR_L_LIM_LAT_U_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CNT_THR_L_LIM_LAT_U_R(crate::FieldReader::new(bits))
    }
}
...
impl CNT_THR_H_LIM_LAT_U_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CNT_THR_H_LIM_LAT_U_R(crate::FieldReader::new(bits))
    }
}
...
impl CNT_THR_ZERO_LAT_U_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CNT_THR_ZERO_LAT_U_R(crate::FieldReader::new(bits))
    }
}
