...
pub type SRP_SESSEND_OVERRIDE_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 0>;
...
pub type SRP_SESSEND_VALUE_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 1>;
...
pub type PHY_SEL_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 2>;
...
pub type DFIFO_FORCE_PD_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 3>;
...
pub type DBNCE_FLTR_BYPASS_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 4>;
...
pub type EXCHG_PINS_OVERRIDE_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 5>;
...
pub type EXCHG_PINS_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 6>;
...
pub type VREFH_W<'a> = crate::FieldWriter<'a, u32, OTG_CONF_SPEC, u8, u8, 2, 7>;
...
pub type VREFL_W<'a> = crate::FieldWriter<'a, u32, OTG_CONF_SPEC, u8, u8, 2, 9>;
...
pub type VREF_OVERRIDE_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 11>;
...
pub type PAD_PULL_OVERRIDE_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 12>;
...
pub type DP_PULLUP_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 13>;
...
pub type DP_PULLDOWN_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 14>;
...
pub type DM_PULLUP_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 15>;
...
pub type DM_PULLDOWN_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 16>;
...
pub type PULLUP_VALUE_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 17>;
...
pub type USB_PAD_ENABLE_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 18>;
...
pub type AHB_CLK_FORCE_ON_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 19>;
...
pub type PHY_CLK_FORCE_ON_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 20>;
...
pub type PHY_TX_EDGE_SEL_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 21>;
...
pub type DFIFO_FORCE_PU_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 22>;
...
pub type CLK_EN_W<'a> = crate::BitWriter<'a, u32, OTG_CONF_SPEC, bool, 31>;
impl R {
