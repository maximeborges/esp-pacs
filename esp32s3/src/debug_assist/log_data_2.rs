...
pub struct LOG_DATA_2_R(crate::FieldReader<u32, u32>);
impl LOG_DATA_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        LOG_DATA_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LOG_DATA_2_R {
...
pub struct LOG_DATA_2_W<'a> {
    w: &'a mut W,
}
impl<'a> LOG_DATA_2_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - check data2"]
    #[inline(always)]
    pub fn log_data_2(&mut self) -> LOG_DATA_2_W {
        LOG_DATA_2_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [log_data_2]
(index.html) module"]
pub struct LOG_DATA_2_SPEC;
impl crate::RegisterSpec for LOG_DATA_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [log_data_2::R]
(R) reader structure"]
impl crate::Readable for LOG_DATA_2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [log_data_2::W]
(W) writer structure"]
