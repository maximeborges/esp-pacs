...
pub struct CORE_1_RCD_PDEBUGENABLE_R(crate::FieldReader<bool, bool>);
impl CORE_1_RCD_PDEBUGENABLE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_RCD_PDEBUGENABLE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_RCD_PDEBUGENABLE_R {
...
pub struct CORE_1_RCD_PDEBUGENABLE_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_RCD_PDEBUGENABLE_W<'a> {
...
impl R {
    ...
    pub fn core_1_rcd_pdebugenable(&self) -> CORE_1_RCD_PDEBUGENABLE_R {
        CORE_1_RCD_PDEBUGENABLE_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Core1 Pdebugenable,set 1 to open Core1 Pdebug interface, then can get Core1 PC"]
    #[inline(always)]
    pub fn core_1_rcd_pdebugenable(&mut self) -> CORE_1_RCD_PDEBUGENABLE_W {
        CORE_1_RCD_PDEBUGENABLE_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_rcd_pdebugenable]
(index.html) module"]
pub struct CORE_1_RCD_PDEBUGENABLE_SPEC;
impl crate::RegisterSpec for CORE_1_RCD_PDEBUGENABLE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_rcd_pdebugenable::R]
(R) reader structure"]
impl crate::Readable for CORE_1_RCD_PDEBUGENABLE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_rcd_pdebugenable::W]
(W) writer structure"]
