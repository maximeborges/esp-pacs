...
pub struct CORE_0_RCD_PDEBUGSTATUS_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_rcd_pdebugstatus]
(index.html) module"]
pub struct CORE_0_RCD_PDEBUGSTATUS_SPEC;
impl crate::RegisterSpec for CORE_0_RCD_PDEBUGSTATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_rcd_pdebugstatus::R]
(R) reader structure"]
