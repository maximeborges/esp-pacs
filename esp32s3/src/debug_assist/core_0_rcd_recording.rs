...
pub struct CORE_0_RCD_RECORDING_R(crate::FieldReader<bool, bool>);
impl CORE_0_RCD_RECORDING_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_RCD_RECORDING_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_RCD_RECORDING_R {
...
pub struct CORE_0_RCD_RECORDING_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_RCD_RECORDING_W<'a> {
...
impl R {
    ...
    pub fn core_0_rcd_recording(&self) -> CORE_0_RCD_RECORDING_R {
        CORE_0_RCD_RECORDING_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Pdebug record enable,set 1 to record core0 pdebug interface signal"]
    #[inline(always)]
    pub fn core_0_rcd_recording(&mut self) -> CORE_0_RCD_RECORDING_W {
        CORE_0_RCD_RECORDING_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_rcd_recording]
(index.html) module"]
pub struct CORE_0_RCD_RECORDING_SPEC;
impl crate::RegisterSpec for CORE_0_RCD_RECORDING_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_rcd_recording::R]
(R) reader structure"]
impl crate::Readable for CORE_0_RCD_RECORDING_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_rcd_recording::W]
(W) writer structure"]
