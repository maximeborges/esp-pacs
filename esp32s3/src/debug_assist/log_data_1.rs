...
pub struct LOG_DATA_1_R(crate::FieldReader<u32, u32>);
impl LOG_DATA_1_R {
    #[inline(always)]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [log_data_1]
(index.html) module"]
pub struct LOG_DATA_1_SPEC;
impl crate::RegisterSpec for LOG_DATA_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [log_data_1::R]
(R) reader structure"]
impl crate::Readable for LOG_DATA_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [log_data_1::W]
(W) writer structure"]
