...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_area_dram0_1_max]
(index.html) module"]
pub struct CORE_0_AREA_DRAM0_1_MAX_SPEC;
impl crate::RegisterSpec for CORE_0_AREA_DRAM0_1_MAX_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_area_dram0_1_max::R]
(R) reader structure"]
impl crate::Readable for CORE_0_AREA_DRAM0_1_MAX_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_area_dram0_1_max::W]
(W) writer structure"]
