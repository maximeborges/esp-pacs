...
pub struct CORE_1_RCD_PDEBUGPC_R(crate::FieldReader<u32, u32>);
impl CORE_1_RCD_PDEBUGPC_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_1_RCD_PDEBUGPC_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_RCD_PDEBUGPC_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_rcd_pdebugpc]
(index.html) module"]
pub struct CORE_1_RCD_PDEBUGPC_SPEC;
impl crate::RegisterSpec for CORE_1_RCD_PDEBUGPC_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_rcd_pdebugpc::R]
(R) reader structure"]
