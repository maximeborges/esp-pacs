...
#[doc = "Field `CORE_1_IRAM0_RECORDING_ADDR_1` reader - The second iram0's addr\\[25:2\\]
 status when trigger IRAM busy interrupt"]
pub struct CORE_1_IRAM0_RECORDING_ADDR_1_R(crate::FieldReader<u32, u32>);
impl CORE_1_IRAM0_RECORDING_ADDR_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_1_IRAM0_RECORDING_ADDR_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_IRAM0_RECORDING_ADDR_1_R {
...
pub struct CORE_1_IRAM0_RECORDING_WR_1_R(crate::FieldReader<bool, bool>);
impl CORE_1_IRAM0_RECORDING_WR_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_IRAM0_RECORDING_WR_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_IRAM0_RECORDING_WR_1_R {
...
pub struct CORE_1_IRAM0_RECORDING_LOADSTORE_1_R(crate::FieldReader<bool, bool>);
impl CORE_1_IRAM0_RECORDING_LOADSTORE_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_IRAM0_RECORDING_LOADSTORE_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_IRAM0_RECORDING_LOADSTORE_1_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    #[doc = "Bits 0:23 - The second iram0's addr\\[25:2\\]
 status when trigger IRAM busy interrupt"]
    #[inline(always)]
    ...
    pub fn core_1_iram0_recording_wr_1(&self) -> CORE_1_IRAM0_RECORDING_WR_1_R {
        CORE_1_IRAM0_RECORDING_WR_1_R::new(((self.bits >> 24) & 0x01) != 0)
    }
    ...
    pub fn core_1_iram0_recording_loadstore_1(&self) -> CORE_1_IRAM0_RECORDING_LOADSTORE_1_R {
        CORE_1_IRAM0_RECORDING_LOADSTORE_1_R::new(((self.bits >> 25) & 0x01) != 0)
    }
}
#[doc = "Core1 bus busy status regsiter\n\nThis register you can [`read`]
(crate::generic::Reg::read). See [API]
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_iram0_exception_monitor_1]
(index.html) module"]
pub struct CORE_1_IRAM0_EXCEPTION_MONITOR_1_SPEC;
impl crate::RegisterSpec for CORE_1_IRAM0_EXCEPTION_MONITOR_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_iram0_exception_monitor_1::R]
(R) reader structure"]
