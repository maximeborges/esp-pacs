...
pub struct CORE_0_RCD_PDEBUGDATA_R(crate::FieldReader<u32, u32>);
impl CORE_0_RCD_PDEBUGDATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_0_RCD_PDEBUGDATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_RCD_PDEBUGDATA_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_rcd_pdebugdata]
(index.html) module"]
pub struct CORE_0_RCD_PDEBUGDATA_SPEC;
impl crate::RegisterSpec for CORE_0_RCD_PDEBUGDATA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_rcd_pdebugdata::R]
(R) reader structure"]
