...
pub struct CORE_1_SP_MAX_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_sp_max]
(index.html) module"]
pub struct CORE_1_SP_MAX_SPEC;
impl crate::RegisterSpec for CORE_1_SP_MAX_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_sp_max::R]
(R) reader structure"]
impl crate::Readable for CORE_1_SP_MAX_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_sp_max::W]
(W) writer structure"]
