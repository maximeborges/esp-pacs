...
#[doc = "Field `CORE_1_DRAM0_RECORDING_ADDR_0` reader - The first dram0's addr\\[25:4\\]
 status when trigger DRAM busy interrupt"]
pub struct CORE_1_DRAM0_RECORDING_ADDR_0_R(crate::FieldReader<u32, u32>);
impl CORE_1_DRAM0_RECORDING_ADDR_0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_1_DRAM0_RECORDING_ADDR_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_DRAM0_RECORDING_ADDR_0_R {
...
pub struct CORE_1_DRAM0_RECORDING_WR_0_R(crate::FieldReader<bool, bool>);
impl CORE_1_DRAM0_RECORDING_WR_0_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_DRAM0_RECORDING_WR_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_DRAM0_RECORDING_WR_0_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_dram0_exception_monitor_0]
(index.html) module"]
pub struct CORE_1_DRAM0_EXCEPTION_MONITOR_0_SPEC;
impl crate::RegisterSpec for CORE_1_DRAM0_EXCEPTION_MONITOR_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_dram0_exception_monitor_0::R]
(R) reader structure"]
