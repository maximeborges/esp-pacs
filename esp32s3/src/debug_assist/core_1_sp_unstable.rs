...
pub struct CORE_1_SP_UNSTABLE_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_sp_unstable]
(index.html) module"]
pub struct CORE_1_SP_UNSTABLE_SPEC;
impl crate::RegisterSpec for CORE_1_SP_UNSTABLE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_sp_unstable::R]
(R) reader structure"]
impl crate::Readable for CORE_1_SP_UNSTABLE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_sp_unstable::W]
(W) writer structure"]
