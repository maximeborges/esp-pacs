...
pub struct RX_PRI_CH_R(crate::FieldReader<u8, u8>);
impl RX_PRI_CH_R {
    #[inline(always)]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [in_pri_ch]
(index.html) module"]
pub struct IN_PRI_CH_SPEC;
impl crate::RegisterSpec for IN_PRI_CH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [in_pri_ch::R]
(R) reader structure"]
impl crate::Readable for IN_PRI_CH_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [in_pri_ch::W]
(W) writer structure"]
