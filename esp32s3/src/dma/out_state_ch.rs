...
pub struct OUTLINK_DSCR_ADDR_CH_R(crate::FieldReader<u32>);
...
pub struct OUT_DSCR_STATE_CH_R(crate::FieldReader<u8>);
...
pub struct OUT_STATE_CH_R(crate::FieldReader<u8>);
impl OUT_STATE_CH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
