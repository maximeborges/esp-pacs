...
pub struct TX_WEIGHT_CH_R(crate::FieldReader<u8, u8>);
impl TX_WEIGHT_CH_R {
    #[inline(always)]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [out_wight_ch]
(index.html) module"]
pub struct OUT_WIGHT_CH_SPEC;
impl crate::RegisterSpec for OUT_WIGHT_CH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [out_wight_ch::R]
(R) reader structure"]
impl crate::Readable for OUT_WIGHT_CH_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [out_wight_ch::W]
(W) writer structure"]
