...
pub struct OUTLINK_DSCR_BF1_CH_R(crate::FieldReader<u32, u32>);
impl OUTLINK_DSCR_BF1_CH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        OUTLINK_DSCR_BF1_CH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUTLINK_DSCR_BF1_CH_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [out_dscr_bf1_ch]
(index.html) module"]
pub struct OUT_DSCR_BF1_CH_SPEC;
impl crate::RegisterSpec for OUT_DSCR_BF1_CH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [out_dscr_bf1_ch::R]
(R) reader structure"]
