...
pub struct OUT_EOF_BFR_DES_ADDR_CH_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [out_eof_bfr_des_addr_ch]
(index.html) module"]
pub struct OUT_EOF_BFR_DES_ADDR_CH_SPEC;
impl crate::RegisterSpec for OUT_EOF_BFR_DES_ADDR_CH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [out_eof_bfr_des_addr_ch::R]
(R) reader structure"]
