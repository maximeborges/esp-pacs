...
pub struct INLINK_DSCR_ADDR_CH_R(crate::FieldReader<u32, u32>);
...
pub struct IN_DSCR_STATE_CH_R(crate::FieldReader<u8, u8>);
...
pub struct IN_STATE_CH_R(crate::FieldReader<u8, u8>);
impl IN_STATE_CH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
impl R {
    ...
    pub fn in_dscr_state_ch(&self) -> IN_DSCR_STATE_CH_R {
        IN_DSCR_STATE_CH_R::new(((self.bits >> 18) & 0x03) as u8)
    }
    #[doc = "Bits 20:22 - reserved"]
    #[inline(always)]
    pub fn in_state_ch(&self) -> IN_STATE_CH_R {
        IN_STATE_CH_R::new(((self.bits >> 20) & 0x07) as u8)
    }
}
...
#[doc = "`read()` method returns [in_state_ch::R]
(R) reader structure"]
