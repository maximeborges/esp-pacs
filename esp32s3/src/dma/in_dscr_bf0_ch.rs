...
pub struct INLINK_DSCR_BF0_CH_R(crate::FieldReader<u32, u32>);
impl INLINK_DSCR_BF0_CH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        INLINK_DSCR_BF0_CH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INLINK_DSCR_BF0_CH_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [in_dscr_bf0_ch]
(index.html) module"]
pub struct IN_DSCR_BF0_CH_SPEC;
impl crate::RegisterSpec for IN_DSCR_BF0_CH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [in_dscr_bf0_ch::R]
(R) reader structure"]
