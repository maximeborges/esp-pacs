...
pub struct PERI_IN_SEL_CH_R(crate::FieldReader<u8, u8>);
impl PERI_IN_SEL_CH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PERI_IN_SEL_CH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PERI_IN_SEL_CH_R {
...
pub struct PERI_IN_SEL_CH_W<'a> {
    w: &'a mut W,
}
impl<'a> PERI_IN_SEL_CH_W<'a> {
...
impl W {
    #[doc = "Bits 0:5 - This register is used to select peripheral for Rx channel 0. 0:SPI2. 1: SPI3. 2: UHCI0. 3: I2S0. 4: I2S1. 5: LCD_CAM. 6: AES. 7: SHA. 8: ADC_DAC. 9: RMT."]
    #[inline(always)]
    pub fn peri_in_sel_ch(&mut self) -> PERI_IN_SEL_CH_W {
        PERI_IN_SEL_CH_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [in_peri_sel_ch]
(index.html) module"]
pub struct IN_PERI_SEL_CH_SPEC;
impl crate::RegisterSpec for IN_PERI_SEL_CH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [in_peri_sel_ch::R]
(R) reader structure"]
impl crate::Readable for IN_PERI_SEL_CH_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [in_peri_sel_ch::W]
(W) writer structure"]
