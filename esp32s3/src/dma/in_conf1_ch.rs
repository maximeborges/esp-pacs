...
pub type DMA_INFIFO_FULL_THRS_CH_W<'a> =
    crate::FieldWriter<'a, u32, IN_CONF1_CH_SPEC, u16, u16, 12, 0>;
...
pub type IN_CHECK_OWNER_CH_W<'a> = crate::BitWriter<'a, u32, IN_CONF1_CH_SPEC, bool, 12>;
...
pub type IN_EXT_MEM_BK_SIZE_CH_W<'a> = crate::FieldWriter<'a, u32, IN_CONF1_CH_SPEC, u8, u8, 2, 13>;
impl R {
