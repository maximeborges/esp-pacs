...
pub struct OUT_EOF_DES_ADDR_CH_R(crate::FieldReader<u32, u32>);
impl OUT_EOF_DES_ADDR_CH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        OUT_EOF_DES_ADDR_CH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUT_EOF_DES_ADDR_CH_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [out_eof_des_addr_ch]
(index.html) module"]
pub struct OUT_EOF_DES_ADDR_CH_SPEC;
impl crate::RegisterSpec for OUT_EOF_DES_ADDR_CH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [out_eof_des_addr_ch::R]
(R) reader structure"]
