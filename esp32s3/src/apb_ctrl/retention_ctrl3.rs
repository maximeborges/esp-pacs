...
pub struct RET_DCACHE_SIZE_R(crate::FieldReader<u16, u16>);
...
pub struct RET_DCACHE_VLD_SIZE_R(crate::FieldReader<u16, u16>);
...
pub struct RET_DCACHE_START_POINT_R(crate::FieldReader<u16, u16>);
...
pub struct RET_DCACHE_ENABLE_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn ret_dcache_enable(&self) -> RET_DCACHE_ENABLE_R {
        RET_DCACHE_ENABLE_R::new(((self.bits >> 31) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 4:12 - ******* Description ***********"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [retention_ctrl3]
(index.html) module"]
pub struct RETENTION_CTRL3_SPEC;
impl crate::RegisterSpec for RETENTION_CTRL3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [retention_ctrl3::R]
(R) reader structure"]
impl crate::Readable for RETENTION_CTRL3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [retention_ctrl3::W]
(W) writer structure"]
