...
pub struct RETENTION_INV_CFG_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [retention_ctrl4]
(index.html) module"]
pub struct RETENTION_CTRL4_SPEC;
impl crate::RegisterSpec for RETENTION_CTRL4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [retention_ctrl4::R]
(R) reader structure"]
impl crate::Readable for RETENTION_CTRL4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [retention_ctrl4::W]
(W) writer structure"]
