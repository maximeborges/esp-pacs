...
pub struct FLASH_ACE2_ATTR_R(crate::FieldReader<u16, u16>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [flash_ace2_attr]
(index.html) module"]
pub struct FLASH_ACE2_ATTR_SPEC;
impl crate::RegisterSpec for FLASH_ACE2_ATTR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [flash_ace2_attr::R]
(R) reader structure"]
impl crate::Readable for FLASH_ACE2_ATTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [flash_ace2_attr::W]
(W) writer structure"]
