...
pub struct SRAM_ACE0_SIZE_R(crate::FieldReader<u16, u16>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sram_ace0_size]
(index.html) module"]
pub struct SRAM_ACE0_SIZE_SPEC;
impl crate::RegisterSpec for SRAM_ACE0_SIZE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sram_ace0_size::R]
(R) reader structure"]
impl crate::Readable for SRAM_ACE0_SIZE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sram_ace0_size::W]
(W) writer structure"]
