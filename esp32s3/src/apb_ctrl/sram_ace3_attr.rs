...
pub struct SRAM_ACE3_ATTR_R(crate::FieldReader<u16, u16>);
impl SRAM_ACE3_ATTR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        SRAM_ACE3_ATTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SRAM_ACE3_ATTR_R {
...
pub struct SRAM_ACE3_ATTR_W<'a> {
    w: &'a mut W,
}
impl<'a> SRAM_ACE3_ATTR_W<'a> {
...
impl W {
    #[doc = "Bits 0:8 - ******* Description ***********"]
    #[inline(always)]
    pub fn sram_ace3_attr(&mut self) -> SRAM_ACE3_ATTR_W {
        SRAM_ACE3_ATTR_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sram_ace3_attr]
(index.html) module"]
pub struct SRAM_ACE3_ATTR_SPEC;
impl crate::RegisterSpec for SRAM_ACE3_ATTR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sram_ace3_attr::R]
(R) reader structure"]
impl crate::Readable for SRAM_ACE3_ATTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sram_ace3_attr::W]
(W) writer structure"]
