...
pub struct SRAM_ACE1_SIZE_R(crate::FieldReader<u16, u16>);
impl SRAM_ACE1_SIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        SRAM_ACE1_SIZE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SRAM_ACE1_SIZE_R {
...
pub struct SRAM_ACE1_SIZE_W<'a> {
    w: &'a mut W,
}
impl<'a> SRAM_ACE1_SIZE_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - ******* Description ***********"]
    #[inline(always)]
    pub fn sram_ace1_size(&mut self) -> SRAM_ACE1_SIZE_W {
        SRAM_ACE1_SIZE_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sram_ace1_size]
(index.html) module"]
pub struct SRAM_ACE1_SIZE_SPEC;
impl crate::RegisterSpec for SRAM_ACE1_SIZE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sram_ace1_size::R]
(R) reader structure"]
impl crate::Readable for SRAM_ACE1_SIZE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sram_ace1_size::W]
(W) writer structure"]
