...
pub struct DONE_INT_RAW_R(crate::FieldReader<bool, bool>);
impl DONE_INT_RAW_R {
    #[inline(always)]
...
pub struct ERR_INT_RAW_R(crate::FieldReader<bool, bool>);
impl ERR_INT_RAW_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
impl R {
    ...
    pub fn done_int_raw(&self) -> DONE_INT_RAW_R {
        DONE_INT_RAW_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - x"]
    #[inline(always)]
    pub fn err_int_raw(&self) -> ERR_INT_RAW_R {
        ERR_INT_RAW_R::new(((self.bits >> 1) & 0x01) != 0)
    }
}
