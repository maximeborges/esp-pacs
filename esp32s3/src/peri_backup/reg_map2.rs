...
pub struct MAP2_R(crate::FieldReader<u32, u32>);
impl MAP2_R {
    #[inline(always)]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [reg_map2]
(index.html) module"]
pub struct REG_MAP2_SPEC;
impl crate::RegisterSpec for REG_MAP2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [reg_map2::R]
(R) reader structure"]
impl crate::Readable for REG_MAP2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [reg_map2::W]
(W) writer structure"]
