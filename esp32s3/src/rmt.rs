...
pub struct RegisterBlock {
    ...
    pub tx_chdata: [crate::Reg<tx_chdata::TX_CHDATA_SPEC>; 4],
    #[doc = "0x10..0x20 - The read and write data register for CHANNEL$n by apb fifo access."]
    pub rx_chdata: [crate::Reg<rx_chdata::RX_CHDATA_SPEC>; 4],
    #[doc = "0x20..0x30 - Channel %s configure register 0"]
    pub ch_tx_conf0: [crate::Reg<ch_tx_conf0::CH_TX_CONF0_SPEC>; 4],
    #[doc = "0x30 - Channel %s configure register 0"]
    pub ch0_rx_conf0: crate::Reg<ch_rx_conf0::CH_RX_CONF0_SPEC>,
    #[doc = "0x34 - Channel %s configure register 1"]
    pub ch0_rx_conf1: crate::Reg<ch_rx_conf1::CH_RX_CONF1_SPEC>,
    #[doc = "0x38 - Channel %s configure register 0"]
    pub ch1_rx_conf0: crate::Reg<ch_rx_conf0::CH_RX_CONF0_SPEC>,
    #[doc = "0x3c - Channel %s configure register 1"]
    pub ch1_rx_conf1: crate::Reg<ch_rx_conf1::CH_RX_CONF1_SPEC>,
    ...
    pub ch2_rx_conf1: crate::Reg<ch_rx_conf1::CH_RX_CONF1_SPEC>,
    ...
    pub ch3_rx_conf1: crate::Reg<ch_rx_conf1::CH_RX_CONF1_SPEC>,
    #[doc = "0x50..0x60 - Channel %s status register"]
    pub ch_tx_status: [crate::Reg<ch_tx_status::CH_TX_STATUS_SPEC>; 4],
    #[doc = "0x60..0x70 - Channel %s status register"]
    pub ch_rx_status: [crate::Reg<ch_rx_status::CH_RX_STATUS_SPEC>; 4],
    ...
    pub ch_rx_lim: [crate::Reg<ch_rx_lim::CH_RX_LIM_SPEC>; 4],
...
#[doc = "TX_CHDATA register accessor: an alias for `Reg<TX_CHDATA_SPEC>`"]
...
pub mod tx_chdata;
#[doc = "RX_CHDATA register accessor: an alias for `Reg<RX_CHDATA_SPEC>`"]
...
#[doc = "Channel %s configure register 0"]
pub mod ch_rx_conf0;
#[doc = "CH_RX_CONF1 register accessor: an alias for `Reg<CH_RX_CONF1_SPEC>`"]
pub type CH_RX_CONF1 = crate::Reg<ch_rx_conf1::CH_RX_CONF1_SPEC>;
#[doc = "Channel %s configure register 1"]
pub mod ch_rx_conf1;
#[doc = "CH_TX_STATUS register accessor: an alias for `Reg<CH_TX_STATUS_SPEC>`"]
pub type CH_TX_STATUS = crate::Reg<ch_tx_status::CH_TX_STATUS_SPEC>;
#[doc = "Channel %s status register"]
pub mod ch_tx_status;
#[doc = "CH_RX_STATUS register accessor: an alias for `Reg<CH_RX_STATUS_SPEC>`"]
