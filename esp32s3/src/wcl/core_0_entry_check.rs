...
pub struct CORE_0_ENTRY_CHECK_R(crate::FieldReader<u16, u16>);
impl CORE_0_ENTRY_CHECK_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CORE_0_ENTRY_CHECK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_ENTRY_CHECK_R {
...
pub struct CORE_0_ENTRY_CHECK_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_ENTRY_CHECK_W<'a> {
...
impl W {
    #[doc = "Bits 1:13 - This filed is used to enable entry address check"]
    #[inline(always)]
    pub fn core_0_entry_check(&mut self) -> CORE_0_ENTRY_CHECK_W {
        CORE_0_ENTRY_CHECK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_entry_check]
(index.html) module"]
pub struct CORE_0_ENTRY_CHECK_SPEC;
impl crate::RegisterSpec for CORE_0_ENTRY_CHECK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_entry_check::R]
(R) reader structure"]
impl crate::Readable for CORE_0_ENTRY_CHECK_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_entry_check::W]
(W) writer structure"]
