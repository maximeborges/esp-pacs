...
pub struct CORE_1_FROM_WORLD_1_R(crate::FieldReader<bool, bool>);
...
pub struct CORE_1_FROM_ENTRY_1_R(crate::FieldReader<u8, u8>);
...
pub struct CORE_1_CURRENT_1_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn core_1_from_world_1(&self) -> CORE_1_FROM_WORLD_1_R {
        CORE_1_FROM_WORLD_1_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core_1_current_1(&self) -> CORE_1_CURRENT_1_R {
        CORE_1_CURRENT_1_R::new(((self.bits >> 5) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - This bit is used to confirm world before enter entry 1"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_statustable1]
(index.html) module"]
pub struct CORE_1_STATUSTABLE1_SPEC;
impl crate::RegisterSpec for CORE_1_STATUSTABLE1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_statustable1::R]
(R) reader structure"]
impl crate::Readable for CORE_1_STATUSTABLE1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_statustable1::W]
(W) writer structure"]
