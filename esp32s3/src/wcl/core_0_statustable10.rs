...
pub struct CORE_0_FROM_WORLD_10_R(crate::FieldReader<bool, bool>);
...
pub struct CORE_0_FROM_ENTRY_10_R(crate::FieldReader<u8, u8>);
...
pub struct CORE_0_CURRENT_10_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn core_0_from_world_10(&self) -> CORE_0_FROM_WORLD_10_R {
        CORE_0_FROM_WORLD_10_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core_0_current_10(&self) -> CORE_0_CURRENT_10_R {
        CORE_0_CURRENT_10_R::new(((self.bits >> 5) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - This bit is used to confirm world before enter entry 10"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_statustable10]
(index.html) module"]
pub struct CORE_0_STATUSTABLE10_SPEC;
impl crate::RegisterSpec for CORE_0_STATUSTABLE10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_statustable10::R]
(R) reader structure"]
impl crate::Readable for CORE_0_STATUSTABLE10_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_statustable10::W]
(W) writer structure"]
