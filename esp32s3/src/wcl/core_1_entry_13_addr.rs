...
pub struct CORE_1_ENTRY_13_ADDR_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_entry_13_addr]
(index.html) module"]
pub struct CORE_1_ENTRY_13_ADDR_SPEC;
impl crate::RegisterSpec for CORE_1_ENTRY_13_ADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_entry_13_addr::R]
(R) reader structure"]
impl crate::Readable for CORE_1_ENTRY_13_ADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_entry_13_addr::W]
(W) writer structure"]
