...
pub struct CORE_0_NMI_MASK_PHASE_R(crate::FieldReader<bool, bool>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_nmi_mask_phase]
(index.html) module"]
pub struct CORE_0_NMI_MASK_PHASE_SPEC;
impl crate::RegisterSpec for CORE_0_NMI_MASK_PHASE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_nmi_mask_phase::R]
(R) reader structure"]
