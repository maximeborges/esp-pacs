...
pub struct CORE_1_FROM_WORLD_9_R(crate::FieldReader<bool, bool>);
impl CORE_1_FROM_WORLD_9_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_FROM_WORLD_9_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_FROM_WORLD_9_R {
...
pub struct CORE_1_FROM_WORLD_9_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_FROM_WORLD_9_W<'a> {
...
pub struct CORE_1_FROM_ENTRY_9_R(crate::FieldReader<u8, u8>);
impl CORE_1_FROM_ENTRY_9_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_1_FROM_ENTRY_9_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_FROM_ENTRY_9_R {
...
pub struct CORE_1_FROM_ENTRY_9_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_FROM_ENTRY_9_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
pub struct CORE_1_CURRENT_9_R(crate::FieldReader<bool, bool>);
impl CORE_1_CURRENT_9_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_CURRENT_9_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_CURRENT_9_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_1_CURRENT_9_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_CURRENT_9_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn core_1_from_world_9(&self) -> CORE_1_FROM_WORLD_9_R {
        CORE_1_FROM_WORLD_9_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core_1_current_9(&self) -> CORE_1_CURRENT_9_R {
        CORE_1_CURRENT_9_R::new(((self.bits >> 5) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - This bit is used to confirm world before enter entry 9"]
    #[inline(always)]
    pub fn core_1_from_world_9(&mut self) -> CORE_1_FROM_WORLD_9_W {
        CORE_1_FROM_WORLD_9_W { w: self }
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 9"]
    #[inline(always)]
    pub fn core_1_from_entry_9(&mut self) -> CORE_1_FROM_ENTRY_9_W {
        CORE_1_FROM_ENTRY_9_W { w: self }
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 9"]
    #[inline(always)]
    pub fn core_1_current_9(&mut self) -> CORE_1_CURRENT_9_W {
        CORE_1_CURRENT_9_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_statustable9]
(index.html) module"]
pub struct CORE_1_STATUSTABLE9_SPEC;
impl crate::RegisterSpec for CORE_1_STATUSTABLE9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_statustable9::R]
(R) reader structure"]
impl crate::Readable for CORE_1_STATUSTABLE9_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_statustable9::W]
(W) writer structure"]
