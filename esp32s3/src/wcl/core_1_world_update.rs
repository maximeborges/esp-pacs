...
pub struct CORE_1_UPDATE_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_UPDATE_W<'a> {
...
impl W {
    ...
    #[inline(always)]
    pub fn core_1_update(&mut self) -> CORE_1_UPDATE_W {
        CORE_1_UPDATE_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_world_update]
(index.html) module"]
pub struct CORE_1_WORLD_UPDATE_SPEC;
impl crate::RegisterSpec for CORE_1_WORLD_UPDATE_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [core_1_world_update::W]
(W) writer structure"]
