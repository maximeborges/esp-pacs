...
pub struct CORE_0_NMI_MASK_DISABLE_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_NMI_MASK_DISABLE_W<'a> {
...
impl W {
    ...
    #[inline(always)]
    pub fn core_0_nmi_mask_disable(&mut self) -> CORE_0_NMI_MASK_DISABLE_W {
        CORE_0_NMI_MASK_DISABLE_W { w: self }
    }
