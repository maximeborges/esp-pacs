...
pub struct CORE_0_FROM_WORLD_2_R(crate::FieldReader<bool, bool>);
impl CORE_0_FROM_WORLD_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_FROM_WORLD_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_FROM_WORLD_2_R {
...
pub struct CORE_0_FROM_WORLD_2_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_FROM_WORLD_2_W<'a> {
...
pub struct CORE_0_FROM_ENTRY_2_R(crate::FieldReader<u8, u8>);
impl CORE_0_FROM_ENTRY_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_FROM_ENTRY_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_FROM_ENTRY_2_R {
...
pub struct CORE_0_FROM_ENTRY_2_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_FROM_ENTRY_2_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
pub struct CORE_0_CURRENT_2_R(crate::FieldReader<bool, bool>);
impl CORE_0_CURRENT_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_CURRENT_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_CURRENT_2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_0_CURRENT_2_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_CURRENT_2_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn core_0_from_world_2(&self) -> CORE_0_FROM_WORLD_2_R {
        CORE_0_FROM_WORLD_2_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core_0_current_2(&self) -> CORE_0_CURRENT_2_R {
        CORE_0_CURRENT_2_R::new(((self.bits >> 5) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - This bit is used to confirm world before enter entry 2"]
    #[inline(always)]
    pub fn core_0_from_world_2(&mut self) -> CORE_0_FROM_WORLD_2_W {
        CORE_0_FROM_WORLD_2_W { w: self }
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 2"]
    #[inline(always)]
    pub fn core_0_from_entry_2(&mut self) -> CORE_0_FROM_ENTRY_2_W {
        CORE_0_FROM_ENTRY_2_W { w: self }
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 2"]
    #[inline(always)]
    pub fn core_0_current_2(&mut self) -> CORE_0_CURRENT_2_W {
        CORE_0_CURRENT_2_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_statustable2]
(index.html) module"]
pub struct CORE_0_STATUSTABLE2_SPEC;
impl crate::RegisterSpec for CORE_0_STATUSTABLE2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_statustable2::R]
(R) reader structure"]
impl crate::Readable for CORE_0_STATUSTABLE2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_statustable2::W]
(W) writer structure"]
