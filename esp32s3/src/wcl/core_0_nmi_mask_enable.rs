...
pub struct CORE_0_NMI_MASK_ENABLE_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_NMI_MASK_ENABLE_W<'a> {
...
impl W {
    ...
    #[inline(always)]
    pub fn core_0_nmi_mask_enable(&mut self) -> CORE_0_NMI_MASK_ENABLE_W {
        CORE_0_NMI_MASK_ENABLE_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_nmi_mask_enable]
(index.html) module"]
pub struct CORE_0_NMI_MASK_ENABLE_SPEC;
impl crate::RegisterSpec for CORE_0_NMI_MASK_ENABLE_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [core_0_nmi_mask_enable::W]
(W) writer structure"]
