...
pub struct CORE_0_WORLD_IRAM0_R(crate::FieldReader<u8, u8>);
...
impl R {
    ...
    pub fn core_0_world_iram0(&self) -> CORE_0_WORLD_IRAM0_R {
        CORE_0_WORLD_IRAM0_R::new((self.bits & 0x03) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - this field is used to read current world of Iram0 bus"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_world_iram0]
(index.html) module"]
pub struct CORE_0_WORLD_IRAM0_SPEC;
impl crate::RegisterSpec for CORE_0_WORLD_IRAM0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_world_iram0::R]
(R) reader structure"]
impl crate::Readable for CORE_0_WORLD_IRAM0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_world_iram0::W]
(W) writer structure"]
