...
pub type CORE_0_FROM_WORLD_6_W<'a> = crate::BitWriter<'a, u32, CORE_0_STATUSTABLE6_SPEC, bool, 0>;
...
pub type CORE_0_FROM_ENTRY_6_W<'a> =
    crate::FieldWriter<'a, u32, CORE_0_STATUSTABLE6_SPEC, u8, u8, 4, 1>;
...
pub type CORE_0_CURRENT_6_W<'a> = crate::BitWriter<'a, u32, CORE_0_STATUSTABLE6_SPEC, bool, 5>;
impl R {
