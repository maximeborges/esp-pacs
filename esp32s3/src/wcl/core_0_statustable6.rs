...
pub struct CORE_0_FROM_WORLD_6_R(crate::FieldReader<bool, bool>);
...
pub struct CORE_0_FROM_ENTRY_6_R(crate::FieldReader<u8, u8>);
...
pub struct CORE_0_CURRENT_6_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn core_0_from_world_6(&self) -> CORE_0_FROM_WORLD_6_R {
        CORE_0_FROM_WORLD_6_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core_0_current_6(&self) -> CORE_0_CURRENT_6_R {
        CORE_0_CURRENT_6_R::new(((self.bits >> 5) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - This bit is used to confirm world before enter entry 6"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_statustable6]
(index.html) module"]
pub struct CORE_0_STATUSTABLE6_SPEC;
impl crate::RegisterSpec for CORE_0_STATUSTABLE6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_0_statustable6::R]
(R) reader structure"]
impl crate::Readable for CORE_0_STATUSTABLE6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_0_statustable6::W]
(W) writer structure"]
