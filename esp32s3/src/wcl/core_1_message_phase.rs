...
pub struct CORE_1_MESSAGE_MATCH_R(crate::FieldReader<bool, bool>);
impl CORE_1_MESSAGE_MATCH_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_MESSAGE_MATCH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_MESSAGE_MATCH_R {
...
pub struct CORE_1_MESSAGE_EXPECT_R(crate::FieldReader<u8, u8>);
impl CORE_1_MESSAGE_EXPECT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_1_MESSAGE_EXPECT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_MESSAGE_EXPECT_R {
...
pub struct CORE_1_MESSAGE_DATAPHASE_R(crate::FieldReader<bool, bool>);
impl CORE_1_MESSAGE_DATAPHASE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_MESSAGE_DATAPHASE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_MESSAGE_DATAPHASE_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_1_MESSAGE_ADDRESSPHASE_R(crate::FieldReader<bool, bool>);
impl CORE_1_MESSAGE_ADDRESSPHASE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_MESSAGE_ADDRESSPHASE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_MESSAGE_ADDRESSPHASE_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_message_phase]
(index.html) module"]
pub struct CORE_1_MESSAGE_PHASE_SPEC;
impl crate::RegisterSpec for CORE_1_MESSAGE_PHASE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_message_phase::R]
(R) reader structure"]
