...
pub struct CORE_1_NMI_MASK_R(crate::FieldReader<bool, bool>);
impl CORE_1_NMI_MASK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_1_NMI_MASK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_1_NMI_MASK_R {
...
pub struct CORE_1_NMI_MASK_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_1_NMI_MASK_W<'a> {
...
impl R {
    ...
    pub fn core_1_nmi_mask(&self) -> CORE_1_NMI_MASK_R {
        CORE_1_NMI_MASK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - this bit is used to mask NMI interrupt,it can directly mask NMI interrupt"]
    #[inline(always)]
    pub fn core_1_nmi_mask(&mut self) -> CORE_1_NMI_MASK_W {
        CORE_1_NMI_MASK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_nmi_mask]
(index.html) module"]
pub struct CORE_1_NMI_MASK_SPEC;
impl crate::RegisterSpec for CORE_1_NMI_MASK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [core_1_nmi_mask::R]
(R) reader structure"]
impl crate::Readable for CORE_1_NMI_MASK_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [core_1_nmi_mask::W]
(W) writer structure"]
