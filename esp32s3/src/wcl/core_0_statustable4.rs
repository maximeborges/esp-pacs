...
impl CORE_0_FROM_WORLD_4_R {
    ...
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_FROM_WORLD_4_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_0_FROM_WORLD_4_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_FROM_WORLD_4_W<'a> {
...
impl CORE_0_FROM_ENTRY_4_R {
    ...
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_FROM_ENTRY_4_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_0_FROM_ENTRY_4_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_FROM_ENTRY_4_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl CORE_0_CURRENT_4_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_CURRENT_4_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_0_CURRENT_4_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_CURRENT_4_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn core_0_from_world_4(&self) -> CORE_0_FROM_WORLD_4_R {
        CORE_0_FROM_WORLD_4_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core_0_current_4(&self) -> CORE_0_CURRENT_4_R {
        CORE_0_CURRENT_4_R::new(((self.bits >> 5) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - This bit is used to confirm world before enter entry 4"]
    #[inline(always)]
    pub fn core_0_from_world_4(&mut self) -> CORE_0_FROM_WORLD_4_W {
        CORE_0_FROM_WORLD_4_W { w: self }
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 4"]
    #[inline(always)]
    pub fn core_0_from_entry_4(&mut self) -> CORE_0_FROM_ENTRY_4_W {
        CORE_0_FROM_ENTRY_4_W { w: self }
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 4"]
    #[inline(always)]
    pub fn core_0_current_4(&mut self) -> CORE_0_CURRENT_4_W {
        CORE_0_CURRENT_4_W { w: self }
    }
