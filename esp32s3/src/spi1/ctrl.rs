...
pub struct FDOUT_OCT_R(crate::FieldReader<bool>);
impl FDOUT_OCT_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct FDIN_OCT_R(crate::FieldReader<bool>);
impl FDIN_OCT_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct FCS_CRC_EN_R(crate::FieldReader<bool>);
impl FCS_CRC_EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct TX_CRC_EN_R(crate::FieldReader<bool>);
impl TX_CRC_EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct RESANDRES_R(crate::FieldReader<bool>);
impl RESANDRES_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct WRSR_2B_R(crate::FieldReader<bool>);
impl WRSR_2B_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
