...
pub struct I2S_TX_CLKM_DIV_NUM_R(crate::FieldReader<u8>);
...
pub struct I2S_TX_CLK_ACTIVE_R(crate::FieldReader<bool>);
...
pub struct I2S_TX_CLK_SEL_R(crate::FieldReader<u8>);
...
pub struct I2S_CLK_EN_R(crate::FieldReader<bool>);
impl I2S_CLK_EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
