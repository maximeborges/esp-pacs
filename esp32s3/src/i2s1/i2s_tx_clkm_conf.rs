...
pub type I2S_TX_CLKM_DIV_NUM_W<'a> =
    crate::FieldWriter<'a, u32, I2S_TX_CLKM_CONF_SPEC, u8, u8, 8, 0>;
...
pub type I2S_TX_CLK_ACTIVE_W<'a> = crate::BitWriter<'a, u32, I2S_TX_CLKM_CONF_SPEC, bool, 26>;
...
pub type I2S_TX_CLK_SEL_W<'a> = crate::FieldWriter<'a, u32, I2S_TX_CLKM_CONF_SPEC, u8, u8, 2, 27>;
...
pub type I2S_CLK_EN_W<'a> = crate::BitWriter<'a, u32, I2S_TX_CLKM_CONF_SPEC, bool, 29>;
impl R {
