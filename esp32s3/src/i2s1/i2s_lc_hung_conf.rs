...
pub struct I2S_LC_FIFO_TIMEOUT_R(crate::FieldReader<u8, u8>);
...
pub struct I2S_LC_FIFO_TIMEOUT_SHIFT_R(crate::FieldReader<u8, u8>);
...
pub struct I2S_LC_FIFO_TIMEOUT_ENA_R(crate::FieldReader<bool, bool>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2s_lc_hung_conf]
(index.html) module"]
pub struct I2S_LC_HUNG_CONF_SPEC;
impl crate::RegisterSpec for I2S_LC_HUNG_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2s_lc_hung_conf::R]
(R) reader structure"]
impl crate::Readable for I2S_LC_HUNG_CONF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2s_lc_hung_conf::W]
(W) writer structure"]
