...
pub struct I2S_SINGLE_DATA_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2s_conf_sigle_data]
(index.html) module"]
pub struct I2S_CONF_SIGLE_DATA_SPEC;
impl crate::RegisterSpec for I2S_CONF_SIGLE_DATA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2s_conf_sigle_data::R]
(R) reader structure"]
impl crate::Readable for I2S_CONF_SIGLE_DATA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2s_conf_sigle_data::W]
(W) writer structure"]
