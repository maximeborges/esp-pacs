...
pub struct I2S_DATE_R(crate::FieldReader<u32, u32>);
impl I2S_DATE_R {
    #[inline(always)]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2s_date]
(index.html) module"]
pub struct I2S_DATE_SPEC;
impl crate::RegisterSpec for I2S_DATE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2s_date::R]
(R) reader structure"]
impl crate::Readable for I2S_DATE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2s_date::W]
(W) writer structure"]
