...
pub struct I2S_TX_SD_OUT_DM_R(crate::FieldReader<u8, u8>);
impl I2S_TX_SD_OUT_DM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        I2S_TX_SD_OUT_DM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S_TX_SD_OUT_DM_R {
...
pub struct I2S_TX_SD1_OUT_DM_R(crate::FieldReader<u8, u8>);
impl I2S_TX_SD1_OUT_DM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        I2S_TX_SD1_OUT_DM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S_TX_SD1_OUT_DM_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct I2S_TX_WS_OUT_DM_R(crate::FieldReader<u8, u8>);
impl I2S_TX_WS_OUT_DM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        I2S_TX_WS_OUT_DM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S_TX_WS_OUT_DM_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct I2S_TX_BCK_OUT_DM_R(crate::FieldReader<u8, u8>);
impl I2S_TX_BCK_OUT_DM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        I2S_TX_BCK_OUT_DM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S_TX_BCK_OUT_DM_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct I2S_TX_WS_IN_DM_R(crate::FieldReader<u8, u8>);
impl I2S_TX_WS_IN_DM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        I2S_TX_WS_IN_DM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S_TX_WS_IN_DM_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct I2S_TX_BCK_IN_DM_R(crate::FieldReader<u8, u8>);
impl I2S_TX_BCK_IN_DM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        I2S_TX_BCK_IN_DM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S_TX_BCK_IN_DM_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2s_tx_timing]
(index.html) module"]
pub struct I2S_TX_TIMING_SPEC;
impl crate::RegisterSpec for I2S_TX_TIMING_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2s_tx_timing::R]
(R) reader structure"]
impl crate::Readable for I2S_TX_TIMING_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2s_tx_timing::W]
(W) writer structure"]
