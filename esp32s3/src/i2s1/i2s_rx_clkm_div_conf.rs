...
pub struct I2S_RX_CLKM_DIV_Z_R(crate::FieldReader<u16, u16>);
impl I2S_RX_CLKM_DIV_Z_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        I2S_RX_CLKM_DIV_Z_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S_RX_CLKM_DIV_Z_R {
...
pub struct I2S_RX_CLKM_DIV_Y_R(crate::FieldReader<u16, u16>);
impl I2S_RX_CLKM_DIV_Y_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        I2S_RX_CLKM_DIV_Y_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S_RX_CLKM_DIV_Y_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct I2S_RX_CLKM_DIV_X_R(crate::FieldReader<u16, u16>);
impl I2S_RX_CLKM_DIV_X_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        I2S_RX_CLKM_DIV_X_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S_RX_CLKM_DIV_X_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct I2S_RX_CLKM_DIV_YN1_R(crate::FieldReader<bool, bool>);
impl I2S_RX_CLKM_DIV_YN1_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        I2S_RX_CLKM_DIV_YN1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S_RX_CLKM_DIV_YN1_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2s_rx_clkm_div_conf]
(index.html) module"]
pub struct I2S_RX_CLKM_DIV_CONF_SPEC;
impl crate::RegisterSpec for I2S_RX_CLKM_DIV_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2s_rx_clkm_div_conf::R]
(R) reader structure"]
impl crate::Readable for I2S_RX_CLKM_DIV_CONF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2s_rx_clkm_div_conf::W]
(W) writer structure"]
