...
pub struct CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_6_W<'a> {
    w: &'a mut W,
}
impl<'a> CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_6_W<'a> {
...
impl W {
    ...
    pub fn cancel_efuse_disable_jtag_temporary_6(
        &mut self,
    ) -> CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_6_W {
        CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_6_W { w: self }
    }
