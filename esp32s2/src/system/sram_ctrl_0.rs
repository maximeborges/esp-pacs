...
pub struct SRAM_FO_R(crate::FieldReader<u32, u32>);
impl SRAM_FO_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SRAM_FO_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SRAM_FO_R {
...
impl W {
    #[doc = "Bits 0:21 - This field is used to force on clock gate of internal SRAM."]
    #[inline(always)]
    pub fn sram_fo(&mut self) -> SRAM_FO_W {
        SRAM_FO_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sram_ctrl_0]
(index.html) module"]
pub struct SRAM_CTRL_0_SPEC;
impl crate::RegisterSpec for SRAM_CTRL_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sram_ctrl_0::R]
(R) reader structure"]
impl crate::Readable for SRAM_CTRL_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sram_ctrl_0::W]
(W) writer structure"]
