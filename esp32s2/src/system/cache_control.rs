...
pub struct PRO_ICACHE_CLK_ON_R(crate::FieldReader<bool>);
...
pub struct PRO_DCACHE_CLK_ON_R(crate::FieldReader<bool>);
...
pub struct PRO_CACHE_RESET_R(crate::FieldReader<bool>);
