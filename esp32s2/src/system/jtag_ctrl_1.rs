...
pub struct CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_1_W<'a> {
    w: &'a mut W,
}
impl<'a> CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_1_W<'a> {
...
impl W {
    ...
    pub fn cancel_efuse_disable_jtag_temporary_1(
        &mut self,
    ) -> CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_1_W {
        CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_1_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [jtag_ctrl_1]
(index.html) module"]
pub struct JTAG_CTRL_1_SPEC;
impl crate::RegisterSpec for JTAG_CTRL_1_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [jtag_ctrl_1::W]
(W) writer structure"]
