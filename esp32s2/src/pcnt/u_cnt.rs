...
pub struct PULSE_CNT_U0_R(crate::FieldReader<u16, u16>);
impl PULSE_CNT_U0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        PULSE_CNT_U0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PULSE_CNT_U0_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [u_cnt]
(index.html) module"]
pub struct U_CNT_SPEC;
impl crate::RegisterSpec for U_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [u_cnt::R]
(R) reader structure"]
