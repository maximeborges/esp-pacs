...
pub struct TIMERS_DATE_R(crate::FieldReader<u32, u32>);
impl TIMERS_DATE_R {
    #[inline(always)]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timers_date]
(index.html) module"]
pub struct TIMERS_DATE_SPEC;
impl crate::RegisterSpec for TIMERS_DATE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timers_date::R]
(R) reader structure"]
impl crate::Readable for TIMERS_DATE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timers_date::W]
(W) writer structure"]
