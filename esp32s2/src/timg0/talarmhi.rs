...
#[doc = "Field `T0_ALARM_HI` reader - Timer %s alarm trigger time-base counter value, high 32 bits."]
pub type T0_ALARM_HI_R = crate::FieldReader<u32, u32>;
#[doc = "Field `T0_ALARM_HI` writer - Timer %s alarm trigger time-base counter value, high 32 bits."]
pub type T0_ALARM_HI_W<'a> = crate::FieldWriter<'a, u32, TALARMHI_SPEC, u32, u32, 32, 0>;
impl R {
    #[doc = "Bits 0:31 - Timer %s alarm trigger time-base counter value, high 32 bits."]
    #[inline(always)]
    pub fn t0_alarm_hi(&self) -> T0_ALARM_HI_R {
        T0_ALARM_HI_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Timer %s alarm trigger time-base counter value, high 32 bits."]
