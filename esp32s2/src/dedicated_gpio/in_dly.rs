...
pub struct CH0_R(crate::FieldReader<u8, u8>);
impl CH0_R {
    #[inline(always)]
...
pub struct CH1_R(crate::FieldReader<u8, u8>);
impl CH1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct CH2_R(crate::FieldReader<u8, u8>);
impl CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct CH3_R(crate::FieldReader<u8, u8>);
impl CH3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct CH4_R(crate::FieldReader<u8, u8>);
impl CH4_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct CH5_R(crate::FieldReader<u8, u8>);
impl CH5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct CH6_R(crate::FieldReader<u8, u8>);
impl CH6_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct CH7_R(crate::FieldReader<u8, u8>);
impl CH7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [in_dly]
(index.html) module"]
pub struct IN_DLY_SPEC;
impl crate::RegisterSpec for IN_DLY_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [in_dly::R]
(R) reader structure"]
impl crate::Readable for IN_DLY_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [in_dly::W]
(W) writer structure"]
