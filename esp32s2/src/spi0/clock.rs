...
pub type CLKCNT_L_W<'a> = crate::FieldWriter<'a, u32, CLOCK_SPEC, u8, u8, 6, 0>;
...
pub type CLKCNT_H_W<'a> = crate::FieldWriter<'a, u32, CLOCK_SPEC, u8, u8, 6, 6>;
...
pub type CLKCNT_N_W<'a> = crate::FieldWriter<'a, u32, CLOCK_SPEC, u8, u8, 6, 12>;
...
pub type CLKDIV_PRE_W<'a> = crate::FieldWriter<'a, u32, CLOCK_SPEC, u16, u16, 13, 18>;
