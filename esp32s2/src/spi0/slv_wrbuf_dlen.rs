...
pub type SLV_WR_BUF_DONE_W<'a> = crate::BitWriter<'a, u32, SLV_WRBUF_DLEN_SPEC, bool, 24>;
...
pub type CONF_BASE_BITLEN_W<'a> = crate::FieldWriter<'a, u32, SLV_WRBUF_DLEN_SPEC, u8, u8, 7, 25>;
impl R {
