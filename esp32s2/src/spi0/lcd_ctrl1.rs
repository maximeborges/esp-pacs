...
pub struct LCD_VB_FRONT_R(crate::FieldReader<u8, u8>);
impl LCD_VB_FRONT_R {
    #[inline(always)]
...
pub struct LCD_HA_WIDTH_R(crate::FieldReader<u16, u16>);
impl LCD_HA_WIDTH_R {
    #[inline(always)]
...
pub struct LCD_HT_WIDTH_R(crate::FieldReader<u16, u16>);
impl LCD_HT_WIDTH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lcd_ctrl1]
(index.html) module"]
pub struct LCD_CTRL1_SPEC;
impl crate::RegisterSpec for LCD_CTRL1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lcd_ctrl1::R]
(R) reader structure"]
impl crate::Readable for LCD_CTRL1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lcd_ctrl1::W]
(W) writer structure"]
