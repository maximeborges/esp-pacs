...
pub type INT_RD_BUF_DONE_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 5>;
...
pub type INT_WR_BUF_DONE_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 6>;
...
pub type INT_RD_DMA_DONE_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 7>;
...
pub type INT_WR_DMA_DONE_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 8>;
...
pub type INT_TRANS_DONE_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 9>;
...
pub type INT_DMA_SEG_TRANS_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 10>;
...
pub type SEG_MAGIC_ERR_INT_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 11>;
...
pub type TRANS_DONE_AUTO_CLR_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 29>;
...
pub type SOFT_RESET_W<'a> = crate::BitWriter<'a, u32, SLAVE_SPEC, bool, 31>;
impl R {
