...
pub type SLV_DATA_BYTELEN_W<'a> = crate::FieldWriter<'a, u32, SLV_RD_BYTE_SPEC, u32, u32, 20, 0>;
...
pub type SLV_RDDMA_BYTELEN_EN_W<'a> = crate::BitWriter<'a, u32, SLV_RD_BYTE_SPEC, bool, 20>;
...
pub type SLV_WRDMA_BYTELEN_EN_W<'a> = crate::BitWriter<'a, u32, SLV_RD_BYTE_SPEC, bool, 21>;
...
pub type SLV_RDBUF_BYTELEN_EN_W<'a> = crate::BitWriter<'a, u32, SLV_RD_BYTE_SPEC, bool, 22>;
...
pub type SLV_WRBUF_BYTELEN_EN_W<'a> = crate::BitWriter<'a, u32, SLV_RD_BYTE_SPEC, bool, 23>;
...
pub type DMA_SEG_MAGIC_VALUE_W<'a> = crate::FieldWriter<'a, u32, SLV_RD_BYTE_SPEC, u8, u8, 4, 24>;
...
pub type SLV_RD_DMA_DONE_W<'a> = crate::BitWriter<'a, u32, SLV_RD_BYTE_SPEC, bool, 30>;
...
pub type USR_CONF_W<'a> = crate::BitWriter<'a, u32, SLV_RD_BYTE_SPEC, bool, 31>;
impl R {
