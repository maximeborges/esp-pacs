...
pub struct INFIFO_FULL_ERR_INT_ENA_R(crate::FieldReader<bool, bool>);
impl INFIFO_FULL_ERR_INT_ENA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        INFIFO_FULL_ERR_INT_ENA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INFIFO_FULL_ERR_INT_ENA_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct INFIFO_FULL_ERR_INT_ENA_W<'a> {
    w: &'a mut W,
}
impl<'a> INFIFO_FULL_ERR_INT_ENA_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct OUTFIFO_EMPTY_ERR_INT_ENA_R(crate::FieldReader<bool, bool>);
impl OUTFIFO_EMPTY_ERR_INT_ENA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUTFIFO_EMPTY_ERR_INT_ENA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUTFIFO_EMPTY_ERR_INT_ENA_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct OUTFIFO_EMPTY_ERR_INT_ENA_W<'a> {
    w: &'a mut W,
}
impl<'a> OUTFIFO_EMPTY_ERR_INT_ENA_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct SLV_CMD6_INT_ENA_R(crate::FieldReader<bool, bool>);
impl SLV_CMD6_INT_ENA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        SLV_CMD6_INT_ENA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLV_CMD6_INT_ENA_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SLV_CMD6_INT_ENA_W<'a> {
    w: &'a mut W,
}
impl<'a> SLV_CMD6_INT_ENA_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn infifo_full_err_int_ena(&self) -> INFIFO_FULL_ERR_INT_ENA_R {
        INFIFO_FULL_ERR_INT_ENA_R::new(((self.bits >> 9) & 0x01) != 0)
    }
