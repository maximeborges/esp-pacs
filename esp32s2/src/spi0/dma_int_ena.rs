...
pub type INLINK_DSCR_EMPTY_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 0>;
...
pub type OUTLINK_DSCR_ERROR_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 1>;
...
pub type INLINK_DSCR_ERROR_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 2>;
...
pub type IN_DONE_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 3>;
...
pub type IN_ERR_EOF_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 4>;
...
pub type IN_SUC_EOF_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 5>;
...
pub type OUT_DONE_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 6>;
...
pub type OUT_EOF_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 7>;
...
pub type OUT_TOTAL_EOF_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 8>;
...
pub type INFIFO_FULL_ERR_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 9>;
...
pub type OUTFIFO_EMPTY_ERR_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 10>;
...
pub type SLV_CMD6_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 11>;
...
pub type SLV_CMD7_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 12>;
...
pub type SLV_CMD8_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 13>;
...
pub type SLV_CMD9_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 14>;
...
pub type SLV_CMDA_INT_ENA_W<'a> = crate::BitWriter<'a, u32, DMA_INT_ENA_SPEC, bool, 15>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 9 - The enable bit for infifo full error interrupt."]
    #[inline(always)]
    pub fn infifo_full_err_int_ena(&mut self) -> INFIFO_FULL_ERR_INT_ENA_W {
        INFIFO_FULL_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 10 - The enable bit for outfifo empty error interrupt."]
    #[inline(always)]
    pub fn outfifo_empty_err_int_ena(&mut self) -> OUTFIFO_EMPTY_ERR_INT_ENA_W {
        OUTFIFO_EMPTY_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 11 - The enable bit for SPI slave CMD6 interrupt."]
    #[inline(always)]
    pub fn slv_cmd6_int_ena(&mut self) -> SLV_CMD6_INT_ENA_W {
