...
pub type DOUTDIN_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 0>;
...
pub type QPI_MODE_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 3>;
...
pub type OPI_MODE_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 4>;
...
pub type TSCK_I_EDGE_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 5>;
...
pub type CS_HOLD_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 6>;
...
pub type CS_SETUP_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 7>;
...
pub type RSCK_I_EDGE_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 8>;
...
pub type RD_BYTE_ORDER_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 10>;
...
pub type WR_BYTE_ORDER_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 11>;
...
pub type FWRITE_OCT_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 14>;
...
pub type USR_CONF_NXT_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 15>;
...
pub type SIO_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 16>;
...
pub type USR_HOLD_POL_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 17>;
...
pub type USR_DOUT_HOLD_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 18>;
...
pub type USR_DIN_HOLD_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 19>;
...
pub type USR_DUMMY_HOLD_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 20>;
...
pub type USR_ADDR_HOLD_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 21>;
...
pub type USR_CMD_HOLD_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 22>;
...
pub type USR_PREP_HOLD_W<'a> = crate::BitWriter<'a, u32, USER_SPEC, bool, 23>;
...
impl W {
    ...
    #[doc = "Bit 4 - Just for master mode. 1: spi controller is in OPI mode (all in 8-bit mode). 0: others. Can be configured in CONF state."]
    #[inline(always)]
    pub fn opi_mode(&mut self) -> OPI_MODE_W {
        OPI_MODE_W::new(self)
    }
    #[doc = "Bit 5 - In the slave mode, this bit can be used to change the polarity of tsck. 0: tsck = spi_ck_i. 1:tsck = !spi_ck_i."]
    #[inline(always)]
    ...
    #[doc = "Bit 14 - In the write operations read-data phase is in 8-bit mode. Can be configured in CONF state."]
    #[inline(always)]
    pub fn fwrite_oct(&mut self) -> FWRITE_OCT_W {
