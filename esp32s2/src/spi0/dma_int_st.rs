...
pub struct INFIFO_FULL_ERR_INT_ST_R(crate::FieldReader<bool>);
...
pub struct OUTFIFO_EMPTY_ERR_INT_ST_R(crate::FieldReader<bool>);
...
pub struct SLV_CMD6_INT_ST_R(crate::FieldReader<bool>);
