...
pub type SLV_ADDR_ERR_CLR_W<'a> = crate::BitWriter<'a, u32, SLAVE1_SPEC, bool, 10>;
...
pub type SLV_CMD_ERR_CLR_W<'a> = crate::BitWriter<'a, u32, SLAVE1_SPEC, bool, 11>;
...
pub type SLV_NO_QPI_EN_W<'a> = crate::BitWriter<'a, u32, SLAVE1_SPEC, bool, 12>;
...
pub type SLV_WR_DMA_DONE_W<'a> = crate::BitWriter<'a, u32, SLAVE1_SPEC, bool, 15>;
...
pub type SLV_LAST_COMMAND_W<'a> = crate::FieldWriter<'a, u32, SLAVE1_SPEC, u8, u8, 8, 16>;
...
pub type SLV_LAST_ADDR_W<'a> = crate::FieldWriter<'a, u32, SLAVE1_SPEC, u8, u8, 8, 24>;
impl R {
