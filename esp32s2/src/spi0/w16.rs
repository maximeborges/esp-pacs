...
pub struct BUF16_R(crate::FieldReader<u32, u32>);
impl BUF16_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BUF16_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BUF16_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [w16]
(index.html) module"]
pub struct W16_SPEC;
impl crate::RegisterSpec for W16_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [w16::R]
(R) reader structure"]
impl crate::Readable for W16_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [w16::W]
(W) writer structure"]
