...
pub struct INLINK_DSCR_EMPTY_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct OUTLINK_DSCR_ERROR_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct INLINK_DSCR_ERROR_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct IN_DONE_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct IN_ERR_EOF_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct IN_SUC_EOF_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct OUT_DONE_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct OUT_EOF_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct OUT_TOTAL_EOF_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct INFIFO_FULL_ERR_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct OUTFIFO_EMPTY_ERR_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct SLV_CMD6_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct SLV_CMD7_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct SLV_CMD8_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct SLV_CMD9_INT_CLR_R(crate::FieldReader<bool>);
...
pub struct SLV_CMDA_INT_CLR_R(crate::FieldReader<bool>);
