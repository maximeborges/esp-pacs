...
pub type COCPU_TOUCH_DONE_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, SAR_COCPU_INT_CLR_SPEC, bool, 0>;
#[doc = "Field `COCPU_TOUCH_INACTIVE_INT_CLR` writer - TOUCH_INACTIVE_INT interrupt clear bit"]
pub type COCPU_TOUCH_INACTIVE_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, SAR_COCPU_INT_CLR_SPEC, bool, 1>;
#[doc = "Field `COCPU_TOUCH_ACTIVE_INT_CLR` writer - TOUCH_ACTIVE_INT interrupt clear bit"]
pub type COCPU_TOUCH_ACTIVE_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, SAR_COCPU_INT_CLR_SPEC, bool, 2>;
#[doc = "Field `COCPU_SARADC1_INT_CLR` writer - SARADC1_DONE_INT interrupt clear bit"]
pub type COCPU_SARADC1_INT_CLR_W<'a> = crate::BitWriter<'a, u32, SAR_COCPU_INT_CLR_SPEC, bool, 3>;
#[doc = "Field `COCPU_SARADC2_INT_CLR` writer - SARADC2_DONE_INT interrupt clear bit"]
pub type COCPU_SARADC2_INT_CLR_W<'a> = crate::BitWriter<'a, u32, SAR_COCPU_INT_CLR_SPEC, bool, 4>;
#[doc = "Field `COCPU_TSENS_INT_CLR` writer - TSENS_DONE_INT interrupt clear bit"]
pub type COCPU_TSENS_INT_CLR_W<'a> = crate::BitWriter<'a, u32, SAR_COCPU_INT_CLR_SPEC, bool, 5>;
#[doc = "Field `COCPU_START_INT_CLR` writer - RISCV_START_INT interrupt clear bit"]
pub type COCPU_START_INT_CLR_W<'a> = crate::BitWriter<'a, u32, SAR_COCPU_INT_CLR_SPEC, bool, 6>;
#[doc = "Field `COCPU_SW_INT_CLR` writer - SW_INT interrupt clear bit"]
pub type COCPU_SW_INT_CLR_W<'a> = crate::BitWriter<'a, u32, SAR_COCPU_INT_CLR_SPEC, bool, 7>;
#[doc = "Field `COCPU_SWD_INT_CLR` writer - SWD_INT interrupt clear bit"]
pub type COCPU_SWD_INT_CLR_W<'a> = crate::BitWriter<'a, u32, SAR_COCPU_INT_CLR_SPEC, bool, 8>;
impl W {
