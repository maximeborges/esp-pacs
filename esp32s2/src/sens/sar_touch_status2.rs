...
pub struct TOUCH_PAD2_DATA_R(crate::FieldReader<u32, u32>);
impl TOUCH_PAD2_DATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TOUCH_PAD2_DATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TOUCH_PAD2_DATA_R {
...
pub struct TOUCH_PAD2_DEBOUNCE_R(crate::FieldReader<u8, u8>);
impl TOUCH_PAD2_DEBOUNCE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        TOUCH_PAD2_DEBOUNCE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TOUCH_PAD2_DEBOUNCE_R {
...
impl R {
    ...
    pub fn touch_pad2_debounce(&self) -> TOUCH_PAD2_DEBOUNCE_R {
        TOUCH_PAD2_DEBOUNCE_R::new(((self.bits >> 29) & 0x07) as u8)
    }
}
#[doc = "Touch pad 2 status\n\nThis register you can [`read`]
(crate::generic::Reg::read). See [API]
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sar_touch_status2]
(index.html) module"]
pub struct SAR_TOUCH_STATUS2_SPEC;
impl crate::RegisterSpec for SAR_TOUCH_STATUS2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sar_touch_status2::R]
(R) reader structure"]
