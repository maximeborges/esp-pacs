...
pub struct TOUCH_OUT_TH8_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sar_touch_thres8]
(index.html) module"]
pub struct SAR_TOUCH_THRES8_SPEC;
impl crate::RegisterSpec for SAR_TOUCH_THRES8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sar_touch_thres8::R]
(R) reader structure"]
impl crate::Readable for SAR_TOUCH_THRES8_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sar_touch_thres8::W]
(W) writer structure"]
