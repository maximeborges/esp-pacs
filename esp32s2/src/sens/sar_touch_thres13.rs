...
pub struct TOUCH_OUT_TH13_R(crate::FieldReader<u32, u32>);
impl TOUCH_OUT_TH13_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TOUCH_OUT_TH13_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TOUCH_OUT_TH13_R {
...
pub struct TOUCH_OUT_TH13_W<'a> {
    w: &'a mut W,
}
impl<'a> TOUCH_OUT_TH13_W<'a> {
...
impl W {
    #[doc = "Bits 0:21 - Finger threshold for touch pad 13"]
    #[inline(always)]
    pub fn touch_out_th13(&mut self) -> TOUCH_OUT_TH13_W {
        TOUCH_OUT_TH13_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sar_touch_thres13]
(index.html) module"]
pub struct SAR_TOUCH_THRES13_SPEC;
impl crate::RegisterSpec for SAR_TOUCH_THRES13_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sar_touch_thres13::R]
(R) reader structure"]
impl crate::Readable for SAR_TOUCH_THRES13_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sar_touch_thres13::W]
(W) writer structure"]
