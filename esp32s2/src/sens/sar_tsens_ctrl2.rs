...
pub type TSENS_XPD_WAIT_W<'a> = crate::FieldWriter<'a, u32, SAR_TSENS_CTRL2_SPEC, u16, u16, 12, 0>;
#[doc = "Field `TSENS_XPD_FORCE` reader - "]
pub type TSENS_XPD_FORCE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TSENS_XPD_FORCE` writer - "]
pub type TSENS_XPD_FORCE_W<'a> = crate::FieldWriter<'a, u32, SAR_TSENS_CTRL2_SPEC, u8, u8, 2, 12>;
#[doc = "Field `TSENS_CLK_INV` reader - "]
pub type TSENS_CLK_INV_R = crate::BitReader<bool>;
#[doc = "Field `TSENS_CLK_INV` writer - "]
pub type TSENS_CLK_INV_W<'a> = crate::BitWriter<'a, u32, SAR_TSENS_CTRL2_SPEC, bool, 14>;
...
pub type TSENS_CLKGATE_EN_W<'a> = crate::BitWriter<'a, u32, SAR_TSENS_CTRL2_SPEC, bool, 15>;
...
pub type TSENS_RESET_W<'a> = crate::BitWriter<'a, u32, SAR_TSENS_CTRL2_SPEC, bool, 16>;
impl R {
    #[doc = "Bits 0:11"]
    #[inline(always)]
