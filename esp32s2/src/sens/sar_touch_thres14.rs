...
pub struct TOUCH_OUT_TH14_R(crate::FieldReader<u32, u32>);
impl TOUCH_OUT_TH14_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TOUCH_OUT_TH14_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TOUCH_OUT_TH14_R {
...
pub struct TOUCH_OUT_TH14_W<'a> {
    w: &'a mut W,
}
impl<'a> TOUCH_OUT_TH14_W<'a> {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sar_touch_thres14]
(index.html) module"]
pub struct SAR_TOUCH_THRES14_SPEC;
impl crate::RegisterSpec for SAR_TOUCH_THRES14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sar_touch_thres14::R]
(R) reader structure"]
impl crate::Readable for SAR_TOUCH_THRES14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sar_touch_thres14::W]
(W) writer structure"]
