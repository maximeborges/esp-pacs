...
pub struct TOUCH_OUT_TH2_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sar_touch_thres2]
(index.html) module"]
pub struct SAR_TOUCH_THRES2_SPEC;
impl crate::RegisterSpec for SAR_TOUCH_THRES2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sar_touch_thres2::R]
(R) reader structure"]
impl crate::Readable for SAR_TOUCH_THRES2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sar_touch_thres2::W]
(W) writer structure"]
