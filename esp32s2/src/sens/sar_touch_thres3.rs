...
pub struct TOUCH_OUT_TH3_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sar_touch_thres3]
(index.html) module"]
pub struct SAR_TOUCH_THRES3_SPEC;
impl crate::RegisterSpec for SAR_TOUCH_THRES3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sar_touch_thres3::R]
(R) reader structure"]
impl crate::Readable for SAR_TOUCH_THRES3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sar_touch_thres3::W]
(W) writer structure"]
