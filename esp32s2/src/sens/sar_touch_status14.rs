...
pub struct TOUCH_PAD14_DATA_R(crate::FieldReader<u32, u32>);
impl TOUCH_PAD14_DATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TOUCH_PAD14_DATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TOUCH_PAD14_DATA_R {
...
pub struct TOUCH_PAD14_DEBOUNCE_R(crate::FieldReader<u8, u8>);
impl TOUCH_PAD14_DEBOUNCE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        TOUCH_PAD14_DEBOUNCE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TOUCH_PAD14_DEBOUNCE_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sar_touch_status14]
(index.html) module"]
pub struct SAR_TOUCH_STATUS14_SPEC;
impl crate::RegisterSpec for SAR_TOUCH_STATUS14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sar_touch_status14::R]
(R) reader structure"]
