...
pub struct TIMER0_DUTY_RES_R(crate::FieldReader<u8, u8>);
...
pub struct CLK_DIV_TIMER0_R(crate::FieldReader<u32, u32>);
...
pub struct TIMER0_PAUSE_R(crate::FieldReader<bool, bool>);
impl TIMER0_PAUSE_R {
    #[inline(always)]
...
pub struct TIMER0_RST_R(crate::FieldReader<bool, bool>);
impl TIMER0_RST_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
#[doc = "Field `TICK_SEL_TIMER0` reader - This bit is used to select clock for timer %s. When this bit is set to 1 LEDC_APB_CLK_SEL\\[1:0\\]
 should be 1, otherwise the timer clock may be not accurate. 0: LEDC_PWM_CLK. 1: REF_TICK."]
pub struct TICK_SEL_TIMER0_R(crate::FieldReader<bool, bool>);
...
#[doc = "Field `TICK_SEL_TIMER0` writer - This bit is used to select clock for timer %s. When this bit is set to 1 LEDC_APB_CLK_SEL\\[1:0\\]
 should be 1, otherwise the timer clock may be not accurate. 0: LEDC_PWM_CLK. 1: REF_TICK."]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timer_conf]
(index.html) module"]
pub struct TIMER_CONF_SPEC;
impl crate::RegisterSpec for TIMER_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timer_conf::R]
(R) reader structure"]
impl crate::Readable for TIMER_CONF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timer_conf::W]
(W) writer structure"]
