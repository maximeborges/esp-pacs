...
impl APB_PERIPHERAL_LOCK_R {
    ...
    pub(crate) fn new(bits: bool) -> Self {
        APB_PERIPHERAL_LOCK_R(crate::FieldReader::new(bits))
    }
}
...
pub struct APB_PERIPHERAL_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> APB_PERIPHERAL_LOCK_W<'a> {
...
impl R {
    ...
    pub fn apb_peripheral_lock(&self) -> APB_PERIPHERAL_LOCK_R {
        APB_PERIPHERAL_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Lock register. Setting to 1 locks TX Copy DMA permission control registers."]
    #[inline(always)]
    pub fn apb_peripheral_lock(&mut self) -> APB_PERIPHERAL_LOCK_W {
        APB_PERIPHERAL_LOCK_W { w: self }
    }
