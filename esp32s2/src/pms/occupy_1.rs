...
pub struct OCCUPY_CACHE_R(crate::FieldReader<u8, u8>);
impl OCCUPY_CACHE_R {
    #[inline(always)]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [occupy_1]
(index.html) module"]
pub struct OCCUPY_1_SPEC;
impl crate::RegisterSpec for OCCUPY_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [occupy_1::R]
(R) reader structure"]
impl crate::Readable for OCCUPY_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [occupy_1::W]
(W) writer structure"]
