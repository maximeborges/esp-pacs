...
pub struct PRO_BOOT_LOCATION_LOCK_R(crate::FieldReader<bool, bool>);
impl PRO_BOOT_LOCATION_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        PRO_BOOT_LOCATION_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_BOOT_LOCATION_LOCK_R {
...
pub struct PRO_BOOT_LOCATION_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_BOOT_LOCATION_LOCK_W<'a> {
...
impl R {
    ...
    pub fn pro_boot_location_lock(&self) -> PRO_BOOT_LOCATION_LOCK_R {
        PRO_BOOT_LOCATION_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Lock register. Setting to 1 locks boot remap permission control registers."]
    #[inline(always)]
    pub fn pro_boot_location_lock(&mut self) -> PRO_BOOT_LOCATION_LOCK_W {
        PRO_BOOT_LOCATION_LOCK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_boot_location_0]
(index.html) module"]
pub struct PRO_BOOT_LOCATION_0_SPEC;
impl crate::RegisterSpec for PRO_BOOT_LOCATION_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_boot_location_0::R]
(R) reader structure"]
impl crate::Readable for PRO_BOOT_LOCATION_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_boot_location_0::W]
(W) writer structure"]
