...
pub struct PRO_DRAM0_LOCK_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn pro_dram0_lock(&self) -> PRO_DRAM0_LOCK_R {
        PRO_DRAM0_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Lock register. Setting to 1 locks DBUS0 permission control registers."]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dram0_0]
(index.html) module"]
pub struct PRO_DRAM0_0_SPEC;
impl crate::RegisterSpec for PRO_DRAM0_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dram0_0::R]
(R) reader structure"]
impl crate::Readable for PRO_DRAM0_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dram0_0::W]
(W) writer structure"]
