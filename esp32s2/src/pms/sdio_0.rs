...
impl SDIO_LOCK_R {
    ...
    pub(crate) fn new(bits: bool) -> Self {
        SDIO_LOCK_R(crate::FieldReader::new(bits))
    }
}
...
pub struct SDIO_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> SDIO_LOCK_W<'a> {
...
impl R {
    ...
    pub fn sdio_lock(&self) -> SDIO_LOCK_R {
        SDIO_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Lock register. Setting to 1 locks SDIO permission control registers."]
    #[inline(always)]
    pub fn sdio_lock(&mut self) -> SDIO_LOCK_W {
        SDIO_LOCK_W { w: self }
    }
