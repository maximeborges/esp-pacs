...
pub struct PRO_IRAM0_LOCK_R(crate::FieldReader<bool, bool>);
impl PRO_IRAM0_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        PRO_IRAM0_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_IRAM0_LOCK_R {
...
pub struct PRO_IRAM0_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_IRAM0_LOCK_W<'a> {
...
impl W {
    #[doc = "Bit 0 - Lock register. Setting to 1 locks IBUS permission control registers."]
    #[inline(always)]
    pub fn pro_iram0_lock(&mut self) -> PRO_IRAM0_LOCK_W {
        PRO_IRAM0_LOCK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_iram0_0]
(index.html) module"]
pub struct PRO_IRAM0_0_SPEC;
impl crate::RegisterSpec for PRO_IRAM0_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_iram0_0::R]
(R) reader structure"]
impl crate::Readable for PRO_IRAM0_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_iram0_0::W]
(W) writer structure"]
