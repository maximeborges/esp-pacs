...
pub struct PRO_DPORT_RESERVE_FIFO_1_R(crate::FieldReader<u32, u32>);
impl PRO_DPORT_RESERVE_FIFO_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PRO_DPORT_RESERVE_FIFO_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_DPORT_RESERVE_FIFO_1_R {
...
pub struct PRO_DPORT_RESERVE_FIFO_1_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_DPORT_RESERVE_FIFO_1_W<'a> {
...
impl W {
    ...
    pub fn pro_dport_reserve_fifo_1(&mut self) -> PRO_DPORT_RESERVE_FIFO_1_W {
        PRO_DPORT_RESERVE_FIFO_1_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dport_3]
(index.html) module"]
pub struct PRO_DPORT_3_SPEC;
impl crate::RegisterSpec for PRO_DPORT_3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dport_3::R]
(R) reader structure"]
impl crate::Readable for PRO_DPORT_3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dport_3::W]
(W) writer structure"]
