...
pub type APB_PERI_BYTE_ERROR_CLR_W<'a> =
    crate::BitWriter<'a, u32, APB_PERIPHERAL_INTR_SPEC, bool, 0>;
...
pub type APB_PERI_BYTE_ERROR_EN_W<'a> =
    crate::BitWriter<'a, u32, APB_PERIPHERAL_INTR_SPEC, bool, 1>;
