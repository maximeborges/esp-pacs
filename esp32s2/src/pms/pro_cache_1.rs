...
pub struct PRO_CACHE_CONNECT_R(crate::FieldReader<u16, u16>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_cache_1]
(index.html) module"]
pub struct PRO_CACHE_1_SPEC;
impl crate::RegisterSpec for PRO_CACHE_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_cache_1::R]
(R) reader structure"]
impl crate::Readable for PRO_CACHE_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_cache_1::W]
(W) writer structure"]
