...
pub struct PRO_CACHE_ILG_CLR_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_CACHE_ILG_EN_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_CACHE_ILG_INTR_R(crate::FieldReader<bool, bool>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_cache_2]
(index.html) module"]
pub struct PRO_CACHE_2_SPEC;
impl crate::RegisterSpec for PRO_CACHE_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_cache_2::R]
(R) reader structure"]
impl crate::Readable for PRO_CACHE_2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_cache_2::W]
(W) writer structure"]
