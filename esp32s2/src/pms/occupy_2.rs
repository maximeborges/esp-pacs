...
pub struct OCCUPY_MAC_DUMP_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [occupy_2]
(index.html) module"]
pub struct OCCUPY_2_SPEC;
impl crate::RegisterSpec for OCCUPY_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [occupy_2::R]
(R) reader structure"]
impl crate::Readable for OCCUPY_2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [occupy_2::W]
(W) writer structure"]
