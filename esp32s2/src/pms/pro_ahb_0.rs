...
pub struct PRO_AHB_LOCK_R(crate::FieldReader<bool, bool>);
impl PRO_AHB_LOCK_R {
    #[inline(always)]
...
impl R {
    ...
    pub fn pro_ahb_lock(&self) -> PRO_AHB_LOCK_R {
        PRO_AHB_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Lock register. Setting to 1 locks PeriBus2 permission control registers."]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_ahb_0]
(index.html) module"]
pub struct PRO_AHB_0_SPEC;
impl crate::RegisterSpec for PRO_AHB_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_ahb_0::R]
(R) reader structure"]
impl crate::Readable for PRO_AHB_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_ahb_0::W]
(W) writer structure"]
