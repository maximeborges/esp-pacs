...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_boot_location_1]
(index.html) module"]
pub struct PRO_BOOT_LOCATION_1_SPEC;
impl crate::RegisterSpec for PRO_BOOT_LOCATION_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_boot_location_1::R]
(R) reader structure"]
impl crate::Readable for PRO_BOOT_LOCATION_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_boot_location_1::W]
(W) writer structure"]
