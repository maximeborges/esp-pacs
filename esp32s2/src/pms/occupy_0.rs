...
pub struct OCCUPY_LOCK_R(crate::FieldReader<bool, bool>);
impl OCCUPY_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OCCUPY_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OCCUPY_LOCK_R {
...
pub struct OCCUPY_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> OCCUPY_LOCK_W<'a> {
...
impl R {
    ...
    pub fn occupy_lock(&self) -> OCCUPY_LOCK_R {
        OCCUPY_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Lock register. Setting to 1 locks occupy permission control registers."]
    #[inline(always)]
    pub fn occupy_lock(&mut self) -> OCCUPY_LOCK_W {
        OCCUPY_LOCK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [occupy_0]
(index.html) module"]
pub struct OCCUPY_0_SPEC;
impl crate::RegisterSpec for OCCUPY_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [occupy_0::R]
(R) reader structure"]
impl crate::Readable for OCCUPY_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [occupy_0::W]
(W) writer structure"]
