...
pub struct PRO_DPORT_RESERVE_FIFO_3_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dport_5]
(index.html) module"]
pub struct PRO_DPORT_5_SPEC;
impl crate::RegisterSpec for PRO_DPORT_5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dport_5::R]
(R) reader structure"]
impl crate::Readable for PRO_DPORT_5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dport_5::W]
(W) writer structure"]
