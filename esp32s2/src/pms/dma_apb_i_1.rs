...
pub struct DMA_APB_I_SRAM_0_R_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_0_W_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_1_R_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_1_W_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_2_R_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_2_W_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_3_R_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_3_W_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_4_SPLTADDR_R(crate::FieldReader<u32, u32>);
...
pub struct DMA_APB_I_SRAM_4_L_R_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_4_L_W_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_4_H_R_R(crate::FieldReader<bool, bool>);
...
pub struct DMA_APB_I_SRAM_4_H_W_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn dma_apb_i_sram_0_r(&self) -> DMA_APB_I_SRAM_0_R_R {
        DMA_APB_I_SRAM_0_R_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_0_w(&self) -> DMA_APB_I_SRAM_0_W_R {
        DMA_APB_I_SRAM_0_W_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_1_r(&self) -> DMA_APB_I_SRAM_1_R_R {
        DMA_APB_I_SRAM_1_R_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_1_w(&self) -> DMA_APB_I_SRAM_1_W_R {
        DMA_APB_I_SRAM_1_W_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_2_r(&self) -> DMA_APB_I_SRAM_2_R_R {
        DMA_APB_I_SRAM_2_R_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_2_w(&self) -> DMA_APB_I_SRAM_2_W_R {
        DMA_APB_I_SRAM_2_W_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_3_r(&self) -> DMA_APB_I_SRAM_3_R_R {
        DMA_APB_I_SRAM_3_R_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_3_w(&self) -> DMA_APB_I_SRAM_3_W_R {
        DMA_APB_I_SRAM_3_W_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_4_l_r(&self) -> DMA_APB_I_SRAM_4_L_R_R {
        DMA_APB_I_SRAM_4_L_R_R::new(((self.bits >> 25) & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_4_l_w(&self) -> DMA_APB_I_SRAM_4_L_W_R {
        DMA_APB_I_SRAM_4_L_W_R::new(((self.bits >> 26) & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_4_h_r(&self) -> DMA_APB_I_SRAM_4_H_R_R {
        DMA_APB_I_SRAM_4_H_R_R::new(((self.bits >> 27) & 0x01) != 0)
    }
    ...
    pub fn dma_apb_i_sram_4_h_w(&self) -> DMA_APB_I_SRAM_4_H_W_R {
        DMA_APB_I_SRAM_4_H_W_R::new(((self.bits >> 28) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Setting to 1 grants internal DMA permission to read SRAM Block 0."]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_apb_i_1]
(index.html) module"]
pub struct DMA_APB_I_1_SPEC;
impl crate::RegisterSpec for DMA_APB_I_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_apb_i_1::R]
(R) reader structure"]
impl crate::Readable for DMA_APB_I_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_apb_i_1::W]
(W) writer structure"]
