...
#[doc = "Field `DMA_RX_I_ILG_ST` reader - Record the illegitimate information of RX Copy DMA. \\[22:6\\]
: store the bits \\[18:2\\]
 of address. \\[5\\]
: if bits \\[31:19\\]
 of address are 0x7ff, then the bit value is 1, otherwise it is 0. \\[4\\]
: 1 means write operation, 0 means read operation. \\[3:0\\]
: RX Copy DMA bus byte enables."]
pub struct DMA_RX_I_ILG_ST_R(crate::FieldReader<u32, u32>);
...
impl R {
    #[doc = "Bits 0:22 - Record the illegitimate information of RX Copy DMA. \\[22:6\\]
: store the bits \\[18:2\\]
 of address. \\[5\\]
: if bits \\[31:19\\]
 of address are 0x7ff, then the bit value is 1, otherwise it is 0. \\[4\\]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_rx_i_3]
(index.html) module"]
pub struct DMA_RX_I_3_SPEC;
impl crate::RegisterSpec for DMA_RX_I_3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_rx_i_3::R]
(R) reader structure"]
