...
#[doc = "Field `PRO_AHB_ILG_ST` reader - Record the illegitimate information of PeriBus2. \\[31:2\\]
: store the bits \\[31:2\\]
 of PeriBus2 address. \\[1\\]
: 1 means data access, 0 means instruction access. \\[0\\]
: 1 means write operation, 0 means read operation."]
pub struct PRO_AHB_ILG_ST_R(crate::FieldReader<u32, u32>);
...
impl R {
    #[doc = "Bits 0:31 - Record the illegitimate information of PeriBus2. \\[31:2\\]
: store the bits \\[31:2\\]
 of PeriBus2 address. \\[1\\]
: 1 means data access, 0 means instruction access. \\[0\\]
: 1 means write operation, 0 means read operation."]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_ahb_4]
(index.html) module"]
pub struct PRO_AHB_4_SPEC;
impl crate::RegisterSpec for PRO_AHB_4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_ahb_4::R]
(R) reader structure"]
