...
pub struct DMA_RX_I_LOCK_R(crate::FieldReader<bool, bool>);
impl DMA_RX_I_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        DMA_RX_I_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMA_RX_I_LOCK_R {
...
pub struct DMA_RX_I_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> DMA_RX_I_LOCK_W<'a> {
...
impl R {
    ...
    pub fn dma_rx_i_lock(&self) -> DMA_RX_I_LOCK_R {
        DMA_RX_I_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Lock register. Setting to 1 locks RX Copy DMA permission control registers."]
    #[inline(always)]
    pub fn dma_rx_i_lock(&mut self) -> DMA_RX_I_LOCK_W {
        DMA_RX_I_LOCK_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_rx_i_0]
(index.html) module"]
pub struct DMA_RX_I_0_SPEC;
impl crate::RegisterSpec for DMA_RX_I_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_rx_i_0::R]
(R) reader structure"]
impl crate::Readable for DMA_RX_I_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_rx_i_0::W]
(W) writer structure"]
