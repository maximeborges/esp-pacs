...
#[doc = "Field `PRO_IRAM0_ILG_ST` reader - Record the illegitimate information of IBUS. \\[21:2\\]
: store the bits \\[21:2\\]
 of IBUS address. \\[1\\]
: 1 means data access, 0 means instruction access. \\[0\\]
: 1 means write operation, 0 means read operation."]
pub struct PRO_IRAM0_ILG_ST_R(crate::FieldReader<u32, u32>);
...
impl R {
    #[doc = "Bits 0:21 - Record the illegitimate information of IBUS. \\[21:2\\]
: store the bits \\[21:2\\]
 of IBUS address. \\[1\\]
: 1 means data access, 0 means instruction access. \\[0\\]
: 1 means write operation, 0 means read operation."]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_iram0_5]
(index.html) module"]
pub struct PRO_IRAM0_5_SPEC;
impl crate::RegisterSpec for PRO_IRAM0_5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_iram0_5::R]
(R) reader structure"]
