...
#[doc = "Field `CLR_DG_PAD_AUTOHOLD` writer - Set this bit to clear the auto-hold enabler for the digital GPIOs."]
...
#[doc = "Field `DG_PAD_AUTOHOLD_EN` reader - Set this bit to allow the digital GPIOs to enter the auto-hold status."]
...
#[doc = "Field `DG_PAD_AUTOHOLD_EN` writer - Set this bit to allow the digital GPIOs to enter the auto-hold status."]
...
#[doc = "Field `DG_PAD_FORCE_NOISO` reader - Set this bit to disable the force isolation of the digital GPIOs."]
...
#[doc = "Field `DG_PAD_FORCE_NOISO` writer - Set this bit to disable the force isolation of the digital GPIOs."]
...
#[doc = "Field `DG_PAD_FORCE_ISO` reader - Set this bit to force isolation of the digital GPIOs."]
...
#[doc = "Field `DG_PAD_FORCE_ISO` writer - Set this bit to force isolation of the digital GPIOs."]
...
#[doc = "Field `WIFI_FORCE_ISO` reader - Set this bit to force isolation of the Wi-Fi digital circuits."]
...
#[doc = "Field `WIFI_FORCE_ISO` writer - Set this bit to force isolation of the Wi-Fi digital circuits."]
...
#[doc = "Field `WIFI_FORCE_NOISO` reader - Set this bit to disable the force isolation of the Wi-Fi digital circuits."]
...
#[doc = "Field `WIFI_FORCE_NOISO` writer - Set this bit to disable the force isolation of the Wi-Fi digital circuits."]
...
#[doc = "Field `DG_WRAP_FORCE_ISO` reader - Set this bit to force isolation of the digital system."]
...
#[doc = "Field `DG_WRAP_FORCE_ISO` writer - Set this bit to force isolation of the digital system."]
...
#[doc = "Field `DG_WRAP_FORCE_NOISO` reader - Set this bit to disable the force isolation of the digital system."]
...
#[doc = "Field `DG_WRAP_FORCE_NOISO` writer - Set this bit to disable the force isolation of the digital system."]
...
impl R {
    ...
    #[doc = "Bit 11 - Set this bit to allow the digital GPIOs to enter the auto-hold status."]
    #[inline(always)]
    pub fn dg_pad_autohold_en(&self) -> DG_PAD_AUTOHOLD_EN_R {
        DG_PAD_AUTOHOLD_EN_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    #[doc = "Bit 12 - Set this bit to disable the force isolation of the digital GPIOs."]
    #[inline(always)]
    pub fn dg_pad_force_noiso(&self) -> DG_PAD_FORCE_NOISO_R {
        DG_PAD_FORCE_NOISO_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 13 - Set this bit to force isolation of the digital GPIOs."]
    #[inline(always)]
    ...
    #[doc = "Bit 28 - Set this bit to force isolation of the Wi-Fi digital circuits."]
    #[inline(always)]
    pub fn wifi_force_iso(&self) -> WIFI_FORCE_ISO_R {
        WIFI_FORCE_ISO_R::new(((self.bits >> 28) & 0x01) != 0)
    }
    #[doc = "Bit 29 - Set this bit to disable the force isolation of the Wi-Fi digital circuits."]
    #[inline(always)]
    pub fn wifi_force_noiso(&self) -> WIFI_FORCE_NOISO_R {
        WIFI_FORCE_NOISO_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    #[doc = "Bit 30 - Set this bit to force isolation of the digital system."]
    #[inline(always)]
    pub fn dg_wrap_force_iso(&self) -> DG_WRAP_FORCE_ISO_R {
        DG_WRAP_FORCE_ISO_R::new(((self.bits >> 30) & 0x01) != 0)
    }
    #[doc = "Bit 31 - Set this bit to disable the force isolation of the digital system."]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 10 - Set this bit to clear the auto-hold enabler for the digital GPIOs."]
    #[inline(always)]
