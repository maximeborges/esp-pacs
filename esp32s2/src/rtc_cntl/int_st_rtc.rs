...
pub struct TOUCH_SCAN_DONE_INT_ST_R(crate::FieldReader<bool>);
...
pub struct ULP_CP_INT_ST_R(crate::FieldReader<bool>);
...
pub struct TOUCH_DONE_INT_ST_R(crate::FieldReader<bool>);
...
pub struct TOUCH_ACTIVE_INT_ST_R(crate::FieldReader<bool>);
...
pub struct TOUCH_INACTIVE_INT_ST_R(crate::FieldReader<bool>);
...
pub struct MAIN_TIMER_INT_ST_R(crate::FieldReader<bool>);
...
pub struct SARADC1_INT_ST_R(crate::FieldReader<bool>);
...
pub struct TSENS_INT_ST_R(crate::FieldReader<bool>);
impl TSENS_INT_ST_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct COCPU_INT_ST_R(crate::FieldReader<bool>);
impl COCPU_INT_ST_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct SARADC2_INT_ST_R(crate::FieldReader<bool>);
...
pub struct SWD_INT_ST_R(crate::FieldReader<bool>);
impl SWD_INT_ST_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct XTAL32K_DEAD_INT_ST_R(crate::FieldReader<bool>);
...
pub struct COCPU_TRAP_INT_ST_R(crate::FieldReader<bool>);
...
pub struct TOUCH_TIMEOUT_INT_ST_R(crate::FieldReader<bool>);
