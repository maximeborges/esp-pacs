...
pub type DG_DCDC_WAIT_TIMER_W<'a> = crate::FieldWriter<'a, u32, TIMER6_SPEC, u16, u16, 9, 16>;
...
pub type DG_DCDC_POWERUP_TIMER_W<'a> = crate::FieldWriter<'a, u32, TIMER6_SPEC, u8, u8, 7, 25>;
impl R {
    #[doc = "Bits 16:24"]
    #[inline(always)]
