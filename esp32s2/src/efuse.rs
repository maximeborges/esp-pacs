...
pub struct RegisterBlock {
    ...
    pub pgm_data: [crate::Reg<pgm_data::PGM_DATA_SPEC>; 8],
    #[doc = "0x20..0x2c - Register %s that stores the RS code to be programmed."]
    pub pgm_check_value: [crate::Reg<pgm_check_value::PGM_CHECK_VALUE_SPEC>; 3],
    ...
    pub rd_sys_data_part1_: [crate::Reg<rd_sys_data_part1_::RD_SYS_DATA_PART1__SPEC>; 8],
    #[doc = "0x7c..0x9c - Register %s of BLOCK3 (user)."]
    pub rd_usr_data: [crate::Reg<rd_usr_data::RD_USR_DATA_SPEC>; 8],
    #[doc = "0x9c..0xbc - Register %s of BLOCK4 (KEY0)."]
    pub rd_key0_data: [crate::Reg<rd_key0_data::RD_KEY0_DATA_SPEC>; 8],
    #[doc = "0xbc..0xdc - Register %s of BLOCK5 (KEY1)."]
    pub rd_key1_data: [crate::Reg<rd_key1_data::RD_KEY1_DATA_SPEC>; 8],
    #[doc = "0xdc..0xfc - Register %s of BLOCK6 (KEY2)."]
    pub rd_key2_data: [crate::Reg<rd_key2_data::RD_KEY2_DATA_SPEC>; 8],
    #[doc = "0xfc..0x11c - Register %s of BLOCK7 (KEY3)."]
    pub rd_key3_data: [crate::Reg<rd_key3_data::RD_KEY3_DATA_SPEC>; 8],
    #[doc = "0x11c..0x13c - Register %s of BLOCK8 (KEY4)."]
    pub rd_key4_data: [crate::Reg<rd_key4_data::RD_KEY4_DATA_SPEC>; 8],
    #[doc = "0x13c..0x15c - Register %s of BLOCK9 (KEY5)."]
    pub rd_key5_data: [crate::Reg<rd_key5_data::RD_KEY5_DATA_SPEC>; 8],
    #[doc = "0x15c..0x17c - Register %s of BLOCK10 (system)."]
    pub rd_sys_data_part2_: [crate::Reg<rd_sys_data_part2_::RD_SYS_DATA_PART2__SPEC>; 8],
...
#[doc = "PGM_DATA register accessor: an alias for `Reg<PGM_DATA_SPEC>`"]
pub type PGM_DATA = crate::Reg<pgm_data::PGM_DATA_SPEC>;
#[doc = "Register %s that stores data to be programmed."]
pub mod pgm_data;
#[doc = "PGM_CHECK_VALUE register accessor: an alias for `Reg<PGM_CHECK_VALUE_SPEC>`"]
...
#[doc = "RD_SYS_DATA_PART1_ register accessor: an alias for `Reg<RD_SYS_DATA_PART1__SPEC>`"]
