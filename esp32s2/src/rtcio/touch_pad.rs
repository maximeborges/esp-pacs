...
pub struct TOUCH_PAD0_FUN_IE_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_PAD0_SLP_OE_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_PAD0_SLP_IE_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_PAD0_SLP_SEL_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_PAD0_FUN_SEL_R(crate::FieldReader<u8, u8>);
...
pub struct TOUCH_PAD0_MUX_SEL_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_PAD0_XPD_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_PAD0_TIE_OPT_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_PAD0_START_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_PAD0_RUE_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_PAD0_RDE_R(crate::FieldReader<bool, bool>);
...
pub struct TOUCH_PAD0_DRV_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [touch_pad]
(index.html) module"]
pub struct TOUCH_PAD_SPEC;
impl crate::RegisterSpec for TOUCH_PAD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [touch_pad::R]
(R) reader structure"]
impl crate::Readable for TOUCH_PAD_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [touch_pad::W]
(W) writer structure"]
