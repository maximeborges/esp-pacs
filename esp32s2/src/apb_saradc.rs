...
pub struct RegisterBlock {
    ...
    pub filter_ctrl: crate::Reg<filter_ctrl::FILTER_CTRL_SPEC>,
    #[doc = "0x40 - Data status of DIG ADC2 filter"]
    pub filter_status: crate::Reg<filter_status::FILTER_STATUS_SPEC>,
    ...
    pub apb_dac_ctrl: crate::Reg<apb_dac_ctrl::APB_DAC_CTRL_SPEC>,
...
pub mod arb_ctrl;
#[doc = "FILTER_CTRL register accessor: an alias for `Reg<FILTER_CTRL_SPEC>`"]
pub type FILTER_CTRL = crate::Reg<filter_ctrl::FILTER_CTRL_SPEC>;
#[doc = "Configure the settings of DIG ADC2 filter"]
pub mod filter_ctrl;
#[doc = "FILTER_STATUS register accessor: an alias for `Reg<FILTER_STATUS_SPEC>`"]
...
pub mod clkm_conf;
#[doc = "APB_DAC_CTRL register accessor: an alias for `Reg<APB_DAC_CTRL_SPEC>`"]
