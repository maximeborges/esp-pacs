...
pub struct PRO_DCACHE_MEMSYNC_ADDR_R(crate::FieldReader<u32, u32>);
impl PRO_DCACHE_MEMSYNC_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PRO_DCACHE_MEMSYNC_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_DCACHE_MEMSYNC_ADDR_R {
...
pub struct PRO_DCACHE_MEMSYNC_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_DCACHE_MEMSYNC_ADDR_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the start virtual address for invalidate, flush, clean, lock and unlock operations. The manual operations will be issued if the address is validate. The auto operations will be issued if the address is invalidate. It should be combined with PRO_DCACHE_MEM_SYNC1."]
    #[inline(always)]
    pub fn pro_dcache_memsync_addr(&mut self) -> PRO_DCACHE_MEMSYNC_ADDR_W {
        PRO_DCACHE_MEMSYNC_ADDR_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_mem_sync0]
(index.html) module"]
pub struct PRO_DCACHE_MEM_SYNC0_SPEC;
impl crate::RegisterSpec for PRO_DCACHE_MEM_SYNC0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dcache_mem_sync0::R]
(R) reader structure"]
impl crate::Readable for PRO_DCACHE_MEM_SYNC0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dcache_mem_sync0::W]
(W) writer structure"]
