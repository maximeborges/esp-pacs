...
pub struct DBUS1_ABANDON_CNT_R(crate::FieldReader<u16, u16>);
impl DBUS1_ABANDON_CNT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DBUS1_ABANDON_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DBUS1_ABANDON_CNT_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dbus1_abandon_cnt]
(index.html) module"]
pub struct DBUS1_ABANDON_CNT_SPEC;
impl crate::RegisterSpec for DBUS1_ABANDON_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dbus1_abandon_cnt::R]
(R) reader structure"]
