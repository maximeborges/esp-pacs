...
impl PRO_ICACHE_LOCK0_ADDR_R {
    ...
    pub(crate) fn new(bits: u32) -> Self {
        PRO_ICACHE_LOCK0_ADDR_R(crate::FieldReader::new(bits))
    }
}
...
pub struct PRO_ICACHE_LOCK0_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_ICACHE_LOCK0_ADDR_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the first start virtual address of data locking, which is combined with PRO_ICACHE_LOCK0_SIZE_REG"]
    #[inline(always)]
    pub fn pro_icache_lock0_addr(&mut self) -> PRO_ICACHE_LOCK0_ADDR_W {
        PRO_ICACHE_LOCK0_ADDR_W { w: self }
    }
