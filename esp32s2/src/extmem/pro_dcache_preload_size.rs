...
pub type PRO_DCACHE_PRELOAD_SIZE_W<'a> =
    crate::FieldWriter<'a, u32, PRO_DCACHE_PRELOAD_SIZE_SPEC, u16, u16, 10, 0>;
...
pub type PRO_DCACHE_PRELOAD_ORDER_W<'a> =
    crate::BitWriter<'a, u32, PRO_DCACHE_PRELOAD_SIZE_SPEC, bool, 10>;
impl R {
