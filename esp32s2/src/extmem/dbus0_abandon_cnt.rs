...
pub struct DBUS0_ABANDON_CNT_R(crate::FieldReader<u16, u16>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dbus0_abandon_cnt]
(index.html) module"]
pub struct DBUS0_ABANDON_CNT_SPEC;
impl crate::RegisterSpec for DBUS0_ABANDON_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dbus0_abandon_cnt::R]
(R) reader structure"]
