...
pub struct IBUS1_ACS_MISS_CNT_R(crate::FieldReader<u32, u32>);
impl IBUS1_ACS_MISS_CNT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        IBUS1_ACS_MISS_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IBUS1_ACS_MISS_CNT_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ibus1_acs_miss_cnt]
(index.html) module"]
pub struct IBUS1_ACS_MISS_CNT_SPEC;
impl crate::RegisterSpec for IBUS1_ACS_MISS_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ibus1_acs_miss_cnt::R]
(R) reader structure"]
