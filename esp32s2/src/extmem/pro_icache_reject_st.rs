...
pub struct PRO_ICACHE_TAG_ATTR_R(crate::FieldReader<u8, u8>);
...
pub struct PRO_ICACHE_CPU_ATTR_R(crate::FieldReader<u8, u8>);
...
impl R {
    ...
    pub fn pro_icache_tag_attr(&self) -> PRO_ICACHE_TAG_ATTR_R {
        PRO_ICACHE_TAG_ATTR_R::new((self.bits & 0x07) as u8)
    }
    ...
    pub fn pro_icache_cpu_attr(&self) -> PRO_ICACHE_CPU_ATTR_R {
        PRO_ICACHE_CPU_ATTR_R::new(((self.bits >> 3) & 0x07) as u8)
    }
}
#[doc = "register description\n\nThis register you can [`read`]
(crate::generic::Reg::read). See [API]
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_icache_reject_st]
(index.html) module"]
pub struct PRO_ICACHE_REJECT_ST_SPEC;
impl crate::RegisterSpec for PRO_ICACHE_REJECT_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_icache_reject_st::R]
(R) reader structure"]
