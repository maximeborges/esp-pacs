...
pub type PRO_DCACHE_AUTOLOAD_MODE_W<'a> =
    crate::BitWriter<'a, u32, PRO_DCACHE_AUTOLOAD_CFG_SPEC, bool, 0>;
...
pub type PRO_DCACHE_AUTOLOAD_STEP_W<'a> =
    crate::FieldWriter<'a, u32, PRO_DCACHE_AUTOLOAD_CFG_SPEC, u8, u8, 2, 1>;
...
pub type PRO_DCACHE_AUTOLOAD_ORDER_W<'a> =
    crate::BitWriter<'a, u32, PRO_DCACHE_AUTOLOAD_CFG_SPEC, bool, 3>;
...
pub type PRO_DCACHE_AUTOLOAD_RQST_W<'a> =
    crate::FieldWriter<'a, u32, PRO_DCACHE_AUTOLOAD_CFG_SPEC, u8, u8, 2, 4>;
...
pub type PRO_DCACHE_AUTOLOAD_SIZE_W<'a> =
    crate::FieldWriter<'a, u32, PRO_DCACHE_AUTOLOAD_CFG_SPEC, u8, u8, 2, 6>;
...
pub type PRO_DCACHE_AUTOLOAD_SCT0_ENA_W<'a> =
    crate::BitWriter<'a, u32, PRO_DCACHE_AUTOLOAD_CFG_SPEC, bool, 8>;
...
pub type PRO_DCACHE_AUTOLOAD_SCT1_ENA_W<'a> =
    crate::BitWriter<'a, u32, PRO_DCACHE_AUTOLOAD_CFG_SPEC, bool, 9>;
impl R {
    #[doc = "Bit 0 - Reserved."]
    #[inline(always)]
