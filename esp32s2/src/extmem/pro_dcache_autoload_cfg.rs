...
pub struct PRO_DCACHE_AUTOLOAD_MODE_R(crate::FieldReader<bool>);
...
pub struct PRO_DCACHE_AUTOLOAD_STEP_R(crate::FieldReader<u8>);
...
pub struct PRO_DCACHE_AUTOLOAD_ORDER_R(crate::FieldReader<bool>);
...
pub struct PRO_DCACHE_AUTOLOAD_RQST_R(crate::FieldReader<u8>);
...
pub struct PRO_DCACHE_AUTOLOAD_SIZE_R(crate::FieldReader<u8>);
...
pub struct PRO_DCACHE_AUTOLOAD_SCT0_ENA_R(crate::FieldReader<bool>);
...
pub struct PRO_DCACHE_AUTOLOAD_SCT1_ENA_R(crate::FieldReader<bool>);
