...
pub struct DBUS1_ACS_WB_CNT_R(crate::FieldReader<u32, u32>);
impl DBUS1_ACS_WB_CNT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        DBUS1_ACS_WB_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DBUS1_ACS_WB_CNT_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dbus1_acs_wb_cnt]
(index.html) module"]
pub struct DBUS1_ACS_WB_CNT_SPEC;
impl crate::RegisterSpec for DBUS1_ACS_WB_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dbus1_acs_wb_cnt::R]
(R) reader structure"]
