...
pub struct DC_PRELOAD_MISS_CNT_R(crate::FieldReader<u16, u16>);
impl DC_PRELOAD_MISS_CNT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DC_PRELOAD_MISS_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DC_PRELOAD_MISS_CNT_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dc_preload_miss_cnt]
(index.html) module"]
pub struct DC_PRELOAD_MISS_CNT_SPEC;
impl crate::RegisterSpec for DC_PRELOAD_MISS_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dc_preload_miss_cnt::R]
(R) reader structure"]
