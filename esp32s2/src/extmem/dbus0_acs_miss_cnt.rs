...
pub struct DBUS0_ACS_MISS_CNT_R(crate::FieldReader<u32, u32>);
impl DBUS0_ACS_MISS_CNT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        DBUS0_ACS_MISS_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DBUS0_ACS_MISS_CNT_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dbus0_acs_miss_cnt]
(index.html) module"]
pub struct DBUS0_ACS_MISS_CNT_SPEC;
impl crate::RegisterSpec for DBUS0_ACS_MISS_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dbus0_acs_miss_cnt::R]
(R) reader structure"]
