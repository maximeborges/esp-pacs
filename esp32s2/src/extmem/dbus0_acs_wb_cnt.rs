...
pub struct DBUS0_ACS_WB_CNT_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dbus0_acs_wb_cnt]
(index.html) module"]
pub struct DBUS0_ACS_WB_CNT_SPEC;
impl crate::RegisterSpec for DBUS0_ACS_WB_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dbus0_acs_wb_cnt::R]
(R) reader structure"]
