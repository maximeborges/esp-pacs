...
pub struct PRO_DCACHE_TAG_ATTR_R(crate::FieldReader<u8, u8>);
...
pub struct PRO_DCACHE_CPU_ATTR_R(crate::FieldReader<u8, u8>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_reject_st]
(index.html) module"]
pub struct PRO_DCACHE_REJECT_ST_SPEC;
impl crate::RegisterSpec for PRO_DCACHE_REJECT_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dcache_reject_st::R]
(R) reader structure"]
