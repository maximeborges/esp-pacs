...
pub struct PRO_ICACHE_LOCK1_SIZE_R(crate::FieldReader<u16, u16>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_icache_lock1_size]
(index.html) module"]
pub struct PRO_ICACHE_LOCK1_SIZE_SPEC;
impl crate::RegisterSpec for PRO_ICACHE_LOCK1_SIZE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_icache_lock1_size::R]
(R) reader structure"]
impl crate::Readable for PRO_ICACHE_LOCK1_SIZE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_icache_lock1_size::W]
(W) writer structure"]
