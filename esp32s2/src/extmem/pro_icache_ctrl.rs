...
pub struct PRO_ICACHE_ENABLE_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_SETSIZE_MODE_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_BLOCKSIZE_MODE_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_INVALIDATE_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_INVALIDATE_DONE_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_LOCK0_EN_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_LOCK1_EN_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_AUTOLOAD_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_AUTOLOAD_DONE_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_PRELOAD_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_PRELOAD_DONE_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_UNLOCK_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_UNLOCK_DONE_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_LOCK_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct PRO_ICACHE_LOCK_DONE_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn pro_icache_enable(&self) -> PRO_ICACHE_ENABLE_R {
        PRO_ICACHE_ENABLE_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn pro_icache_setsize_mode(&self) -> PRO_ICACHE_SETSIZE_MODE_R {
        PRO_ICACHE_SETSIZE_MODE_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_blocksize_mode(&self) -> PRO_ICACHE_BLOCKSIZE_MODE_R {
        PRO_ICACHE_BLOCKSIZE_MODE_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_invalidate_ena(&self) -> PRO_ICACHE_INVALIDATE_ENA_R {
        PRO_ICACHE_INVALIDATE_ENA_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_invalidate_done(&self) -> PRO_ICACHE_INVALIDATE_DONE_R {
        PRO_ICACHE_INVALIDATE_DONE_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_lock0_en(&self) -> PRO_ICACHE_LOCK0_EN_R {
        PRO_ICACHE_LOCK0_EN_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_lock1_en(&self) -> PRO_ICACHE_LOCK1_EN_R {
        PRO_ICACHE_LOCK1_EN_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_autoload_ena(&self) -> PRO_ICACHE_AUTOLOAD_ENA_R {
        PRO_ICACHE_AUTOLOAD_ENA_R::new(((self.bits >> 18) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_autoload_done(&self) -> PRO_ICACHE_AUTOLOAD_DONE_R {
        PRO_ICACHE_AUTOLOAD_DONE_R::new(((self.bits >> 19) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_preload_ena(&self) -> PRO_ICACHE_PRELOAD_ENA_R {
        PRO_ICACHE_PRELOAD_ENA_R::new(((self.bits >> 20) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_preload_done(&self) -> PRO_ICACHE_PRELOAD_DONE_R {
        PRO_ICACHE_PRELOAD_DONE_R::new(((self.bits >> 21) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_unlock_ena(&self) -> PRO_ICACHE_UNLOCK_ENA_R {
        PRO_ICACHE_UNLOCK_ENA_R::new(((self.bits >> 22) & 0x01) != 0)
    }
    ...
    pub fn pro_icache_unlock_done(&self) -> PRO_ICACHE_UNLOCK_DONE_R {
        PRO_ICACHE_UNLOCK_DONE_R::new(((self.bits >> 23) & 0x01) != 0)
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_icache_ctrl]
(index.html) module"]
pub struct PRO_ICACHE_CTRL_SPEC;
impl crate::RegisterSpec for PRO_ICACHE_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_icache_ctrl::R]
(R) reader structure"]
impl crate::Readable for PRO_ICACHE_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_icache_ctrl::W]
(W) writer structure"]
