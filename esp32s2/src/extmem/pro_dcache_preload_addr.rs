...
pub struct PRO_DCACHE_PRELOAD_ADDR_R(crate::FieldReader<u32, u32>);
impl PRO_DCACHE_PRELOAD_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PRO_DCACHE_PRELOAD_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_DCACHE_PRELOAD_ADDR_R {
...
pub struct PRO_DCACHE_PRELOAD_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_DCACHE_PRELOAD_ADDR_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the start virtual address for manual pre-load operation. It should be combined with PRO_DCACHE_PRELOAD_SIZE_REG."]
    #[inline(always)]
    pub fn pro_dcache_preload_addr(&mut self) -> PRO_DCACHE_PRELOAD_ADDR_W {
        PRO_DCACHE_PRELOAD_ADDR_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_preload_addr]
(index.html) module"]
pub struct PRO_DCACHE_PRELOAD_ADDR_SPEC;
impl crate::RegisterSpec for PRO_DCACHE_PRELOAD_ADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dcache_preload_addr::R]
(R) reader structure"]
impl crate::Readable for PRO_DCACHE_PRELOAD_ADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dcache_preload_addr::W]
(W) writer structure"]
