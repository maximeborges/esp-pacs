...
pub struct PRO_DCACHE_AUTOLOAD_SCT0_SIZE_R(crate::FieldReader<u32, u32>);
impl PRO_DCACHE_AUTOLOAD_SCT0_SIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PRO_DCACHE_AUTOLOAD_SCT0_SIZE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_DCACHE_AUTOLOAD_SCT0_SIZE_R {
...
pub struct PRO_DCACHE_AUTOLOAD_SCT0_SIZE_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_DCACHE_AUTOLOAD_SCT0_SIZE_W<'a> {
...
impl W {
    #[doc = "Bits 0:23 - The bits are used to configure the length of the first section for conditional pre-load operation. It should be combined with pro_dcache_autoload_sct0_ena."]
    #[inline(always)]
    pub fn pro_dcache_autoload_sct0_size(&mut self) -> PRO_DCACHE_AUTOLOAD_SCT0_SIZE_W {
        PRO_DCACHE_AUTOLOAD_SCT0_SIZE_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_autoload_section0_size]
(index.html) module"]
pub struct PRO_DCACHE_AUTOLOAD_SECTION0_SIZE_SPEC;
impl crate::RegisterSpec for PRO_DCACHE_AUTOLOAD_SECTION0_SIZE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dcache_autoload_section0_size::R]
(R) reader structure"]
impl crate::Readable for PRO_DCACHE_AUTOLOAD_SECTION0_SIZE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dcache_autoload_section0_size::W]
(W) writer structure"]
