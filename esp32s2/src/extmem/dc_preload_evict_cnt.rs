...
pub struct DC_PRELOAD_EVICT_CNT_R(crate::FieldReader<u16, u16>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dc_preload_evict_cnt]
(index.html) module"]
pub struct DC_PRELOAD_EVICT_CNT_SPEC;
impl crate::RegisterSpec for DC_PRELOAD_EVICT_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dc_preload_evict_cnt::R]
(R) reader structure"]
