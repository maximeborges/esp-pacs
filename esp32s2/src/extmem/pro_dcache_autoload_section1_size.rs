...
pub struct PRO_DCACHE_AUTOLOAD_SCT1_SIZE_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_autoload_section1_size]
(index.html) module"]
pub struct PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC;
impl crate::RegisterSpec for PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dcache_autoload_section1_size::R]
(R) reader structure"]
impl crate::Readable for PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dcache_autoload_section1_size::W]
(W) writer structure"]
