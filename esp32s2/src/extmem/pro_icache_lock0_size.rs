...
pub struct PRO_ICACHE_LOCK0_SIZE_R(crate::FieldReader<u16, u16>);
impl PRO_ICACHE_LOCK0_SIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        PRO_ICACHE_LOCK0_SIZE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_ICACHE_LOCK0_SIZE_R {
...
pub struct PRO_ICACHE_LOCK0_SIZE_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_ICACHE_LOCK0_SIZE_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - The bits are used to configure the first length of data locking, which is combined with PRO_ICACHE_LOCK0_ADDR_REG"]
    #[inline(always)]
    pub fn pro_icache_lock0_size(&mut self) -> PRO_ICACHE_LOCK0_SIZE_W {
        PRO_ICACHE_LOCK0_SIZE_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_icache_lock0_size]
(index.html) module"]
pub struct PRO_ICACHE_LOCK0_SIZE_SPEC;
impl crate::RegisterSpec for PRO_ICACHE_LOCK0_SIZE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_icache_lock0_size::R]
(R) reader structure"]
impl crate::Readable for PRO_ICACHE_LOCK0_SIZE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_icache_lock0_size::W]
(W) writer structure"]
