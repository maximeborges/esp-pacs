...
pub struct IBUS0_ACS_MISS_CNT_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ibus0_acs_miss_cnt]
(index.html) module"]
pub struct IBUS0_ACS_MISS_CNT_SPEC;
impl crate::RegisterSpec for IBUS0_ACS_MISS_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ibus0_acs_miss_cnt::R]
(R) reader structure"]
