...
pub type IBUS_ACS_MSK_IC_INT_CLR_W<'a> = crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 0>;
#[doc = "Field `IBUS_CNT_OVF_INT_CLR` writer - The bit is used to clear interrupt by ibus counter overflow."]
pub type IBUS_CNT_OVF_INT_CLR_W<'a> = crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 1>;
#[doc = "Field `IC_SYNC_SIZE_FAULT_INT_CLR` writer - The bit is used to clear interrupt by manual sync configurations fault."]
pub type IC_SYNC_SIZE_FAULT_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 2>;
...
pub type IC_PRELOAD_SIZE_FAULT_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 3>;
#[doc = "Field `ICACHE_REJECT_INT_CLR` writer - The bit is used to clear interrupt by authentication fail."]
pub type ICACHE_REJECT_INT_CLR_W<'a> = crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 4>;
...
pub type ICACHE_SET_ILG_INT_CLR_W<'a> = crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 5>;
...
pub type DBUS_ACS_MSK_DC_INT_CLR_W<'a> = crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 6>;
#[doc = "Field `DBUS_CNT_OVF_INT_CLR` writer - The bit is used to clear interrupt by dbus counter overflow."]
pub type DBUS_CNT_OVF_INT_CLR_W<'a> = crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 7>;
#[doc = "Field `DC_SYNC_SIZE_FAULT_INT_CLR` writer - The bit is used to clear interrupt by manual sync configurations fault."]
pub type DC_SYNC_SIZE_FAULT_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 8>;
...
pub type DC_PRELOAD_SIZE_FAULT_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 9>;
...
pub type DCACHE_WRITE_FLASH_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 10>;
#[doc = "Field `DCACHE_REJECT_INT_CLR` writer - The bit is used to clear interrupt by authentication fail."]
pub type DCACHE_REJECT_INT_CLR_W<'a> = crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 11>;
...
pub type DCACHE_SET_ILG_INT_CLR_W<'a> = crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 12>;
#[doc = "Field `MMU_ENTRY_FAULT_INT_CLR` writer - The bit is used to clear interrupt by mmu entry fault."]
pub type MMU_ENTRY_FAULT_INT_CLR_W<'a> =
    crate::BitWriter<'a, u32, CACHE_DBG_INT_CLR_SPEC, bool, 13>;
impl W {
