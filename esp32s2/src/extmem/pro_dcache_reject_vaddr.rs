...
pub struct PRO_DCACHE_CPU_VADDR_R(crate::FieldReader<u32, u32>);
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_reject_vaddr]
(index.html) module"]
pub struct PRO_DCACHE_REJECT_VADDR_SPEC;
impl crate::RegisterSpec for PRO_DCACHE_REJECT_VADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dcache_reject_vaddr::R]
(R) reader structure"]
