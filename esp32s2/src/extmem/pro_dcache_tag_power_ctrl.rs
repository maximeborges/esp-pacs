...
pub struct PRO_DCACHE_TAG_MEM_FORCE_ON_R(crate::FieldReader<bool, bool>);
impl PRO_DCACHE_TAG_MEM_FORCE_ON_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        PRO_DCACHE_TAG_MEM_FORCE_ON_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_DCACHE_TAG_MEM_FORCE_ON_R {
...
pub struct PRO_DCACHE_TAG_MEM_FORCE_ON_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_DCACHE_TAG_MEM_FORCE_ON_W<'a> {
...
pub struct PRO_DCACHE_TAG_MEM_FORCE_PD_R(crate::FieldReader<bool, bool>);
impl PRO_DCACHE_TAG_MEM_FORCE_PD_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        PRO_DCACHE_TAG_MEM_FORCE_PD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_DCACHE_TAG_MEM_FORCE_PD_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct PRO_DCACHE_TAG_MEM_FORCE_PD_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_DCACHE_TAG_MEM_FORCE_PD_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct PRO_DCACHE_TAG_MEM_FORCE_PU_R(crate::FieldReader<bool, bool>);
impl PRO_DCACHE_TAG_MEM_FORCE_PU_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        PRO_DCACHE_TAG_MEM_FORCE_PU_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_DCACHE_TAG_MEM_FORCE_PU_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct PRO_DCACHE_TAG_MEM_FORCE_PU_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_DCACHE_TAG_MEM_FORCE_PU_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn pro_dcache_tag_mem_force_on(&self) -> PRO_DCACHE_TAG_MEM_FORCE_ON_R {
        PRO_DCACHE_TAG_MEM_FORCE_ON_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn pro_dcache_tag_mem_force_pd(&self) -> PRO_DCACHE_TAG_MEM_FORCE_PD_R {
        PRO_DCACHE_TAG_MEM_FORCE_PD_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    ...
    pub fn pro_dcache_tag_mem_force_pu(&self) -> PRO_DCACHE_TAG_MEM_FORCE_PU_R {
        PRO_DCACHE_TAG_MEM_FORCE_PU_R::new(((self.bits >> 2) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - The bit is used to close clock gating of dcache tag memory. 1: close gating, 0: open clock gating."]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_tag_power_ctrl]
(index.html) module"]
pub struct PRO_DCACHE_TAG_POWER_CTRL_SPEC;
impl crate::RegisterSpec for PRO_DCACHE_TAG_POWER_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dcache_tag_power_ctrl::R]
(R) reader structure"]
impl crate::Readable for PRO_DCACHE_TAG_POWER_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dcache_tag_power_ctrl::W]
(W) writer structure"]
