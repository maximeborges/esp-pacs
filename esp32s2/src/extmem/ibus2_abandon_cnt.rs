...
pub struct IBUS2_ABANDON_CNT_R(crate::FieldReader<u16, u16>);
impl IBUS2_ABANDON_CNT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        IBUS2_ABANDON_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IBUS2_ABANDON_CNT_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ibus2_abandon_cnt]
(index.html) module"]
pub struct IBUS2_ABANDON_CNT_SPEC;
impl crate::RegisterSpec for IBUS2_ABANDON_CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ibus2_abandon_cnt::R]
(R) reader structure"]
