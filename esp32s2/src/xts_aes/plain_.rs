...
pub struct PLAIN_0_R(crate::FieldReader<u32, u32>);
impl PLAIN_0_R {
    #[inline(always)]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [plain_]
(index.html) module"]
pub struct PLAIN__SPEC;
impl crate::RegisterSpec for PLAIN__SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [plain_::R]
(R) reader structure"]
impl crate::Readable for PLAIN__SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [plain_::W]
(W) writer structure"]
