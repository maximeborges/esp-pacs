...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_gpio_interrupt_pro_nmi_map]
(index.html) module"]
pub struct PRO_GPIO_INTERRUPT_PRO_NMI_MAP_SPEC;
impl crate::RegisterSpec for PRO_GPIO_INTERRUPT_PRO_NMI_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_gpio_interrupt_pro_nmi_map::R]
(R) reader structure"]
impl crate::Readable for PRO_GPIO_INTERRUPT_PRO_NMI_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_gpio_interrupt_pro_nmi_map::W]
(W) writer structure"]
