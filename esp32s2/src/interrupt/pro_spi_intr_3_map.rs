...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_spi_intr_3_map]
(index.html) module"]
pub struct PRO_SPI_INTR_3_MAP_SPEC;
impl crate::RegisterSpec for PRO_SPI_INTR_3_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_spi_intr_3_map::R]
(R) reader structure"]
impl crate::Readable for PRO_SPI_INTR_3_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_spi_intr_3_map::W]
(W) writer structure"]
