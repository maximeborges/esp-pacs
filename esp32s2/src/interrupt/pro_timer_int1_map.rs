...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_timer_int1_map]
(index.html) module"]
pub struct PRO_TIMER_INT1_MAP_SPEC;
impl crate::RegisterSpec for PRO_TIMER_INT1_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_timer_int1_map::R]
(R) reader structure"]
impl crate::Readable for PRO_TIMER_INT1_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_timer_int1_map::W]
(W) writer structure"]
