...
pub struct PRO_SYSTIMER_TARGET0_INT_MAP_R(crate::FieldReader<u8, u8>);
impl PRO_SYSTIMER_TARGET0_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PRO_SYSTIMER_TARGET0_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_SYSTIMER_TARGET0_INT_MAP_R {
...
pub struct PRO_SYSTIMER_TARGET0_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_SYSTIMER_TARGET0_INT_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - This register is used to map SYSTIMER_TARGET0_INT interrupt signal to one of the CPU interrupts."]
    #[inline(always)]
    pub fn pro_systimer_target0_int_map(&mut self) -> PRO_SYSTIMER_TARGET0_INT_MAP_W {
        PRO_SYSTIMER_TARGET0_INT_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_systimer_target0_int_map]
(index.html) module"]
pub struct PRO_SYSTIMER_TARGET0_INT_MAP_SPEC;
impl crate::RegisterSpec for PRO_SYSTIMER_TARGET0_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_systimer_target0_int_map::R]
(R) reader structure"]
impl crate::Readable for PRO_SYSTIMER_TARGET0_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_systimer_target0_int_map::W]
(W) writer structure"]
