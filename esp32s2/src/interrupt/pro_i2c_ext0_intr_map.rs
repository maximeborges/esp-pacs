...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_i2c_ext0_intr_map]
(index.html) module"]
pub struct PRO_I2C_EXT0_INTR_MAP_SPEC;
impl crate::RegisterSpec for PRO_I2C_EXT0_INTR_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_i2c_ext0_intr_map::R]
(R) reader structure"]
impl crate::Readable for PRO_I2C_EXT0_INTR_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_i2c_ext0_intr_map::W]
(W) writer structure"]
