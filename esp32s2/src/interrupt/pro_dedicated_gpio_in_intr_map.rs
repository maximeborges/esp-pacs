...
pub struct PRO_DEDICATED_GPIO_IN_INTR_MAP_R(crate::FieldReader<u8, u8>);
impl PRO_DEDICATED_GPIO_IN_INTR_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PRO_DEDICATED_GPIO_IN_INTR_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_DEDICATED_GPIO_IN_INTR_MAP_R {
...
pub struct PRO_DEDICATED_GPIO_IN_INTR_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_DEDICATED_GPIO_IN_INTR_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - This register is used to map DEDICATED_GPIO_IN_INTR interrupt signal to one of the CPU interrupts."]
    #[inline(always)]
    pub fn pro_dedicated_gpio_in_intr_map(&mut self) -> PRO_DEDICATED_GPIO_IN_INTR_MAP_W {
        PRO_DEDICATED_GPIO_IN_INTR_MAP_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dedicated_gpio_in_intr_map]
(index.html) module"]
pub struct PRO_DEDICATED_GPIO_IN_INTR_MAP_SPEC;
impl crate::RegisterSpec for PRO_DEDICATED_GPIO_IN_INTR_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dedicated_gpio_in_intr_map::R]
(R) reader structure"]
impl crate::Readable for PRO_DEDICATED_GPIO_IN_INTR_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dedicated_gpio_in_intr_map::W]
(W) writer structure"]
