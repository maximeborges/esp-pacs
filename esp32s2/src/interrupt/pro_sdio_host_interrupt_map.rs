...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_sdio_host_interrupt_map]
(index.html) module"]
pub struct PRO_SDIO_HOST_INTERRUPT_MAP_SPEC;
impl crate::RegisterSpec for PRO_SDIO_HOST_INTERRUPT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_sdio_host_interrupt_map::R]
(R) reader structure"]
impl crate::Readable for PRO_SDIO_HOST_INTERRUPT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_sdio_host_interrupt_map::W]
(W) writer structure"]
