...
pub struct TIMER_LOAD_HI_R(crate::FieldReader<u32, u32>);
impl TIMER_LOAD_HI_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TIMER_LOAD_HI_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIMER_LOAD_HI_R {
...
pub struct TIMER_LOAD_HI_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMER_LOAD_HI_W<'a> {
...
#[doc = "`read()` method returns [load_hi::R]
(R) reader structure"]
impl crate::Readable for LOAD_HI_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [load_hi::W]
(W) writer structure"]
