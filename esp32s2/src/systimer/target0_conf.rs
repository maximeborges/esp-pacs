...
pub type TARGET0_PERIOD_W<'a> = crate::FieldWriter<'a, u32, TARGET0_CONF_SPEC, u32, u32, 30, 0>;
...
pub type TARGET0_WORK_EN_W<'a> = crate::BitWriter<'a, u32, TARGET0_CONF_SPEC, bool, 31>;
impl R {
