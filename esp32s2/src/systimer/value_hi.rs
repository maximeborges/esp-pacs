...
pub struct TIMER_VALUE_HI_R(crate::FieldReader<u32, u32>);
impl TIMER_VALUE_HI_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TIMER_VALUE_HI_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIMER_VALUE_HI_R {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [value_hi]
(index.html) module"]
pub struct VALUE_HI_SPEC;
impl crate::RegisterSpec for VALUE_HI_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [value_hi::R]
(R) reader structure"]
