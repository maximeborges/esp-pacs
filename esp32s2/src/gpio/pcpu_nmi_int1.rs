...
pub struct PROCPU_NMI1_INT_R(crate::FieldReader<u32, u32>);
impl PROCPU_NMI1_INT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PROCPU_NMI1_INT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PROCPU_NMI1_INT_R {
