...
impl SAR2_PATT_TAB4_R {
    ...
    pub(crate) fn new(bits: u32) -> Self {
        SAR2_PATT_TAB4_R(crate::FieldReader::new(bits))
    }
}
...
pub struct SAR2_PATT_TAB4_W<'a> {
    w: &'a mut W,
}
impl<'a> SAR2_PATT_TAB4_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - Item 12 ~ 15 for pattern table 2 (each item one byte)"]
    #[inline(always)]
    pub fn sar2_patt_tab4(&mut self) -> SAR2_PATT_TAB4_W {
        SAR2_PATT_TAB4_W { w: self }
    }
