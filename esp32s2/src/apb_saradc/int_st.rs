...
impl ADC2_THRES_INT_ST_R {
    ...
    pub(crate) fn new(bits: bool) -> Self {
        ADC2_THRES_INT_ST_R(crate::FieldReader::new(bits))
    }
}
...
impl ADC1_THRES_INT_ST_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        ADC1_THRES_INT_ST_R(crate::FieldReader::new(bits))
    }
}
