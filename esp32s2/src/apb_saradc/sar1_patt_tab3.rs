...
pub struct SAR1_PATT_TAB3_R(crate::FieldReader<u32, u32>);
impl SAR1_PATT_TAB3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SAR1_PATT_TAB3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SAR1_PATT_TAB3_R {
...
pub struct SAR1_PATT_TAB3_W<'a> {
    w: &'a mut W,
}
impl<'a> SAR1_PATT_TAB3_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - Item 8 ~ 11 for pattern table 1 (each item one byte)"]
    #[inline(always)]
    pub fn sar1_patt_tab3(&mut self) -> SAR1_PATT_TAB3_W {
        SAR1_PATT_TAB3_W { w: self }
    }
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sar1_patt_tab3]
(index.html) module"]
pub struct SAR1_PATT_TAB3_SPEC;
impl crate::RegisterSpec for SAR1_PATT_TAB3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sar1_patt_tab3::R]
(R) reader structure"]
impl crate::Readable for SAR1_PATT_TAB3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sar1_patt_tab3::W]
(W) writer structure"]
