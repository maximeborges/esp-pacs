...
pub struct SCL_MAIN_ST_TO_R(crate::FieldReader<u32, u32>);
impl SCL_MAIN_ST_TO_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SCL_MAIN_ST_TO_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCL_MAIN_ST_TO_R {
...
pub struct SCL_MAIN_ST_TO_W<'a> {
    w: &'a mut W,
}
impl<'a> SCL_MAIN_ST_TO_W<'a> {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [scl_main_st_time_out]
(index.html) module"]
pub struct SCL_MAIN_ST_TIME_OUT_SPEC;
impl crate::RegisterSpec for SCL_MAIN_ST_TIME_OUT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [scl_main_st_time_out::R]
(R) reader structure"]
impl crate::Readable for SCL_MAIN_ST_TIME_OUT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [scl_main_st_time_out::W]
(W) writer structure"]
