...
pub type SCL_FILTER_THRES_W<'a> = crate::FieldWriter<'a, u32, SCL_FILTER_CFG_SPEC, u8, u8, 4, 0>;
...
pub type SCL_FILTER_EN_W<'a> = crate::BitWriter<'a, u32, SCL_FILTER_CFG_SPEC, bool, 4>;
impl R {
