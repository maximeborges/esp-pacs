...
pub type TO_GPIO_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD3_SPEC, bool, 12>;
...
pub type DAC_W<'a> = crate::FieldWriter<'a, u32, TOUCH_PAD3_SPEC, u8, u8, 3, 23>;
...
pub type HOLD_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD3_SPEC, bool, 31>;
impl R {
