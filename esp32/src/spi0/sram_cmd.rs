...
pub type SRAM_DIO_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 0>;
...
pub type SRAM_QIO_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 1>;
...
pub type SRAM_RSTIO_W<'a> = crate::BitWriter<'a, u32, SRAM_CMD_SPEC, bool, 4>;
impl R {
