...
pub type SLV_RDSTA_DUMMY_CYCLELEN_W<'a> = crate::FieldWriter<'a, u32, SLAVE2_SPEC, u8, u8, 8, 0>;
...
pub type SLV_WRSTA_DUMMY_CYCLELEN_W<'a> = crate::FieldWriter<'a, u32, SLAVE2_SPEC, u8, u8, 8, 8>;
...
pub type SLV_RDBUF_DUMMY_CYCLELEN_W<'a> = crate::FieldWriter<'a, u32, SLAVE2_SPEC, u8, u8, 8, 16>;
...
pub type SLV_WRBUF_DUMMY_CYCLELEN_W<'a> = crate::FieldWriter<'a, u32, SLAVE2_SPEC, u8, u8, 8, 24>;
impl R {
