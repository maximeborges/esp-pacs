...
pub type T_PP_TIME_W<'a> = crate::FieldWriter<'a, u32, EXT0_SPEC, u16, u16, 12, 0>;
...
pub type T_PP_SHIFT_W<'a> = crate::FieldWriter<'a, u32, EXT0_SPEC, u8, u8, 4, 16>;
...
pub type T_PP_ENA_W<'a> = crate::BitWriter<'a, u32, EXT0_SPEC, bool, 31>;
impl R {
