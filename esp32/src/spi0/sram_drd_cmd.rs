...
pub type CACHE_SRAM_USR_RD_CMD_VALUE_W<'a> =
    crate::FieldWriter<'a, u32, SRAM_DRD_CMD_SPEC, u16, u16, 16, 0>;
...
pub type CACHE_SRAM_USR_RD_CMD_BITLEN_W<'a> =
    crate::FieldWriter<'a, u32, SRAM_DRD_CMD_SPEC, u8, u8, 4, 28>;
impl R {
