...
pub struct FILTER_THRES_U1_R(crate::FieldReader<u16>);
...
pub struct FILTER_EN_U1_R(crate::FieldReader<bool>);
impl FILTER_EN_U1_R {
    #[inline(always)]
...
pub struct THR_ZERO_EN_U1_R(crate::FieldReader<bool>);
...
pub struct THR_H_LIM_EN_U1_R(crate::FieldReader<bool>);
...
pub struct THR_L_LIM_EN_U1_R(crate::FieldReader<bool>);
...
pub struct THR_THRES0_EN_U1_R(crate::FieldReader<bool>);
...
pub struct THR_THRES1_EN_U1_R(crate::FieldReader<bool>);
...
pub struct CH0_NEG_MODE_U1_R(crate::FieldReader<u8>);
...
pub struct CH0_POS_MODE_U1_R(crate::FieldReader<u8>);
...
pub struct CH0_HCTRL_MODE_U1_R(crate::FieldReader<u8>);
...
pub struct CH0_LCTRL_MODE_U1_R(crate::FieldReader<u8>);
...
pub struct CH1_NEG_MODE_U1_R(crate::FieldReader<u8>);
...
pub struct CH1_POS_MODE_U1_R(crate::FieldReader<u8>);
...
pub struct CH1_HCTRL_MODE_U1_R(crate::FieldReader<u8>);
...
pub struct CH1_LCTRL_MODE_U1_R(crate::FieldReader<u8>);
