...
pub struct RegisterBlock {
    ...
    #[doc = "0x14 - "]
    pub dma_out_status: crate::Reg<dma_out_status::DMA_OUT_STATUS_SPEC>,
    #[doc = "0x18 - "]
    pub dma_out_push: crate::Reg<dma_out_push::DMA_OUT_PUSH_SPEC>,
    #[doc = "0x1c - "]
    pub dma_in_status: crate::Reg<dma_in_status::DMA_IN_STATUS_SPEC>,
    #[doc = "0x20 - "]
    pub dma_in_pop: crate::Reg<dma_in_pop::DMA_IN_POP_SPEC>,
    #[doc = "0x24 - "]
    ...
    #[doc = "0x38 - "]
    pub dma_out_eof_des_addr: crate::Reg<dma_out_eof_des_addr::DMA_OUT_EOF_DES_ADDR_SPEC>,
    #[doc = "0x3c - "]
    pub dma_in_suc_eof_des_addr: crate::Reg<dma_in_suc_eof_des_addr::DMA_IN_SUC_EOF_DES_ADDR_SPEC>,
    #[doc = "0x40 - "]
    pub dma_in_err_eof_des_addr: crate::Reg<dma_in_err_eof_des_addr::DMA_IN_ERR_EOF_DES_ADDR_SPEC>,
    #[doc = "0x44 - "]
    pub dma_out_eof_bfr_des_addr:
        crate::Reg<dma_out_eof_bfr_des_addr::DMA_OUT_EOF_BFR_DES_ADDR_SPEC>,
    #[doc = "0x48 - "]
    pub ahb_test: crate::Reg<ahb_test::AHB_TEST_SPEC>,
    #[doc = "0x4c - "]
    pub dma_in_dscr: crate::Reg<dma_in_dscr::DMA_IN_DSCR_SPEC>,
    #[doc = "0x50 - "]
    pub dma_in_dscr_bf0: crate::Reg<dma_in_dscr_bf0::DMA_IN_DSCR_BF0_SPEC>,
    #[doc = "0x54 - "]
    pub dma_in_dscr_bf1: crate::Reg<dma_in_dscr_bf1::DMA_IN_DSCR_BF1_SPEC>,
    #[doc = "0x58 - "]
    pub dma_out_dscr: crate::Reg<dma_out_dscr::DMA_OUT_DSCR_SPEC>,
    #[doc = "0x5c - "]
    pub dma_out_dscr_bf0: crate::Reg<dma_out_dscr_bf0::DMA_OUT_DSCR_BF0_SPEC>,
    #[doc = "0x60 - "]
    pub dma_out_dscr_bf1: crate::Reg<dma_out_dscr_bf1::DMA_OUT_DSCR_BF1_SPEC>,
    #[doc = "0x64 - "]
...
#[doc = ""]
pub mod int_clr;
#[doc = "DMA_OUT_STATUS register accessor: an alias for `Reg<DMA_OUT_STATUS_SPEC>`"]
pub type DMA_OUT_STATUS = crate::Reg<dma_out_status::DMA_OUT_STATUS_SPEC>;
#[doc = ""]
pub mod dma_out_status;
#[doc = "DMA_OUT_PUSH register accessor: an alias for `Reg<DMA_OUT_PUSH_SPEC>`"]
pub type DMA_OUT_PUSH = crate::Reg<dma_out_push::DMA_OUT_PUSH_SPEC>;
#[doc = ""]
pub mod dma_out_push;
#[doc = "DMA_IN_STATUS register accessor: an alias for `Reg<DMA_IN_STATUS_SPEC>`"]
pub type DMA_IN_STATUS = crate::Reg<dma_in_status::DMA_IN_STATUS_SPEC>;
#[doc = ""]
pub mod dma_in_status;
#[doc = "DMA_IN_POP register accessor: an alias for `Reg<DMA_IN_POP_SPEC>`"]
...
#[doc = ""]
pub mod state1;
#[doc = "DMA_OUT_EOF_DES_ADDR register accessor: an alias for `Reg<DMA_OUT_EOF_DES_ADDR_SPEC>`"]
pub type DMA_OUT_EOF_DES_ADDR = crate::Reg<dma_out_eof_des_addr::DMA_OUT_EOF_DES_ADDR_SPEC>;
#[doc = ""]
pub mod dma_out_eof_des_addr;
#[doc = "DMA_IN_SUC_EOF_DES_ADDR register accessor: an alias for `Reg<DMA_IN_SUC_EOF_DES_ADDR_SPEC>`"]
...
#[doc = "DMA_IN_ERR_EOF_DES_ADDR register accessor: an alias for `Reg<DMA_IN_ERR_EOF_DES_ADDR_SPEC>`"]
...
#[doc = "DMA_OUT_EOF_BFR_DES_ADDR register accessor: an alias for `Reg<DMA_OUT_EOF_BFR_DES_ADDR_SPEC>`"]
...
#[doc = ""]
pub mod ahb_test;
#[doc = "DMA_IN_DSCR register accessor: an alias for `Reg<DMA_IN_DSCR_SPEC>`"]
pub type DMA_IN_DSCR = crate::Reg<dma_in_dscr::DMA_IN_DSCR_SPEC>;
#[doc = ""]
pub mod dma_in_dscr;
#[doc = "DMA_IN_DSCR_BF0 register accessor: an alias for `Reg<DMA_IN_DSCR_BF0_SPEC>`"]
pub type DMA_IN_DSCR_BF0 = crate::Reg<dma_in_dscr_bf0::DMA_IN_DSCR_BF0_SPEC>;
#[doc = ""]
pub mod dma_in_dscr_bf0;
#[doc = "DMA_IN_DSCR_BF1 register accessor: an alias for `Reg<DMA_IN_DSCR_BF1_SPEC>`"]
pub type DMA_IN_DSCR_BF1 = crate::Reg<dma_in_dscr_bf1::DMA_IN_DSCR_BF1_SPEC>;
#[doc = ""]
pub mod dma_in_dscr_bf1;
#[doc = "DMA_OUT_DSCR register accessor: an alias for `Reg<DMA_OUT_DSCR_SPEC>`"]
pub type DMA_OUT_DSCR = crate::Reg<dma_out_dscr::DMA_OUT_DSCR_SPEC>;
#[doc = ""]
pub mod dma_out_dscr;
#[doc = "DMA_OUT_DSCR_BF0 register accessor: an alias for `Reg<DMA_OUT_DSCR_BF0_SPEC>`"]
pub type DMA_OUT_DSCR_BF0 = crate::Reg<dma_out_dscr_bf0::DMA_OUT_DSCR_BF0_SPEC>;
#[doc = ""]
pub mod dma_out_dscr_bf0;
#[doc = "DMA_OUT_DSCR_BF1 register accessor: an alias for `Reg<DMA_OUT_DSCR_BF1_SPEC>`"]
