...
pub type USER_ID_FN2_W<'a> = crate::FieldWriter<'a, u32, CFG_DATA16_SPEC, u16, u16, 16, 0>;
#[doc = "Field `DEVICE_ID_FN2` reader - "]
pub type DEVICE_ID_FN2_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DEVICE_ID_FN2` writer - "]
pub type DEVICE_ID_FN2_W<'a> = crate::FieldWriter<'a, u32, CFG_DATA16_SPEC, u16, u16, 16, 16>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
