...
pub struct RegisterBlock {
    ...
    #[doc = "0x84 - "]
    pub host_slchost_win_cmd: crate::Reg<host_slchost_win_cmd::HOST_SLCHOST_WIN_CMD_SPEC>,
    #[doc = "0x88 - "]
...
#[doc = "HOST_SLCHOST_WIN_CMD register accessor: an alias for `Reg<HOST_SLCHOST_WIN_CMD_SPEC>`"]
