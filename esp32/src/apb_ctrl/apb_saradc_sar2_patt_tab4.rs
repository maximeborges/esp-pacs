...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [apb_saradc_sar2_patt_tab4]
(index.html) module"]
pub struct APB_SARADC_SAR2_PATT_TAB4_SPEC;
impl crate::RegisterSpec for APB_SARADC_SAR2_PATT_TAB4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [apb_saradc_sar2_patt_tab4::R]
(R) reader structure"]
impl crate::Readable for APB_SARADC_SAR2_PATT_TAB4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [apb_saradc_sar2_patt_tab4::W]
(W) writer structure"]
