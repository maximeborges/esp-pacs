...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [apb_saradc_sar1_patt_tab2]
(index.html) module"]
pub struct APB_SARADC_SAR1_PATT_TAB2_SPEC;
impl crate::RegisterSpec for APB_SARADC_SAR1_PATT_TAB2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [apb_saradc_sar1_patt_tab2::R]
(R) reader structure"]
impl crate::Readable for APB_SARADC_SAR1_PATT_TAB2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [apb_saradc_sar1_patt_tab2::W]
(W) writer structure"]
