...
pub type CHIP_VER_DIS_APP_CPU_W<'a> = crate::BitWriter<'a, u32, BLK0_WDATA3_SPEC, bool, 0>;
#[doc = "Field `CHIP_VER_DIS_BT` reader - "]
pub type CHIP_VER_DIS_BT_R = crate::BitReader<bool>;
#[doc = "Field `CHIP_VER_DIS_BT` writer - "]
pub type CHIP_VER_DIS_BT_W<'a> = crate::BitWriter<'a, u32, BLK0_WDATA3_SPEC, bool, 1>;
...
pub type CHIP_VER_DIS_CACHE_W<'a> = crate::BitWriter<'a, u32, BLK0_WDATA3_SPEC, bool, 3>;
...
pub type SPI_PAD_CONFIG_HD_W<'a> = crate::FieldWriter<'a, u32, BLK0_WDATA3_SPEC, u8, u8, 5, 4>;
...
pub type CHIP_VER_PKG_W<'a> = crate::FieldWriter<'a, u32, BLK0_WDATA3_SPEC, u8, u8, 3, 9>;
...
pub type CHIP_CPU_FREQ_LOW_W<'a> = crate::BitWriter<'a, u32, BLK0_WDATA3_SPEC, bool, 12>;
...
pub type CHIP_CPU_FREQ_RATED_W<'a> = crate::BitWriter<'a, u32, BLK0_WDATA3_SPEC, bool, 13>;
...
pub type BLK3_PART_RESERVE_W<'a> = crate::BitWriter<'a, u32, BLK0_WDATA3_SPEC, bool, 14>;
#[doc = "Field `CHIP_VER_REV1` reader - "]
pub type CHIP_VER_REV1_R = crate::BitReader<bool>;
#[doc = "Field `CHIP_VER_REV1` writer - "]
pub type CHIP_VER_REV1_W<'a> = crate::BitWriter<'a, u32, BLK0_WDATA3_SPEC, bool, 15>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
