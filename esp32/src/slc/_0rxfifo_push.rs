...
pub type SLC0_RXFIFO_WDATA_W<'a> = crate::FieldWriter<'a, u32, _0RXFIFO_PUSH_SPEC, u16, u16, 9, 0>;
#[doc = "Field `SLC0_RXFIFO_PUSH` reader - "]
pub type SLC0_RXFIFO_PUSH_R = crate::BitReader<bool>;
#[doc = "Field `SLC0_RXFIFO_PUSH` writer - "]
pub type SLC0_RXFIFO_PUSH_W<'a> = crate::BitWriter<'a, u32, _0RXFIFO_PUSH_SPEC, bool, 16>;
impl R {
    #[doc = "Bits 0:8"]
    #[inline(always)]
