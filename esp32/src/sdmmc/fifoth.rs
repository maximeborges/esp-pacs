...
pub type RX_WMARK_W<'a> = crate::FieldWriter<'a, u32, FIFOTH_SPEC, u16, u16, 11, 16>;
...
pub type DMA_MULTIPLE_TRANSACTION_SIZE_W<'a> =
    crate::FieldWriter<'a, u32, FIFOTH_SPEC, u8, u8, 3, 28>;
impl R {
