...
pub type CCLKIN_EDGE_DRV_SEL_W<'a> = crate::FieldWriter<'a, u32, CLK_EDGE_SEL_SPEC, u8, u8, 3, 0>;
...
pub type CCLKIN_EDGE_SAM_SEL_W<'a> = crate::FieldWriter<'a, u32, CLK_EDGE_SEL_SPEC, u8, u8, 3, 3>;
...
pub type CCLKIN_EDGE_SLF_SEL_W<'a> = crate::FieldWriter<'a, u32, CLK_EDGE_SEL_SPEC, u8, u8, 3, 6>;
...
pub type CCLLKIN_EDGE_H_W<'a> = crate::FieldWriter<'a, u32, CLK_EDGE_SEL_SPEC, u8, u8, 4, 9>;
...
pub type CCLLKIN_EDGE_L_W<'a> = crate::FieldWriter<'a, u32, CLK_EDGE_SEL_SPEC, u8, u8, 4, 13>;
...
pub type CCLLKIN_EDGE_N_W<'a> = crate::FieldWriter<'a, u32, CLK_EDGE_SEL_SPEC, u8, u8, 4, 17>;
...
pub type ESDIO_MODE_W<'a> = crate::BitWriter<'a, u32, CLK_EDGE_SEL_SPEC, bool, 21>;
...
pub type ESD_MODE_W<'a> = crate::BitWriter<'a, u32, CLK_EDGE_SEL_SPEC, bool, 22>;
...
pub type CCLK_EN_W<'a> = crate::BitWriter<'a, u32, CLK_EDGE_SEL_SPEC, bool, 23>;
impl R {
