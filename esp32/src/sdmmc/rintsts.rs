...
pub type INT_STATUS_RAW_W<'a> = crate::FieldWriter<'a, u32, RINTSTS_SPEC, u16, u16, 16, 0>;
...
pub type SDIO_INTERRUPT_RAW_W<'a> = crate::FieldWriter<'a, u32, RINTSTS_SPEC, u8, u8, 2, 16>;
impl R {
