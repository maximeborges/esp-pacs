...
pub type INDEX_W<'a> = crate::FieldWriter<'a, u32, CMD_SPEC, u8, u8, 6, 0>;
...
pub type CARD_NUMBER_W<'a> = crate::FieldWriter<'a, u32, CMD_SPEC, u8, u8, 5, 16>;
...
pub type USE_HOLE_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 29>;
