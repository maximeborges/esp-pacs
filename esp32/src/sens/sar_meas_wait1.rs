...
pub type SAR_AMP_WAIT1_W<'a> = crate::FieldWriter<'a, u32, SAR_MEAS_WAIT1_SPEC, u16, u16, 16, 0>;
#[doc = "Field `SAR_AMP_WAIT2` reader - "]
pub type SAR_AMP_WAIT2_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SAR_AMP_WAIT2` writer - "]
pub type SAR_AMP_WAIT2_W<'a> = crate::FieldWriter<'a, u32, SAR_MEAS_WAIT1_SPEC, u16, u16, 16, 16>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
