...
#[doc = "Field `HPOINT_LSCH4` reader - The output value changes to high when lstimerx(x=\\[0 3\\]
) selected by low speed channel4 has reached reg_hpoint_lsch4\\[19:0\\]
"]
...
#[doc = "Field `HPOINT_LSCH4` writer - The output value changes to high when lstimerx(x=\\[0 3\\]
) selected by low speed channel4 has reached reg_hpoint_lsch4\\[19:0\\]
"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lsch4_hpoint]
(index.html) module"]
pub struct LSCH4_HPOINT_SPEC;
impl crate::RegisterSpec for LSCH4_HPOINT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lsch4_hpoint::R]
(R) reader structure"]
impl crate::Readable for LSCH4_HPOINT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lsch4_hpoint::W]
(W) writer structure"]
