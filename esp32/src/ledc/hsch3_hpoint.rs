...
#[doc = "Field `HPOINT_HSCH3` reader - The output value changes to high when htimerx(x=\\[0 3\\]
...
#[doc = "Field `HPOINT_HSCH3` writer - The output value changes to high when htimerx(x=\\[0 3\\]
) selected by high speed channel3 has reached reg_hpoint_hsch3\\[19:0\\]
"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hsch3_hpoint]
(index.html) module"]
pub struct HSCH3_HPOINT_SPEC;
impl crate::RegisterSpec for HSCH3_HPOINT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hsch3_hpoint::R]
(R) reader structure"]
impl crate::Readable for HSCH3_HPOINT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [hsch3_hpoint::W]
(W) writer structure"]
