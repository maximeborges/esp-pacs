...
#[doc = "Field `HPOINT_HSCH2` reader - The output value changes to high when htimerx(x=\\[0 3\\]
) selected by high speed channel2 has reached reg_hpoint_hsch2\\[19:0\\]
"]
...
#[doc = "Field `HPOINT_HSCH2` writer - The output value changes to high when htimerx(x=\\[0 3\\]
) selected by high speed channel2 has reached reg_hpoint_hsch2\\[19:0\\]
"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hsch2_hpoint]
(index.html) module"]
pub struct HSCH2_HPOINT_SPEC;
impl crate::RegisterSpec for HSCH2_HPOINT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hsch2_hpoint::R]
(R) reader structure"]
impl crate::Readable for HSCH2_HPOINT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [hsch2_hpoint::W]
(W) writer structure"]
