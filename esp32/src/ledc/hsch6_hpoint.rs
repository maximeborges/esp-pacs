...
#[doc = "Field `HPOINT_HSCH6` reader - The output value changes to high when htimerx(x=\\[0 3\\]
) selected by high speed channel6 has reached reg_hpoint_hsch6\\[19:0\\]
"]
...
#[doc = "Field `HPOINT_HSCH6` writer - The output value changes to high when htimerx(x=\\[0 3\\]
) selected by high speed channel6 has reached reg_hpoint_hsch6\\[19:0\\]
"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hsch6_hpoint]
(index.html) module"]
pub struct HSCH6_HPOINT_SPEC;
impl crate::RegisterSpec for HSCH6_HPOINT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hsch6_hpoint::R]
(R) reader structure"]
impl crate::Readable for HSCH6_HPOINT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [hsch6_hpoint::W]
(W) writer structure"]
