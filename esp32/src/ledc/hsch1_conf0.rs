...
pub struct TIMER_SEL_HSCH1_R(crate::FieldReader<u8>);
...
pub struct SIG_OUT_EN_HSCH1_R(crate::FieldReader<bool>);
...
pub struct IDLE_LV_HSCH1_R(crate::FieldReader<bool>);
