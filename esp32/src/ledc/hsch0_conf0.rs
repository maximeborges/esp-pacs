...
pub struct TIMER_SEL_HSCH0_R(crate::FieldReader<u8>);
...
pub struct SIG_OUT_EN_HSCH0_R(crate::FieldReader<bool>);
...
pub struct IDLE_LV_HSCH0_R(crate::FieldReader<bool>);
