...
#[doc = "Register `LSCH3_DUTY_R` writer"]
pub struct W(crate::W<LSCH3_DUTY_R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LSCH3_DUTY_R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LSCH3_DUTY_R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LSCH3_DUTY_R_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lsch3_duty_r]
(index.html) module"]
pub struct LSCH3_DUTY_R_SPEC;
impl crate::RegisterSpec for LSCH3_DUTY_R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lsch3_duty_r::R]
(R) reader structure"]
impl crate::Readable for LSCH3_DUTY_R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lsch3_duty_r::W]
(W) writer structure"]
impl crate::Writable for LSCH3_DUTY_R_SPEC {
    type Writer = W;
}
