...
#[doc = "Field `HPOINT_LSCH3` reader - The output value changes to high when lstimerx(x=\\[0 3\\]
) selected by low speed channel3 has reached reg_hpoint_lsch3\\[19:0\\]
"]
...
#[doc = "Field `HPOINT_LSCH3` writer - The output value changes to high when lstimerx(x=\\[0 3\\]
) selected by low speed channel3 has reached reg_hpoint_lsch3\\[19:0\\]
"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lsch3_hpoint]
(index.html) module"]
pub struct LSCH3_HPOINT_SPEC;
impl crate::RegisterSpec for LSCH3_HPOINT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lsch3_hpoint::R]
(R) reader structure"]
impl crate::Readable for LSCH3_HPOINT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lsch3_hpoint::W]
(W) writer structure"]
