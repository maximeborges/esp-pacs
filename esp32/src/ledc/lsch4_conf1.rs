...
pub type DUTY_SCALE_LSCH4_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DUTY_SCALE_LSCH4` writer - This register controls the increase or decrease step scale for low speed channel4."]
pub type DUTY_SCALE_LSCH4_W<'a> = crate::FieldWriter<'a, u32, LSCH4_CONF1_SPEC, u16, u16, 10, 0>;
...
pub type DUTY_CYCLE_LSCH4_R = crate::FieldReader<u16, u16>;
...
pub type DUTY_CYCLE_LSCH4_W<'a> = crate::FieldWriter<'a, u32, LSCH4_CONF1_SPEC, u16, u16, 10, 10>;
...
pub type DUTY_NUM_LSCH4_R = crate::FieldReader<u16, u16>;
...
pub type DUTY_NUM_LSCH4_W<'a> = crate::FieldWriter<'a, u32, LSCH4_CONF1_SPEC, u16, u16, 10, 20>;
...
pub type DUTY_INC_LSCH4_R = crate::BitReader<bool>;
...
pub type DUTY_INC_LSCH4_W<'a> = crate::BitWriter<'a, u32, LSCH4_CONF1_SPEC, bool, 30>;
...
pub type DUTY_START_LSCH4_R = crate::BitReader<bool>;
...
pub type DUTY_START_LSCH4_W<'a> = crate::BitWriter<'a, u32, LSCH4_CONF1_SPEC, bool, 31>;
impl R {
    ...
    pub fn duty_inc_lsch4(&self) -> DUTY_INC_LSCH4_R {
        DUTY_INC_LSCH4_R::new(((self.bits >> 30) & 1) != 0)
    }
    ...
    pub fn duty_start_lsch4(&self) -> DUTY_START_LSCH4_R {
        DUTY_START_LSCH4_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:9 - This register controls the increase or decrease step scale for low speed channel4."]
