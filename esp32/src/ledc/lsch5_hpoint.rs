...
#[doc = "Field `HPOINT_LSCH5` reader - The output value changes to high when lstimerx(x=\\[0 3\\]
) selected by low speed channel5 has reached reg_hpoint_lsch5\\[19:0\\]
"]
...
#[doc = "Field `HPOINT_LSCH5` writer - The output value changes to high when lstimerx(x=\\[0 3\\]
) selected by low speed channel5 has reached reg_hpoint_lsch5\\[19:0\\]
"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lsch5_hpoint]
(index.html) module"]
pub struct LSCH5_HPOINT_SPEC;
impl crate::RegisterSpec for LSCH5_HPOINT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lsch5_hpoint::R]
(R) reader structure"]
impl crate::Readable for LSCH5_HPOINT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lsch5_hpoint::W]
(W) writer structure"]
