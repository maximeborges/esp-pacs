...
pub struct LSTIMER0_DUTY_RES_R(crate::FieldReader<u8>);
...
pub struct DIV_NUM_LSTIMER0_R(crate::FieldReader<u32>);
...
pub struct LSTIMER0_PAUSE_R(crate::FieldReader<bool>);
...
pub struct LSTIMER0_RST_R(crate::FieldReader<bool>);
impl LSTIMER0_RST_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct TICK_SEL_LSTIMER0_R(crate::FieldReader<bool>);
...
pub struct LSTIMER0_PARA_UP_R(crate::FieldReader<bool>);
...
pub struct LSTIMER0_LIM_R(crate::FieldReader<u8>);
impl LSTIMER0_LIM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
