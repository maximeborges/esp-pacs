...
#[doc = "Field `LSTIMER0_DUTY_RES` reader - This register controls the range of the counter in low speed timer0. the counter range is \\[0 2**reg_lstimer0_lim\\] the max bit width for counter is 20."]
pub type LSTIMER0_DUTY_RES_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LSTIMER0_DUTY_RES` writer - This register controls the range of the counter in low speed timer0. the counter range is \\[0 2**reg_lstimer0_lim\\] the max bit width for counter is 20."]
pub type LSTIMER0_DUTY_RES_W<'a> = crate::FieldWriter<'a, u32, LSTIMER0_CONF_SPEC, u8, u8, 5, 0>;
...
pub type DIV_NUM_LSTIMER0_R = crate::FieldReader<u32, u32>;
...
pub type DIV_NUM_LSTIMER0_W<'a> = crate::FieldWriter<'a, u32, LSTIMER0_CONF_SPEC, u32, u32, 18, 5>;
...
pub type LSTIMER0_PAUSE_W<'a> = crate::BitWriter<'a, u32, LSTIMER0_CONF_SPEC, bool, 23>;
...
pub type LSTIMER0_RST_W<'a> = crate::BitWriter<'a, u32, LSTIMER0_CONF_SPEC, bool, 24>;
...
pub type TICK_SEL_LSTIMER0_W<'a> = crate::BitWriter<'a, u32, LSTIMER0_CONF_SPEC, bool, 25>;
#[doc = "Field `LSTIMER0_PARA_UP` reader - Set this bit to update reg_div_num_lstime0 and reg_lstimer0_lim."]
pub type LSTIMER0_PARA_UP_R = crate::BitReader<bool>;
#[doc = "Field `LSTIMER0_PARA_UP` writer - Set this bit to update reg_div_num_lstime0 and reg_lstimer0_lim."]
pub type LSTIMER0_PARA_UP_W<'a> = crate::BitWriter<'a, u32, LSTIMER0_CONF_SPEC, bool, 26>;
#[doc = "Field `LSTIMER0_LIM` reader - "]
pub type LSTIMER0_LIM_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LSTIMER0_LIM` writer - "]
pub type LSTIMER0_LIM_W<'a> = crate::FieldWriter<'a, u32, LSTIMER0_CONF_SPEC, u8, u8, 5, 31>;
impl R {
    ...
    pub fn lstimer0_pause(&self) -> LSTIMER0_PAUSE_R {
        LSTIMER0_PAUSE_R::new(((self.bits >> 23) & 1) != 0)
    }
    ...
    pub fn lstimer0_rst(&self) -> LSTIMER0_RST_R {
        LSTIMER0_RST_R::new(((self.bits >> 24) & 1) != 0)
    }
    ...
    pub fn tick_sel_lstimer0(&self) -> TICK_SEL_LSTIMER0_R {
        TICK_SEL_LSTIMER0_R::new(((self.bits >> 25) & 1) != 0)
    }
    ...
    pub fn lstimer0_para_up(&self) -> LSTIMER0_PARA_UP_R {
        LSTIMER0_PARA_UP_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bits 31:35"]
    #[inline(always)]
