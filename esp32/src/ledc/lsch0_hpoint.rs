...
#[doc = "Field `HPOINT_LSCH0` reader - The output value changes to high when lstimerx(x=\\[0 3\\]
) selected by low speed channel0 has reached reg_hpoint_lsch0\\[19:0\\]
"]
...
#[doc = "Field `HPOINT_LSCH0` writer - The output value changes to high when lstimerx(x=\\[0 3\\]
) selected by low speed channel0 has reached reg_hpoint_lsch0\\[19:0\\]
"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lsch0_hpoint]
(index.html) module"]
pub struct LSCH0_HPOINT_SPEC;
impl crate::RegisterSpec for LSCH0_HPOINT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lsch0_hpoint::R]
(R) reader structure"]
impl crate::Readable for LSCH0_HPOINT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lsch0_hpoint::W]
(W) writer structure"]
