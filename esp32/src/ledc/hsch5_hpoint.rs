...
#[doc = "Field `HPOINT_HSCH5` reader - The output value changes to high when htimerx(x=\\[0 3\\]
) selected by high speed channel5 has reached reg_hpoint_hsch5\\[19:0\\]
"]
...
#[doc = "Field `HPOINT_HSCH5` writer - The output value changes to high when htimerx(x=\\[0 3\\]
) selected by high speed channel5 has reached reg_hpoint_hsch5\\[19:0\\]
"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hsch5_hpoint]
(index.html) module"]
pub struct HSCH5_HPOINT_SPEC;
impl crate::RegisterSpec for HSCH5_HPOINT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hsch5_hpoint::R]
(R) reader structure"]
impl crate::Readable for HSCH5_HPOINT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [hsch5_hpoint::W]
(W) writer structure"]
