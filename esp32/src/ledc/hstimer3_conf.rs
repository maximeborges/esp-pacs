...
pub struct HSTIMER3_DUTY_RES_R(crate::FieldReader<u8>);
...
pub struct DIV_NUM_HSTIMER3_R(crate::FieldReader<u32>);
...
pub struct HSTIMER3_PAUSE_R(crate::FieldReader<bool>);
...
pub struct HSTIMER3_RST_R(crate::FieldReader<bool>);
impl HSTIMER3_RST_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct TICK_SEL_HSTIMER3_R(crate::FieldReader<bool>);
...
pub struct HSTIMER3_LIM_R(crate::FieldReader<u8>);
impl HSTIMER3_LIM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
