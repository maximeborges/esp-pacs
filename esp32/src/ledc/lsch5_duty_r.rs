...
#[doc = "Register `LSCH5_DUTY_R` writer"]
pub struct W(crate::W<LSCH5_DUTY_R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LSCH5_DUTY_R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LSCH5_DUTY_R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LSCH5_DUTY_R_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lsch5_duty_r]
(index.html) module"]
pub struct LSCH5_DUTY_R_SPEC;
impl crate::RegisterSpec for LSCH5_DUTY_R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lsch5_duty_r::R]
(R) reader structure"]
impl crate::Readable for LSCH5_DUTY_R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lsch5_duty_r::W]
(W) writer structure"]
impl crate::Writable for LSCH5_DUTY_R_SPEC {
    type Writer = W;
}
