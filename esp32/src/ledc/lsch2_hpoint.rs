...
#[doc = "Field `HPOINT_LSCH2` reader - The output value changes to high when lstimerx(x=\\[0 3\\]
) selected by low speed channel2 has reached reg_hpoint_lsch2\\[19:0\\]
"]
...
#[doc = "Field `HPOINT_LSCH2` writer - The output value changes to high when lstimerx(x=\\[0 3\\]
) selected by low speed channel2 has reached reg_hpoint_lsch2\\[19:0\\]
"]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lsch2_hpoint]
(index.html) module"]
pub struct LSCH2_HPOINT_SPEC;
impl crate::RegisterSpec for LSCH2_HPOINT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lsch2_hpoint::R]
(R) reader structure"]
impl crate::Readable for LSCH2_HPOINT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lsch2_hpoint::W]
(W) writer structure"]
