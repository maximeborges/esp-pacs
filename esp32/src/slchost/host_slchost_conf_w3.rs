...
pub struct HOST_SLCHOST_CONF12_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF13_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF14_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF15_R(crate::FieldReader<u8>);
