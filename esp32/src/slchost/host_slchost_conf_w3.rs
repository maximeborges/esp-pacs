...
pub type HOST_SLCHOST_CONF12_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W3_SPEC, u8, u8, 8, 0>;
...
pub type HOST_SLCHOST_CONF13_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W3_SPEC, u8, u8, 8, 8>;
...
pub type HOST_SLCHOST_CONF14_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W3_SPEC, u8, u8, 8, 16>;
...
pub type HOST_SLCHOST_CONF15_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W3_SPEC, u8, u8, 8, 24>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
