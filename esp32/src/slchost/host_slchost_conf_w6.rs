...
pub struct HOST_SLCHOST_CONF24_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF25_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF26_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF27_R(crate::FieldReader<u8>);
