...
pub type HOST_SLCHOST_CONF24_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W6_SPEC, u8, u8, 8, 0>;
...
pub type HOST_SLCHOST_CONF25_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W6_SPEC, u8, u8, 8, 8>;
...
pub type HOST_SLCHOST_CONF26_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W6_SPEC, u8, u8, 8, 16>;
...
pub type HOST_SLCHOST_CONF27_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W6_SPEC, u8, u8, 8, 24>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
