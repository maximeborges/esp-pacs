...
pub type HOST_SLCHOST_CONF48_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W12_SPEC, u8, u8, 8, 0>;
...
pub type HOST_SLCHOST_CONF49_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W12_SPEC, u8, u8, 8, 8>;
...
pub type HOST_SLCHOST_CONF50_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W12_SPEC, u8, u8, 8, 16>;
...
pub type HOST_SLCHOST_CONF51_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W12_SPEC, u8, u8, 8, 24>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
