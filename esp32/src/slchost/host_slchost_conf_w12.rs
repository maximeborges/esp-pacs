...
pub struct HOST_SLCHOST_CONF48_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF49_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF50_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF51_R(crate::FieldReader<u8>);
