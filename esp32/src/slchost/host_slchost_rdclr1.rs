...
pub type HOST_SLCHOST_SLC1_BIT7_CLRADDR_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_RDCLR1_SPEC, u16, u16, 9, 0>;
...
pub type HOST_SLCHOST_SLC1_BIT6_CLRADDR_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_RDCLR1_SPEC, u16, u16, 9, 9>;
impl R {
    #[doc = "Bits 0:8"]
    #[inline(always)]
