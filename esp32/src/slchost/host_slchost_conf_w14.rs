...
pub struct HOST_SLCHOST_CONF56_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF57_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF58_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF59_R(crate::FieldReader<u8>);
