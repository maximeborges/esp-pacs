...
pub type HOST_SLCHOST_CONF56_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W14_SPEC, u8, u8, 8, 0>;
...
pub type HOST_SLCHOST_CONF57_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W14_SPEC, u8, u8, 8, 8>;
...
pub type HOST_SLCHOST_CONF58_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W14_SPEC, u8, u8, 8, 16>;
...
pub type HOST_SLCHOST_CONF59_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W14_SPEC, u8, u8, 8, 24>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
