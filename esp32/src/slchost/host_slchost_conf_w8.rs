...
pub struct HOST_SLCHOST_CONF32_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF33_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF34_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF35_R(crate::FieldReader<u8>);
