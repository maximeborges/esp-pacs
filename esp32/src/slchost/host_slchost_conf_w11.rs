...
pub type HOST_SLCHOST_CONF44_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W11_SPEC, u8, u8, 8, 0>;
...
pub type HOST_SLCHOST_CONF45_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W11_SPEC, u8, u8, 8, 8>;
...
pub type HOST_SLCHOST_CONF46_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W11_SPEC, u8, u8, 8, 16>;
...
pub type HOST_SLCHOST_CONF47_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W11_SPEC, u8, u8, 8, 24>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
