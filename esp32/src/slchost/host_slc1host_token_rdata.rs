...
pub struct HOST_SLC1_TOKEN0_R(crate::FieldReader<u16>);
...
pub struct HOST_SLC1_RX_PF_VALID_R(crate::FieldReader<bool>);
...
pub struct HOST_HOSTSLC1_TOKEN1_R(crate::FieldReader<u16>);
...
pub struct HOST_SLC1_RX_PF_EOF_R(crate::FieldReader<u8>);
