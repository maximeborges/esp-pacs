...
pub type HOST_SLCHOST_CONF0_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W0_SPEC, u8, u8, 8, 0>;
...
pub type HOST_SLCHOST_CONF1_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W0_SPEC, u8, u8, 8, 8>;
...
pub type HOST_SLCHOST_CONF2_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W0_SPEC, u8, u8, 8, 16>;
...
pub type HOST_SLCHOST_CONF3_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W0_SPEC, u8, u8, 8, 24>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
