...
pub struct HOST_SLC0_TOKEN0_R(crate::FieldReader<u16>);
...
pub struct HOST_SLC0_RX_PF_VALID_R(crate::FieldReader<bool>);
...
pub struct HOST_HOSTSLC0_TOKEN1_R(crate::FieldReader<u16>);
...
pub struct HOST_SLC0_RX_PF_EOF_R(crate::FieldReader<u8>);
