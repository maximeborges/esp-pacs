...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [host_slchost_conf_w13]
(index.html) module"]
pub struct HOST_SLCHOST_CONF_W13_SPEC;
impl crate::RegisterSpec for HOST_SLCHOST_CONF_W13_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [host_slchost_conf_w13::R]
(R) reader structure"]
impl crate::Readable for HOST_SLCHOST_CONF_W13_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [host_slchost_conf_w13::W]
(W) writer structure"]
