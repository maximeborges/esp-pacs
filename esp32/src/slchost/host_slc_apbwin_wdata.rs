...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [host_slc_apbwin_wdata]
(index.html) module"]
pub struct HOST_SLC_APBWIN_WDATA_SPEC;
impl crate::RegisterSpec for HOST_SLC_APBWIN_WDATA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [host_slc_apbwin_wdata::R]
(R) reader structure"]
impl crate::Readable for HOST_SLC_APBWIN_WDATA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [host_slc_apbwin_wdata::W]
(W) writer structure"]
