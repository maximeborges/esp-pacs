...
pub type HOST_SLCHOST_CONF8_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W2_SPEC, u8, u8, 8, 0>;
...
pub type HOST_SLCHOST_CONF9_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W2_SPEC, u8, u8, 8, 8>;
...
pub type HOST_SLCHOST_CONF10_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W2_SPEC, u8, u8, 8, 16>;
...
pub type HOST_SLCHOST_CONF11_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W2_SPEC, u8, u8, 8, 24>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
