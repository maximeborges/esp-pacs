...
pub struct HOST_SLCHOST_CONF8_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF9_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF10_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF11_R(crate::FieldReader<u8>);
