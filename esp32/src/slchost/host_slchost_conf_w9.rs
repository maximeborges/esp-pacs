...
pub struct HOST_SLCHOST_CONF36_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF37_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF38_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF39_R(crate::FieldReader<u8>);
