...
pub struct HOST_SLCHOST_CONF4_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF5_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF6_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF7_R(crate::FieldReader<u8>);
