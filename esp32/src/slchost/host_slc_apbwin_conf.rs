...
pub struct HOST_SLC_APBWIN_ADDR_R(crate::FieldReader<u32>);
...
pub struct HOST_SLC_APBWIN_WR_R(crate::FieldReader<bool>);
...
pub struct HOST_SLC_APBWIN_START_R(crate::FieldReader<bool>);
