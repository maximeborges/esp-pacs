...
pub type HOST_SLCHOST_CONF20_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W5_SPEC, u8, u8, 8, 0>;
...
pub type HOST_SLCHOST_CONF21_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W5_SPEC, u8, u8, 8, 8>;
...
pub type HOST_SLCHOST_CONF22_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W5_SPEC, u8, u8, 8, 16>;
...
pub type HOST_SLCHOST_CONF23_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W5_SPEC, u8, u8, 8, 24>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
