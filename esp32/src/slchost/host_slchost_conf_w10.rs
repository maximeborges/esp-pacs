...
pub type HOST_SLCHOST_CONF40_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W10_SPEC, u8, u8, 8, 0>;
...
pub type HOST_SLCHOST_CONF41_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W10_SPEC, u8, u8, 8, 8>;
...
pub type HOST_SLCHOST_CONF42_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W10_SPEC, u8, u8, 8, 16>;
...
pub type HOST_SLCHOST_CONF43_W<'a> =
    crate::FieldWriter<'a, u32, HOST_SLCHOST_CONF_W10_SPEC, u8, u8, 8, 24>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
