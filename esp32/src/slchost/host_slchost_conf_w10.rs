...
pub struct HOST_SLCHOST_CONF40_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF41_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF42_R(crate::FieldReader<u8>);
...
pub struct HOST_SLCHOST_CONF43_R(crate::FieldReader<u8>);
