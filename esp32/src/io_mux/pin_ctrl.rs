...
pub type CLK1_W<'a> = crate::FieldWriter<'a, u32, PIN_CTRL_SPEC, u8, u8, 4, 0>;
...
pub type CLK2_W<'a> = crate::FieldWriter<'a, u32, PIN_CTRL_SPEC, u8, u8, 4, 4>;
...
pub type CLK3_W<'a> = crate::FieldWriter<'a, u32, PIN_CTRL_SPEC, u8, u8, 4, 8>;
impl R {
