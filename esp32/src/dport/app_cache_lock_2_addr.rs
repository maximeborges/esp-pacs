...
pub type PRE_W<'a> = crate::FieldWriter<'a, u32, APP_CACHE_LOCK_2_ADDR_SPEC, u16, u16, 14, 0>;
#[doc = "Field `MIN` reader - "]
pub type MIN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MIN` writer - "]
pub type MIN_W<'a> = crate::FieldWriter<'a, u32, APP_CACHE_LOCK_2_ADDR_SPEC, u8, u8, 4, 14>;
#[doc = "Field `MAX` reader - "]
pub type MAX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MAX` writer - "]
pub type MAX_W<'a> = crate::FieldWriter<'a, u32, APP_CACHE_LOCK_2_ADDR_SPEC, u8, u8, 4, 18>;
impl R {
    #[doc = "Bits 0:13"]
    #[inline(always)]
