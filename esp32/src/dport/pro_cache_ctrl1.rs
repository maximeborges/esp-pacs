...
pub struct PRO_CACHE_MASK_IRAM0_R(crate::FieldReader<bool>);
...
pub struct PRO_CACHE_MASK_IRAM1_R(crate::FieldReader<bool>);
...
pub struct PRO_CACHE_MASK_IROM0_R(crate::FieldReader<bool>);
...
pub struct PRO_CACHE_MASK_DRAM1_R(crate::FieldReader<bool>);
...
pub struct PRO_CACHE_MASK_DROM0_R(crate::FieldReader<bool>);
...
pub struct PRO_CACHE_MASK_OPSDRAM_R(crate::FieldReader<bool>);
...
pub struct PRO_CMMU_SRAM_PAGE_MODE_R(crate::FieldReader<u8>);
...
pub struct PRO_CMMU_FLASH_PAGE_MODE_R(crate::FieldReader<u8>);
...
pub struct PRO_CMMU_FORCE_ON_R(crate::FieldReader<bool>);
...
pub struct PRO_CMMU_PD_R(crate::FieldReader<bool>);
impl PRO_CMMU_PD_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct PRO_CACHE_MMU_IA_CLR_R(crate::FieldReader<bool>);
