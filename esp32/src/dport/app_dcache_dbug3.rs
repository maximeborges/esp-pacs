...
pub struct APP_MMU_RDATA_R(crate::FieldReader<u16>);
...
pub struct APP_CPU_DISABLED_CACHE_IA_R(crate::FieldReader<u8>);
...
pub struct APP_CPU_DISABLED_CACHE_IA_OPPOSITE_R(crate::FieldReader<bool>);
...
pub struct APP_CPU_DISABLED_CACHE_IA_DRAM1_R(crate::FieldReader<bool>);
...
pub struct APP_CPU_DISABLED_CACHE_IA_IROM0_R(crate::FieldReader<bool>);
...
pub struct APP_CPU_DISABLED_CACHE_IA_IRAM1_R(crate::FieldReader<bool>);
...
pub struct APP_CPU_DISABLED_CACHE_IA_IRAM0_R(crate::FieldReader<bool>);
...
pub struct APP_CPU_DISABLED_CACHE_IA_DROM0_R(crate::FieldReader<bool>);
...
pub struct APP_CACHE_IRAM0_PID_ERROR_R(crate::FieldReader<bool>);
