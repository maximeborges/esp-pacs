...
pub type PRO_ROM_PD_W<'a> = crate::BitWriter<'a, u32, ROM_PD_CTRL_SPEC, bool, 0>;
#[doc = "Field `APP_ROM_PD` reader - "]
pub type APP_ROM_PD_R = crate::BitReader<bool>;
#[doc = "Field `APP_ROM_PD` writer - "]
pub type APP_ROM_PD_W<'a> = crate::BitWriter<'a, u32, ROM_PD_CTRL_SPEC, bool, 1>;
#[doc = "Field `SHARE_ROM_PD` reader - "]
pub type SHARE_ROM_PD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SHARE_ROM_PD` writer - "]
pub type SHARE_ROM_PD_W<'a> = crate::FieldWriter<'a, u32, ROM_PD_CTRL_SPEC, u8, u8, 6, 2>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
