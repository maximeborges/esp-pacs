...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [app_cache_lock_1_addr]
(index.html) module"]
pub struct APP_CACHE_LOCK_1_ADDR_SPEC;
impl crate::RegisterSpec for APP_CACHE_LOCK_1_ADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [app_cache_lock_1_addr::R]
(R) reader structure"]
impl crate::Readable for APP_CACHE_LOCK_1_ADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [app_cache_lock_1_addr::W]
(W) writer structure"]
