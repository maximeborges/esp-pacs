...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_boot_remap_ctrl]
(index.html) module"]
pub struct PRO_BOOT_REMAP_CTRL_SPEC;
impl crate::RegisterSpec for PRO_BOOT_REMAP_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_boot_remap_ctrl::R]
(R) reader structure"]
impl crate::Readable for PRO_BOOT_REMAP_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_boot_remap_ctrl::W]
(W) writer structure"]
