...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [app_uart1_intr_map]
(index.html) module"]
pub struct APP_UART1_INTR_MAP_SPEC;
impl crate::RegisterSpec for APP_UART1_INTR_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [app_uart1_intr_map::R]
(R) reader structure"]
impl crate::Readable for APP_UART1_INTR_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [app_uart1_intr_map::W]
(W) writer structure"]
