...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [app_gpio_interrupt_map]
(index.html) module"]
pub struct APP_GPIO_INTERRUPT_MAP_SPEC;
impl crate::RegisterSpec for APP_GPIO_INTERRUPT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [app_gpio_interrupt_map::R]
(R) reader structure"]
impl crate::Readable for APP_GPIO_INTERRUPT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [app_gpio_interrupt_map::W]
(W) writer structure"]
