...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dport_apb_mask0]
(index.html) module"]
pub struct PRO_DPORT_APB_MASK0_SPEC;
impl crate::RegisterSpec for PRO_DPORT_APB_MASK0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dport_apb_mask0::R]
(R) reader structure"]
impl crate::Readable for PRO_DPORT_APB_MASK0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dport_apb_mask0::W]
(W) writer structure"]
