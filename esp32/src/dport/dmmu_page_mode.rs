...
pub type INTERNAL_SRAM_DMMU_ENA_W<'a> = crate::BitWriter<'a, u32, DMMU_PAGE_MODE_SPEC, bool, 0>;
#[doc = "Field `DMMU_PAGE_MODE` reader - "]
pub type DMMU_PAGE_MODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DMMU_PAGE_MODE` writer - "]
pub type DMMU_PAGE_MODE_W<'a> = crate::FieldWriter<'a, u32, DMMU_PAGE_MODE_SPEC, u8, u8, 2, 1>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
