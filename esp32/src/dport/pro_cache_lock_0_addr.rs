...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_cache_lock_0_addr]
(index.html) module"]
pub struct PRO_CACHE_LOCK_0_ADDR_SPEC;
impl crate::RegisterSpec for PRO_CACHE_LOCK_0_ADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_cache_lock_0_addr::R]
(R) reader structure"]
impl crate::Readable for PRO_CACHE_LOCK_0_ADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_cache_lock_0_addr::W]
(W) writer structure"]
