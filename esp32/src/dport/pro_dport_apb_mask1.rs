...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dport_apb_mask1]
(index.html) module"]
pub struct PRO_DPORT_APB_MASK1_SPEC;
impl crate::RegisterSpec for PRO_DPORT_APB_MASK1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_dport_apb_mask1::R]
(R) reader structure"]
impl crate::Readable for PRO_DPORT_APB_MASK1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_dport_apb_mask1::W]
(W) writer structure"]
