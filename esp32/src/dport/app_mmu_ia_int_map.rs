...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [app_mmu_ia_int_map]
(index.html) module"]
pub struct APP_MMU_IA_INT_MAP_SPEC;
impl crate::RegisterSpec for APP_MMU_IA_INT_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [app_mmu_ia_int_map::R]
(R) reader structure"]
impl crate::Readable for APP_MMU_IA_INT_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [app_mmu_ia_int_map::W]
(W) writer structure"]
