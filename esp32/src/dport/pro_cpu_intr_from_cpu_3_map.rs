...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_cpu_intr_from_cpu_3_map]
(index.html) module"]
pub struct PRO_CPU_INTR_FROM_CPU_3_MAP_SPEC;
impl crate::RegisterSpec for PRO_CPU_INTR_FROM_CPU_3_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_cpu_intr_from_cpu_3_map::R]
(R) reader structure"]
impl crate::Readable for PRO_CPU_INTR_FROM_CPU_3_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_cpu_intr_from_cpu_3_map::W]
(W) writer structure"]
