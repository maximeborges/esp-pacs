...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_spi_intr_0_map]
(index.html) module"]
pub struct PRO_SPI_INTR_0_MAP_SPEC;
impl crate::RegisterSpec for PRO_SPI_INTR_0_MAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pro_spi_intr_0_map::R]
(R) reader structure"]
impl crate::Readable for PRO_SPI_INTR_0_MAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pro_spi_intr_0_map::W]
(W) writer structure"]
