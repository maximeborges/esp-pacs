...
pub struct PRO_CPU_RECORD_ENABLE_R(crate::FieldReader<bool>);
...
pub struct PRO_CPU_RECORD_DISABLE_R(crate::FieldReader<bool>);
...
pub struct PRO_CPU_PDEBUG_ENABLE_R(crate::FieldReader<bool>);
