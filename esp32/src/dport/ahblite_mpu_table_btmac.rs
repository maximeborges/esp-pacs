...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ahblite_mpu_table_btmac]
(index.html) module"]
pub struct AHBLITE_MPU_TABLE_BTMAC_SPEC;
impl crate::RegisterSpec for AHBLITE_MPU_TABLE_BTMAC_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ahblite_mpu_table_btmac::R]
(R) reader structure"]
impl crate::Readable for AHBLITE_MPU_TABLE_BTMAC_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ahblite_mpu_table_btmac::W]
(W) writer structure"]
