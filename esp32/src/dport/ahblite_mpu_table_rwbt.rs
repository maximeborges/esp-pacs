...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ahblite_mpu_table_rwbt]
(index.html) module"]
pub struct AHBLITE_MPU_TABLE_RWBT_SPEC;
impl crate::RegisterSpec for AHBLITE_MPU_TABLE_RWBT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ahblite_mpu_table_rwbt::R]
(R) reader structure"]
impl crate::Readable for AHBLITE_MPU_TABLE_RWBT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ahblite_mpu_table_rwbt::W]
(W) writer structure"]
