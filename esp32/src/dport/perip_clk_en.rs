...
#[doc = "Field `I2C_EXT0_CLK_EN` reader - I2C0 module."]
...
#[doc = "Field `I2C_EXT0_CLK_EN` writer - I2C0 module."]
...
#[doc = "Field `I2C0_EXT0_CLK_EN` reader - Enable Bit for I2C0 Peripheral"]
...
#[doc = "Field `I2C0_EXT0_CLK_EN` writer - Enable Bit for I2C0 Peripheral"]
...
impl R {
    ...
    pub fn spi_dma_clk_en(&self) -> SPI_DMA_CLK_EN_R {
        SPI_DMA_CLK_EN_R::new(((self.bits >> 22) & 0x01) != 0)
    }
    #[doc = "Bit 23 - UART2 module."]
    #[inline(always)]
    pub fn uart2_clk_en(&self) -> UART2_CLK_EN_R {
        UART2_CLK_EN_R::new(((self.bits >> 23) & 0x01) != 0)
    }
    ...
    #[doc = "Bit 7 - Enable Bit for I2C0 Peripheral"]
    #[inline(always)]
    pub fn i2c0_ext0_clk_en(&self) -> I2C0_EXT0_CLK_EN_R {
        I2C0_EXT0_CLK_EN_R::new(((self.bits >> 7) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - SPI0 and SPI1 module."]
