...
pub struct FH0_CLR_OST_R(crate::FieldReader<bool>);
impl FH0_CLR_OST_R {
    #[inline(always)]
...
pub struct FH0_CBCPULSE_R(crate::FieldReader<u8>);
impl FH0_CBCPULSE_R {
    #[inline(always)]
...
pub struct FH0_FORCE_CBC_R(crate::FieldReader<bool>);
...
pub struct FH0_FORCE_OST_R(crate::FieldReader<bool>);
