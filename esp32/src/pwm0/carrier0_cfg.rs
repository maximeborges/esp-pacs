...
pub struct CARRIER0_EN_R(crate::FieldReader<bool>);
impl CARRIER0_EN_R {
    #[inline(always)]
...
pub struct CARRIER0_PRESCALE_R(crate::FieldReader<u8>);
...
pub struct CARRIER0_DUTY_R(crate::FieldReader<u8>);
...
pub struct CARRIER0_OSHTWTH_R(crate::FieldReader<u8>);
...
pub struct CARRIER0_OUT_INVERT_R(crate::FieldReader<bool>);
...
pub struct CARRIER0_IN_INVERT_R(crate::FieldReader<bool>);
