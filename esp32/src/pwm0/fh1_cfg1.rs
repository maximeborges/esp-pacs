...
pub struct FH1_CLR_OST_R(crate::FieldReader<bool>);
impl FH1_CLR_OST_R {
    #[inline(always)]
...
pub struct FH1_CBCPULSE_R(crate::FieldReader<u8>);
impl FH1_CBCPULSE_R {
    #[inline(always)]
...
pub struct FH1_FORCE_CBC_R(crate::FieldReader<bool>);
...
pub struct FH1_FORCE_OST_R(crate::FieldReader<bool>);
