...
pub struct GEN2_A_UPMETHOD_R(crate::FieldReader<u8>);
...
pub struct GEN2_B_UPMETHOD_R(crate::FieldReader<u8>);
...
pub struct GEN2_A_SHDW_FULL_R(crate::FieldReader<bool>);
...
pub struct GEN2_B_SHDW_FULL_R(crate::FieldReader<bool>);
