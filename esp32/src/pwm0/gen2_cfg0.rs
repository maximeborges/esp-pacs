...
pub type GEN2_CFG_UPMETHOD_W<'a> = crate::FieldWriter<'a, u32, GEN2_CFG0_SPEC, u8, u8, 4, 0>;
#[doc = "Field `GEN2_T0_SEL` reader - "]
pub type GEN2_T0_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GEN2_T0_SEL` writer - "]
pub type GEN2_T0_SEL_W<'a> = crate::FieldWriter<'a, u32, GEN2_CFG0_SPEC, u8, u8, 3, 4>;
#[doc = "Field `GEN2_T1_SEL` reader - "]
pub type GEN2_T1_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GEN2_T1_SEL` writer - "]
pub type GEN2_T1_SEL_W<'a> = crate::FieldWriter<'a, u32, GEN2_CFG0_SPEC, u8, u8, 3, 7>;
impl R {
    #[doc = "Bits 0:3"]
    #[inline(always)]
