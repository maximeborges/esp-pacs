...
pub type GPIO_SD0_IN_W<'a> = crate::FieldWriter<'a, u32, SIGMADELTA0_SPEC, u8, u8, 8, 0>;
#[doc = "Field `GPIO_SD0_PRESCALE` reader - "]
pub type GPIO_SD0_PRESCALE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GPIO_SD0_PRESCALE` writer - "]
pub type GPIO_SD0_PRESCALE_W<'a> = crate::FieldWriter<'a, u32, SIGMADELTA0_SPEC, u8, u8, 8, 8>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
