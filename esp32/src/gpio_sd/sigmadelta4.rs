...
pub type GPIO_SD4_IN_W<'a> = crate::FieldWriter<'a, u32, SIGMADELTA4_SPEC, u8, u8, 8, 0>;
#[doc = "Field `GPIO_SD4_PRESCALE` reader - "]
pub type GPIO_SD4_PRESCALE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GPIO_SD4_PRESCALE` writer - "]
pub type GPIO_SD4_PRESCALE_W<'a> = crate::FieldWriter<'a, u32, SIGMADELTA4_SPEC, u8, u8, 8, 8>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
