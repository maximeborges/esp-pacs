...
pub type CVSD_SIGMA_MAX_W<'a> = crate::FieldWriter<'a, u32, CVSD_CONF1_SPEC, u16, u16, 16, 0>;
#[doc = "Field `CVSD_SIGMA_MIN` reader - "]
pub type CVSD_SIGMA_MIN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CVSD_SIGMA_MIN` writer - "]
pub type CVSD_SIGMA_MIN_W<'a> = crate::FieldWriter<'a, u32, CVSD_CONF1_SPEC, u16, u16, 16, 16>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
