...
pub type CVSD_Y_MAX_W<'a> = crate::FieldWriter<'a, u32, CVSD_CONF0_SPEC, u16, u16, 16, 0>;
#[doc = "Field `CVSD_Y_MIN` reader - "]
pub type CVSD_Y_MIN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CVSD_Y_MIN` writer - "]
pub type CVSD_Y_MIN_W<'a> = crate::FieldWriter<'a, u32, CVSD_CONF0_SPEC, u16, u16, 16, 16>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
