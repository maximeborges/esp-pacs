...
pub type MEM_PD_W<'a> = crate::BitWriter<'a, u32, MEM_CONF_SPEC, bool, 0>;
...
pub type RX_SIZE_W<'a> = crate::FieldWriter<'a, u32, MEM_CONF_SPEC, u8, u8, 4, 3>;
...
pub type TX_SIZE_W<'a> = crate::FieldWriter<'a, u32, MEM_CONF_SPEC, u8, u8, 4, 7>;
...
pub type RX_FLOW_THRHD_H3_W<'a> = crate::FieldWriter<'a, u32, MEM_CONF_SPEC, u8, u8, 3, 15>;
...
pub type RX_TOUT_THRHD_H3_W<'a> = crate::FieldWriter<'a, u32, MEM_CONF_SPEC, u8, u8, 3, 18>;
...
pub type XON_THRESHOLD_H2_W<'a> = crate::FieldWriter<'a, u32, MEM_CONF_SPEC, u8, u8, 2, 21>;
...
pub type XOFF_THRESHOLD_H2_W<'a> = crate::FieldWriter<'a, u32, MEM_CONF_SPEC, u8, u8, 2, 23>;
...
pub type RX_MEM_FULL_THRHD_W<'a> = crate::FieldWriter<'a, u32, MEM_CONF_SPEC, u8, u8, 3, 25>;
...
pub type TX_MEM_EMPTY_THRHD_W<'a> = crate::FieldWriter<'a, u32, MEM_CONF_SPEC, u8, u8, 3, 28>;
impl R {
